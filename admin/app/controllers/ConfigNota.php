<?php 
	...
	$notas=$lider->consultarQuery("SELECT * FROM planes, confignotaentrega WHERE planes.id_plan = confignotaentrega.id_plan and confignotaentrega.estatus = 1 and confignotaentrega.id_campana = {$id_campana}");
