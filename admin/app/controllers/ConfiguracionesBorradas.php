...
if($_SESSION['nombre_rol']=="Superusuario"){
	...
	$configuracioness=$lider->consultarQuery("SELECT * FROM configuraciones WHERE estatus = 0");

	if(!empty($_GET['permission']) && $_GET['permission'] == 1 ){

		$query = "UPDATE configuraciones SET estatus = 1 WHERE id_configuracion = $id";
	...
	if(empty($_POST)){
		...
		if($configuracioness['ejecucion']==1){
