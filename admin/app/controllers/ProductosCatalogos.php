...
// if($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Analista2" || $_SESSION['nombre_rol']=="Analista Supervisor2" ){
	...
	$catalogos=$lider->consultarQuery("SELECT * FROM catalogos WHERE estatus = 1 ORDER BY catalogos.codigo_producto_catalogo ASC;");

	if(!empty($_GET['permission']) && $_GET['permission'] == 1 ){
		$query = "UPDATE catalogos SET estatus = 0 WHERE codigo_producto_catalogo = '{$id}'";
