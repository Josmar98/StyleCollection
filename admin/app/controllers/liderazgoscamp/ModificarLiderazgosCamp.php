...
if($amLiderazgosCampE == 1){
	...
	if(!empty($_POST['titulo'])){
		...
		if($resp['ejecucion']){
			if(Count($resp)>1){
				$query = "SELECT * FROM liderazgos_campana WHERE id_campana = $id_campana and id_liderazgo = $id_buscar";
		...
		$query = "SELECT * FROM liderazgos, liderazgos_campana WHERE liderazgos_campana.id_liderazgo = liderazgos.id_liderazgo and liderazgos_campana.estatus = 1 and liderazgos_campana.id_lc = $id";
