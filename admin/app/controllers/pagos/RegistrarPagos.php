					...
					// }else{
						if($referencia!=""){
							...
							if($banco['nombre_banco']=="Provincial" && !empty($_POST['cedula'])){
								$buscar = $lider->consultarQuery("SELECT * FROM movimientos WHERE id_banco = {$id_banco} and fecha_movimiento = '{$fechaPago}' and num_movimiento LIKE '%{$cedula}%' and monto_movimiento = '{$monto}' and estado_movimiento != 'Firmado'");
							}else{
								$buscar = $lider->consultarQuery("SELECT * FROM movimientos WHERE id_banco = {$id_banco} and fecha_movimiento = '{$fechaPago}' and num_movimiento LIKE '%{$referencia}%' and monto_movimiento = '{$monto}' and estado_movimiento != 'Firmado'");
							}
							// print_r($buscar);
							...
							if(!isset($monto)){
								$buscar = $lider->consultarQuery("SELECT * FROM movimientos WHERE id_banco = {$id_banco} and fecha_movimiento = '{$fechaPago}' and num_movimiento LIKE '%{$serial}%' and monto_movimiento = '{$monto}' and estado_movimiento != 'Firmado'");
							}else{
								$buscar = $lider->consultarQuery("SELECT * FROM movimientos WHERE id_banco = {$id_banco} and fecha_movimiento = '{$fechaPago}' and num_movimiento LIKE '%{$serial}%' and monto_movimiento = '{$eqv}' and estado_movimiento != 'Firmado'");
							}
