              ...
              if(!( $sizeImg < 10000000 )){ // 10 MB - 10000 KB - 10000000 Bytes
                ...
                if($errorImg=="0"){
                  if(move_uploaded_file($tempImg, $final)){
                    ...
                    $ficha2 = $final;
                    if($codigo!=$catalogo['codigo_producto_catalogo']){
                      unlink($dirCatalogo."ficha2_".$catalogo['codigo_producto_catalogo'].'.'.$extImg);
                    }
                  }else{
                    $responseImg = "72";  // Error al cargar
                  }
              ...
              if(!( $sizeImg < 10000000 )){ // 10 MB - 10000 KB - 10000000 Bytes
                ...
                if($errorImg=="0"){
                  if(move_uploaded_file($tempImg, $final)){
                    ...
                    $ficha3 = $final;
                    if($codigo!=$catalogo['codigo_producto_catalogo']){
                      unlink($dirCatalogo."ficha3_".$catalogo['codigo_producto_catalogo'].'.'.$extImg);
                    }
                  }else{
                    $responseImg = "72";  // Error al cargar
                  }
              ...
              if(!( $sizeImg < 10000000 )){ // 10 MB - 10000 KB - 10000000 Bytes
                ...
                if($errorImg=="0"){
                  if(move_uploaded_file($tempImg, $final)){
                    ...
                    $ficha4 = $final;
                    if($codigo!=$catalogo['codigo_producto_catalogo']){
                      unlink($dirCatalogo."ficha4_".$catalogo['codigo_producto_catalogo'].'.'.$extImg);
                    }
                  }else{
                    $responseImg = "72";  // Error al cargar
                  }
