...
if($amReportesC == 1){
			  ...
			  // $planes = $lider->consultarQuery("SELECT planes.nombre_plan FROM planes, planes_campana, campanas, despachos WHERE planes.id_plan = planes_campana.id_plan and planes_campana.id_campana = campanas.id_campana and campanas.id_campana = despachos.id_campana and despachos.id_despacho = {$id_despacho}");
              ...
              // $premios = $lider->consultarQuery("SELECT DISTINCT nombre_premio FROM premios, tipos_premios_planes_campana, premios_planes_campana, planes_campana, campanas, despachos WHERE premios.id_premio = tipos_premios_planes_campana.id_premio and tipos_premios_planes_campana.id_ppc = premios_planes_campana.id_ppc and premios_planes_campana.id_plan_campana = planes_campana.id_plan_campana and planes_campana.id_campana = campanas.id_campana and campanas.id_campana = despachos.id_campana and despachos.id_despacho = {$id_despacho}");
			...
			<div class='row' style='padding:0;margin:0;'>
				<div class='col-xs-12'  style='width:100%;'>
						...
						<h2 style='font-size:1.9em;'> Planes y Premios Seleccionados (Estructura de {$nombreReport}) - Campaña ".$numeroCampana."/".$anioCampana."</h2>
						<br>
				";		
					...
					$info .= "<table class='table  text-center' style='font-size:1.2em;width:110%;position:relative;left:-5%;'>
								...
								$info .= "<tr class='text-center'>
										...
										$info .= "<tr >
												...
												$info .= $data3['cantidad_coleccion_plan']." Plan ".$data3['nombre_plan']."
													...
													$info.= "<tr>
																<td style='text-align:left;'>";
																	//$acumPremios[$data4['nombre_premio']] += $data4['cantidad_premios_plan'];
															...
															$info .= $data4['cantidad_premios_plan']." ".$data4['nombre_premio']."<br>
																</td>
															</tr>";
																		endif;
																	endif;
						...
						$info .= "<tr style='background:#efefef66;font-size:1.05em;'>
