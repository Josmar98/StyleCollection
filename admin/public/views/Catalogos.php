                              ...
                              <?php endif; ?>
                                <div class="row">
                                  <div class="col-xs-12" style="height:12.5%;width:100%;margin-top:2%;" >
                                      <button class="modificarBtn btn" style="font-size:1em;border:0;background:none;background:#04a7c9;color:#FFF;width:40%;height:auto;margin-left:auto;margin-right:auto;display:inline-block;" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['codigo_catalogo'] ?>">
                                        <span class="fa fa-wrench"></span>
                                      </button>
                                      <button class="eliminarBtn btn" style="font-size:1em;border:0;background:none;background:red;color:#FFF;width:40%;height:auto;margin-left:auto;margin-right:auto;display:inline-block;" value="?route=<?php echo $url; ?>&id=<?php echo $data['codigo_catalogo'] ?>&permission=1">
