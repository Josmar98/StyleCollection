        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo "Estructura de Productos"; ?></h3>
              <?php if(count($estructuras)>1){ ?>
                <h2><?php echo $nombre_camp; ?></h2>
              <?php } ?>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                if(!empty($data['id_estructura_catalogo'])):  
                ?>
                <tr>
                  <td style="width:5%">
                  ...
                  <td style="width:20%">
                    <span class="contenido2" style="font-size:.9em;">
                      <img src="<?=$data['imagen_producto_catalogo'] ?>" style="width:25%;">
                    </span>
                  </td>
