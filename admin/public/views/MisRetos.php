        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo "Planes Seleccionados para sus Colecciones"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                ...
                <tr >
                  ...
                  <td style="width:15%">
                    <?php if ($_SESSION['nombre_rol']=="Vendedor"): ?>
                        <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=Retos&action=Modificar&id=<?=$data['id_pedido']?>">
                          <span class="fa fa-wrench"></span>
                        </button>
                      <?php else: ?>
                        <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=Retos&action=Modificar&id=<?=$data['id_pedido']?>&admin=1">
                          <span class="fa fa-wrench"></span>
                        </button>
                      <?php endif; ?>
