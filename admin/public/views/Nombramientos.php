  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="?route=<?php echo "Configuracion" ?>"><?php echo $url; ?></a></li>
            ...
            <div class="box-body">
              <table id="datatable2" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  ...
                  <td style="width:10%">
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_nombramiento'] ?>">
                            <span class="fa fa-wrench"></span>
                          </button>
                    <?php if($_SESSION['nombre_rol']=="Superusuario"){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_nombramiento'] ?>&permission=1">
