    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo " ". $url; ?></li>
              ...
              <br>
              <div style="width:100%;text-align:center;"><a href="?route=Productos&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar Producto</a></div>
    <!-- Main content -->
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=ProductosBorrados";
      });
    }
    if(response == "2"){
      swal.fire({
