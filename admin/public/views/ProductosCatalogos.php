          ...
          <div class="box">
            ...
            <div class="box-body">
                  <div class="sm-none">
                    ...
                    <input type="hidden" name="route" value="ProductosCatalogos">
                    <label style="margin:0">Tamaño</label>
                    <select class="form-control" name="t" onchange="if($(this).val()=='0'){ window.location.href='?route=ProductosCatalogos'; }else{ $('.tamBtn').click(); }">
                ...
                <?php $color = "#CCC"; ?>
                  ...
                  <div class="row box<?=$cant['cantidad_gemas']?>" style="margin-top:5px">
                    <?php foreach ($catalogos as $data): ?>
                      <?php if (!empty($data['codigo_producto_catalogo'])): ?>
                          ...
                          <?php
                            ...
                            if($data['ficha_producto_catalogo2'] != ""){
                              ...
                              if(file_exists($data['ficha_producto_catalogo2'])){
                                $ficha = getimagesize($data['ficha_producto_catalogo2']); //Sacamos la información.
                            ...
                            if($data['ficha_producto_catalogo3'] != ""){
                              ...
                              if(file_exists($data['ficha_producto_catalogo3'])){
                                $ficha = getimagesize($data['ficha_producto_catalogo3']); //Sacamos la información.
                            ...
                            if($data['ficha_producto_catalogo4'] != ""){
                              ...
                              if(file_exists($data['ficha_producto_catalogo4'])){
                                $ficha = getimagesize($data['ficha_producto_catalogo4']); //Sacamos la información.
                          ...
                          <?php endif; ?>
                              ...
                              <div class="row" style="height:12.5%;padding:2% 0;">
                                <div class="col-xs-10 col-xs-offset-1" style="border-bottom:0px solid <?=$color?>;">
                                  <b style="color:<?=$fucsia?>"><?=$data['nombre_producto_catalogo']?></b>
                                </div>
                              </div>
                              <?php if ($data['codigo_producto_catalogo']!=""): ?>
                              <div class="" style="border-bottom:1px solid <?=$color?>;">
                                <b>#<?=$data['codigo_producto_catalogo']?></b>
                              </div>
                              <?php endif; ?>
                                <div class="row">
                                  <div class="col-xs-12" style="height:12.5%;width:100%;margin-top:2%;" >
                                      <button class="modificarBtn btn" style="font-size:1em;border:0;background:none;background:#04a7c9;color:#FFF;width:40%;height:auto;margin-left:auto;margin-right:auto;display:inline-block;" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['codigo_producto_catalogo'] ?>">
                                        <span class="fa fa-wrench"></span>
                                      </button>
                                      <button class="eliminarBtn btn" style="font-size:1em;border:0;background:none;background:red;color:#FFF;width:40%;height:auto;margin-left:auto;margin-right:auto;display:inline-block;" value="?route=<?php echo $url; ?>&id=<?php echo $data['codigo_producto_catalogo'] ?>&permission=1">
