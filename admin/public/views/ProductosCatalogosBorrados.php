                              ...
                              <?php endif; ?>
                                <div class="row">
                                  <div class="col-xs-12" style="height:12.5%;width:100%;margin-top:2%;" >
                                      <button class="eliminarBtn btn" style="font-size:1em;border:0;background:none;background:#04a7c9;color:#FFF;width:40%;height:auto;margin-left:auto;margin-right:auto;display:inline-block;" value="?route=<?php echo $url; ?>&id=<?php echo $data['codigo_producto_catalogo'] ?>&permission=1">
...
$(document).ready(function(){ 
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=ProductosCatalogosBorrados";
      });
    }
    if(response == "2"){
      swal.fire({
  ...
  $(".eliminarBtn").click(function(){
      swal.fire({ 
          title: "¿Desea habilitar el elemento?",
          text: "Se habilitara el elemento escogido, ¿desea continuar?",
          type: "error",
          showCancelButton: true,
          confirmButtonColor: "#ED2A77",
          confirmButtonText: "¡Si!",
          ...
          if (isConfirm.value){            
                ...
                swal.fire({ 
                    title: "¿Esta seguro de habilitar el elemento?",
                    text: "Se habilitara el elemento. ¿desea continuar?",
                    type: "error",
                    showCancelButton: true,
                  confirmButtonColor: "#ED2A77",
                    confirmButtonText: "¡Si!",
