          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="datatable2" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                $num = 1;
                // print_r($clientes);
                foreach ($tasas as $data):
                if(!empty($data['id_tasa'])):  
                ?>
                <tr>
                  <td style="width:5%">
                  ...
                  <td style="width:10%">
                    <!-- <table style="background:none;text-align:center;width:100%"> -->
                      <!-- <tr> -->
                        <?php if ($amTasasE==1): ?>
                        <!-- <td style="width:50%"> -->
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_tasa'] ?>">
                        ...
                        <?php if ($amTasasB==1): ?>
                        <!-- <td style="width:50%"> -->
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_tasa'] ?>&permission=1">
                  ...
                  <td style="width:20%">
                    <span class="contenido2">
                      <?php echo "Bs. ".number_format($data['monto_tasa'],2,',','.'); ?>
                    </span>
                  </td>
