...
.skin-blue .sidebar-menu .treeview-menu2 > li > a{background:#212121 !important}
      ...
      <?php } ?>
        ...
        <li class="treeview">
                            <?php } ?>
          <a href="#">
            <i class="fa fa-folder-o"></i> <span>Planes y Premios</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active" ><a <?php if(Count($cols)>1 || Count($pedd)<2 || $limittteee=="0"): ?>style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PlanCol&action=Registrar" <?php endif; ?> ><i class="fa fa-folder"></i> Seleccionar Planes</a></li>
                            <?php }else{ ?>
            <li class="" ><a <?php if(Count($cols)>1 || Count($pedd)<2 || $limittteee=="0"): ?>style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PlanCol&action=Registrar" <?php endif; ?> ><i class="fa fa-folder"></i> Seleccionar Planes</a></li>
                            <?php } ?>
                      

                            <?php if($url=="PlanCol" && empty($action)){ ?>
            <li class="active"><a <?php if(Count($cols)<2): ?>style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PlanCol" <?php endif; ?>><i class="fa fa-folder"></i> Planes Seleccionados</a></li>
                            <?php }else{ ?>
            <li><a <?php if(Count($cols)<2): ?>style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PlanCol" <?php endif; ?>><i class="fa fa-folder"></i> Planes Seleccionados</a></li>
                            <?php } ?>
            ...
            <li class="active"><a <?php if(Count($prems)>1 || Count($cols)<2 || $limittteee=="0"): ?> style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PremioCol&action=Registrar"<?php endif; ?> ><i class="fa fa-folder"></i> Seleccionar Premios</a></li>
                            <?php }else{ ?>
            <li><a <?php if(Count($prems)>1 || Count($cols)<2 || $limittteee=="0"): ?> style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PremioCol&action=Registrar"<?php endif; ?> ><i class="fa fa-folder"></i> Seleccionar  Premios</a></li>
                            <?php } ?>


                            <?php if($url=="PremioCol" && empty($action)){ ?>
            <li class="active"><a <?php if(Count($prems)<2): ?>  style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PremioCol" <?php endif; ?> ><i class="fa fa-folder"></i> Premios Seleccionados</a></li>
                            <?php }else{ ?>
            <li><a <?php if(Count($prems)<2): ?>  style="color:#676767;cursor:default;" <?php else: ?> href="?<?php echo $menu ?>&route=PremioCol" <?php endif; ?> ><i class="fa fa-folder"></i>Premios Seleccionados</a></li>
                            <?php } ?>
...
<?php 
  ...
  if(count($camppagos)>1){
    ...
    $pedpagos = $lider->consultarQuery("SELECT * FROM pedidos WHERE id_cliente = {$_SESSION['id_cliente']} and id_despacho = {$camppago['id_despacho']}");
    if(count($pedpagos)>1){
      $pedpago = $pedpagos[0];
...
?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?<?php echo $menu ?>&route=Pagos"><i class="fa fa-money"></i> Ver Pagos</a></li>
                            <?php }else{ ?>
            <li><a href="?<?php echo $menu ?>&route=Pagos"><i class="fa fa-money"></i> Ver Pagos</a></li>
                            <?php } ?>
                  <?php endif; ?>
...
<!-- ======================================================================================================================= -->
        <?php 
          ...
          ?>
                            ...
                            <?php if($url=="FacturaDespacho" || $url=="FacturaDespachoConfiguracion"){ ?>
        <li class="active treeview">
                            <?php }else{ ?>
        <li class="treeview">
                            <?php } ?>
          <a href="#">
            <i class="fa fa-tags"></i> <span>Facturacion de Pedidos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?<?php echo $menu ?>&route=FacturaDespacho&action=Registrar"><i class="fa fa-tag"></i> Realizar Factura</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?<?php echo $menu ?>&route=FacturaDespacho&action=Registrar"><i class="fa fa-tag"></i> Realizar Factura</a></li>
                            <?php } ?>
                      <?php } ?>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
                            <?php } ?>
          <a href="#">
            <i class="fa fa-folder-open"></i> <span>Catalogos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?route=Catalogos&action=Registrar"><i class="fa fa-folder-open-o"></i> Registrar Catalogo</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?route=Catalogos&action=Registrar"><i class="fa fa-folder-open-o"></i> Registrar Catalogo</a></li>
                            <?php } ?>
            ...
            <li class="active"><a href="?route=Catalogos"><i class="fa fa-folder-open-o"></i> Ver Catalogos</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Catalogos"><i class="fa fa-folder-open-o"></i> Ver Catalogos</a></li>
                            <?php } ?>
            <?php } ?>

                      <?php if($_SESSION['nombre_rol']=="Superusuario"){ ?>
                            <?php if($url=="CatalogosBorrados" && empty($action)){ ?>
            <li class="active"><a href="?route=CatalogosBorrados"><i class="fa fa-folder-open-o"></i> Ver Catalogos Borrados</a></li>
                            <?php }else{ ?>
            <li><a href="?route=CatalogosBorrados"><i class="fa fa-folder-open-o"></i> Ver Catalogos Borrados</a></li>
                            <?php } ?>
                      <?php } ?>
          ...
          ?>
                  ...
                  <?php } ?>
                      <a href="?route=Reportes">
                        <i class="fa  fa-file-text" style="background:;"></i> <span>Reportes</span>
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                      </a>
            ...
            <li><a href="?route=Reportes&action=PorcentajePremiosSeleccionados"><i class="fa  fa-file-pdf-o"></i> Porcentaje De Premios <br>Seleccionados</a></li>
                            <?php } ?>  
                             ...
                             <?php //if($url=="Reportes" && !empty($action) && $action=="PorcentajePremiosSeleccionados2"){ ?>
            <!-- <li class="active "><a href="?route=Reportes&action=PorcentajePremiosSeleccionados2"><i class="fa  fa-file-pdf-o"></i> Porcentaje De Premios <br>Seleccionados 2</a></li> -->
                            <?php //}else{ ?>
            <!-- <li><a href="?route=Reportes&action=PorcentajePremiosSeleccionados2"><i class="fa  fa-file-pdf-o"></i> Porcentaje De Premios <br>Seleccionados 2</a></li> -->
                            <?php //} ?>                            
            ...
            <li class="active "><a href="?route=Reportes&action=PremiosSeleccionados"><i class="fa  fa-file-pdf-o"></i> Planes Y Premios <br>&nbsp&nbsp Seleccionados</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Reportes&action=PremiosSeleccionados"><i class="fa  fa-file-pdf-o"></i> Planes Y Premios <br>&nbsp&nbsp Seleccionados</a></li>
                            <?php } ?>
            ...
            <li class="active "><a href="?route=Reportes&action=PremiosEstructura"><i class="fa  fa-file-pdf-o"></i> Planes Y Premios <br>&nbsp&nbsp Por Estructura</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Reportes&action=PremiosEstructura"><i class="fa  fa-file-pdf-o"></i> Planes Y Premios <br>&nbsp&nbsp Por Estructura</a></li>
                            <?php } ?>
