      ...
      <div class="row">
        <div class="col-sm-12 col-md-10 ">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <?php
              if($banco['opcion_pago']=="Ambos"){
                $opcion_pago = "Transferencia y Pago Movil";
              }else{
                $opcion_pago = $banco['opcion_pago'];
              }
            ...
            <div class="box-body" style="padding: 0% 2%">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <?php $banco['tipo_cuenta']=="Ahorro" ? $mos = "Cuenta de ".$banco['tipo_cuenta'] : $mos = "Cuenta ".$banco['tipo_cuenta']; ?>
                  <h3><u> 
                    Banco <?=$banco['nombre_banco']?></u> (<?=$banco['codigo_banco']?>) - <u><i><?=$mos;?></i></u>
              ...
              <?php if($opcion_pago=="Pago Movil"){ ?>
              <div class="row">
                <div class="col-xs-12 col-md-12">
                    <h4><b>Nombre de Propietario</b></h4>
                    <input type="text" class="form-control" style="font-size:1.5em" value="<?=$banco['nombre_propietario']?>" readonly>
                </div>
              </div>
              <?php } ?>
              <?php if($opcion_pago!="Pago Movil"){ ?>
              <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <h4><b>Numero de Cuenta</b></h4>
                    <input type="text" class="form-control" style="font-size:1.5em" value="<?=separateDatosCuenta($banco['numero_cuenta'])?>" readonly>
                </div>
              </div>
              <?php } ?>
              <?php if($opcion_pago=="Transferencia"){ ?>
              <div class="row">
                <div class="col-xs-12 col-md-12">
                    <h4><b>Cedula de Propietario</b></h4>
                    <input type="text" class="form-control" style="font-size:1.5em" value="<?=$cedula_cuenta?>" readonly>
                </div>
              </div>
              <?php } ?>
              <?php if($opcion_pago!="Transferencia"){ ?>
              <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <h4><b>Teléfono de Propietario</b></h4>
                    <input type="text" class="form-control" style="font-size:1.5em" value="<?=separateDatosCuentaTel($banco['telefono_cuenta'])?>" readonly>
                </div>
              </div>
              <?php } ?>
              <br>
