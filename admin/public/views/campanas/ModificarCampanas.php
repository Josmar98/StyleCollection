        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Editar <?php echo "Campaña"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre_campana" value="<?php echo $campana['nombre_campana']; ?>" name="nombre_campana" maxlength="80" placeholder="Ingresar nombre de la campaña">
                       <span id="error_nombre_campana" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-3">
                       <label for="num_campana">Numero de campaña</label>
                       <input type="number" min="1" maxlength="2" max="10" class="form-control" value="<?php echo $campana['numero_campana']; ?>" id="num_campana" name="num_campana" maxlength="30" placeholder="Numero de campaña">
                       <span id="error_num_campana" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-3">
                       <label for="anio">Año de la campaña</label>
                       <input type="number" class="form-control" id="anio" minlength="4" maxlength="4" min="2020" value="<?php echo $campana['anio_campana']; ?>" name="anio" maxlength="30" placeholder="Año de la campaña">
...
function validar(){
  ...
  var rnum_campana = checkInput(num_campana, numberPattern);
