                          ...
                          <?php endif; ?>
                            <div style="border:1px solid <?=$color?>;">
                              ...
                              <div class="">
                                ...
                                <!-- <button class="btn enviar2 canjearBtn col-xs-12" style="font-size:1em;border:0;background:none;" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_catalogo'] ?>"><span class="fa fa-diamond"></span> Canjear <span class="fa fa-diamond"></span></button> -->

                                <!-- <a class="btn" style="font-size:1em;border:0;background:none;" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_catalogo'] ?>"><u><b><span class="fa fa-diamond"></span> Canjear <span class="fa fa-diamond"></span></b></u></a> -->

                                <a href="?route=<?=$url?>&action=Detalle&id=<?=$data['id_catalogo']?>" class="btn" style="font-size:1em;border:0;background:none;"><u><b>Ver Detalle</b></u></a>
