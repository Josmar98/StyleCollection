      ...
      <div class="row">
        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            ...
            <?php $cantidadPaginas = (!empty($_GET['paginas'])) ? $_GET['paginas'] : $index;  ?>
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="form-group col-xs-12 col-sm-6">
                     ...
                     <input type="text" class="form-control" id="codigo" value="<?=$catalogo['codigo_catalogo']?>" name="codigo" maxlength="30" placeholder="Ingresar el codigo del premio">
                ...
                <div class="row">
                  <?php for ($i=1;$i<=$cantidadPaginas;$i++){ ?>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      <?php if ($catalogo['imagen_catalogo'.$i]!=""){ ?>
                        <img src="<?=$catalogo['imagen_catalogo'.$i]; ?>" style='width:40%;border:1px solid #ccc'>
                      <?php } ?>
                    </div>
                  <?php } ?>
                </div>
...
$(document).ready(function(){
  ...
  $(".cantPaginas").change(function(){
    ...
    var ruta = '';
    // if(cant > 1){
    ruta = '?route='+route+'&action='+action+'&id='+id+'&paginas='+cant;
    // }else{
      // ruta = '?route='+route+'&action='+action+'&id='+id;
    // }
