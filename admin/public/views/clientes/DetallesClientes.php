  ...
  <div class="content-wrapper">
              ...
              <div class="row">
                ...
                <h4 style="margin-top:-1%;" class="col-xs-12 col-md-9 textPerfil">
                  <small style="font-size:.6em;"> 
                    <?=$rrollCliente?> de StyleCollection
                  </small> 
                  <!-- JAJAJAJA -->
                </h4>
                <!-- <br><br>
    ...
    <section class="content-header" style="margin-top:">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Detalles de Clientes</li>
      </ol>
    </section>
                ...
                <div class="form-horizontal">
                  ...
                  <?php if ($amClientesE==1): ?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Modificar&id=<?=$cliente['id_cliente']?>&aux=<?=$cliente['id_cliente']?>">
                    ...
                    foreach ($clientesss as $datas) {
                      if(!empty($datas['id_cliente'])){
                        if (!empty($pedidosClientes) && Count($pedidosClientes)>1){
                          Imprimir($cliente['id_cliente'], $datas, $lider, "0", $pedidosClientes);
                        }else{
                          Imprimir($cliente['id_cliente'], $datas, $lider, "0");                          
                        }
                      }
                    }
