        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Agregar Nuevos <?php echo "Lideres"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                  ...
                  <div class="row">
                    <div class="form-group col-sm-12">
                      ...
                      <select class="form-control select2" id="lider" name="lider">
                        ...
                        <option value="0">Ningun(a) Lider</option>
                            <?php 
                            foreach ($clientes as $data) {
                              if(!empty($data['id_cliente'])){
                            ?>
                        <option value="<?php echo $data['id_cliente'] ?>"><?php echo $data['primer_nombre']." ".$data['primer_apellido']." ".$data['cedula']; ?></option>
                            <?php 
                              }
                            }
                            ?>
    ...
    if(response == true){
      $(".btn-enviar").attr("disabled");
       ...
       swal.fire({ 
          ...
          if (isConfirm.value){
              $.ajax({
                    url: '?route=Clientes&action=Registrar',
                    type: 'POST',
                    data: {
                      validarData: true,
                      cedula: $("#cedula").val(),
