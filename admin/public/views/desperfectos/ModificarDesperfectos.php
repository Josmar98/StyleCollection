                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       <label for="fecha_inicio">Apertura de Desperfectos</label>
                        <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" value="<?=$desperfectos['fecha_inicio_desperfecto']?>">
                       <span id="error_fecha_inicio" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="fecha_final">Cierre de Desperfectos</label>
                        <input type="date" class="form-control" id="fecha_final" name="fecha_final" value="<?=$desperfectos['fecha_fin_desperfecto']?>">
