              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12">
                      <label for="nombre_camp">Titulo de la Campaña</label>
                      <input type="text" class="form-control" id="nombre_camp" name="nombre_camp" maxlength="150" placeholder="Ingresar titulo de la campaña">
                      <span id="error_nombre_producto" class="errors"></span>
                    </div>
                  </div>
                  
                  <?php foreach ($catalogos as $cata){ if(!empty($cata['codigo_producto_catalogo'])){ ?>
                    <div class="col-xs-12 producto<?=$cata['codigo_producto_catalogo']; ?>" style="border-bottom:1px solid #CCC;padding-top:5px;">
                      <div class="form-group col-xs-12" style="">
                        <label for="producto<?=$cata['codigo_producto_catalogo']; ?>" class="">
                        <input type="checkbox" class="productos" id="producto<?=$cata['codigo_producto_catalogo']; ?>" value="<?=$cata['codigo_producto_catalogo']; ?>" name="productos[]">
                          <?=$cata['nombre_producto_catalogo']; ?>
                          <?php if(!empty($cata['imagen_producto_catalogo'])){ ?>
                            <img style="width:5%" src="<?=$cata['imagen_producto_catalogo']; ?>">
                          <?php } ?>
                        </label>
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=EstructuraProductos";
      });
    }
    if(response == "2"){
      swal.fire({
...
function validar(){
  $(".btn-enviar").attr("disabled");
  /*===================================================================*/
  var nombre_producto = $("#nombre_camp").val();
  var rnombre_producto = checkInput(nombre_producto, alfanumericPattern3);
