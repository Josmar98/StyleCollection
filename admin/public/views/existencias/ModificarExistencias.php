                       ...
                       <select class="form-control select2" id="premios" name="premios">
                        ...
                        <?php 
                         foreach ($premios_planes as $data){ if(!empty($data['id_premio'])){
                          foreach ($existencias as $data2){if(!empty($data2['id_premio'])){ 
                                if($data['id_premio']==$data2['id_premio']){
                          ?>
                        <option <?php foreach ($existencias2 as $data3){if(!empty($data3['id_existencia'])){if($data3['id_premio']==$data['id_premio']){?>selected="selected"<?php }}} ?> value="<?php echo $data['id_premio'] ?>"><?php echo $data['nombre_premio']; ?></option>
                          <?php
                                } 
                          }} ?>
                        <?php
