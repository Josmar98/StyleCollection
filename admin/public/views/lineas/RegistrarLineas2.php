              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12">
                      ...
                      <input type="text" class="form-control" id="linea" name="linea" maxlength="150" placeholder="Línea de productos">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12">
                      ...
                      <input type="number" class="form-control" id="posicion" name="posicion" placeholder="Orden de la Línea de productos">
                    ...
                    <div class="col-xs-12 producto<?=$cata['codigo_producto_catalogo']; ?>" style="border-bottom:1px solid #CCC;padding-top:5px;">
                      <div class="form-group col-xs-12" style="padding:0;">
                        <label for="producto<?=$cata['codigo_producto_catalogo']; ?>" style="padding:10px;" class="">
                          <div class="form-group col-xs-12 col-md-6" style="border-right:1px solid #CCC;">
                            
                              <?php if(!empty($cata['imagen_producto_catalogo'])){ ?>
                                <img style="width:15%" src="<?=$cata['imagen_producto_catalogo']; ?>">
                              <?php } ?>
                          ...
                          <div class="form-group col-xs-12 col-md-6" style="">
                            Linea actual
                          </div>
                        </label>
