        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Posicionar <?php echo $url; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                                ...
                                <div class="form-group col-xs-12" style="padding:0;">
                                  <label for="producto<?=$cata['codigo_producto_catalogo']; ?>" style="padding:10px;" class="">
                                    <div class="form-group col-xs-12 col-md-8" style="border-right:1px solid #CCC;">
                                        ...
                                        <?php } ?>
                                        <input type="hidden" class="productos" value="<?=$cata['codigo_producto_catalogo']; ?>" name="productos[]">
                                        <input type="hidden" class="productos" value="<?=$key['id_linea_producto']; ?>" name="id[]">
                                        <?=$cata['nombre_producto_catalogo']; ?>
                                    </div>
                                    <div class="form-group col-xs-12 col-md-4">
                                      <label for="pos">Posición</label>
                                      <input type="number" class="form-control" value="<?=$key['posicion'] ?>" id="pos" name="posiciones[]">
                                    </div>
                                  </label>
