                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <select class="form-control select2 selectLider" id="lider" name="lider" style="width:100%;">
                      ...
                      <option <?php if (!empty($_GET['lider'])): if($data['id_cliente']==$_GET['lider']): ?>
                          selected="selected"
                      <?php endif; endif; ?> value="<?=$data['id_cliente']?>" 
                      <?php //foreach ($premios_perdidos_usados as $pclientes) { if(!empty($pclientes['id_cliente'])){ if($pclientes['id_cliente']==$data['id_cliente']){ ?>  <?php //} } } ?> ><?=$data['primer_nombre']." ".$data['primer_apellido']." ".$data['cedula']?></option>
                                          ...
                                          if (!empty($planstandard['id_plan_campana'])){
                                            if ($dataperdidos['valor'] == $planstandard['tipo_premio']){ ?>
                                                <tr class="codigoI"> <!-- INICIAL -->
                                                  ...
                                                  <td>
                                                    <select class="opciones" name="opts[I]" id="I">
                                                  ...
                                                  if ($planstandard['id_plan_campana']){
                                                    if ($data2['nombre_plan'] == $planstandard['nombre_plan']){
                                                      if ($planstandard['tipo_premio']=="Primer"){ ?>
                                                          <tr class="codigoS<?=$planstandard['id_premio']?>"> <!-- STANDARD -->
                                                            <td class="col1">
                                                              <?php echo $nuevoResult; ?>
                                                            </td>
                                                            <td class="col2">
                                                  ...
                                                  foreach ($premios_perdidos as $dataperdidos) {
                                                    if(!empty($dataperdidos['id_premio_perdido'])){
                                                      if(($dataperdidos['id_tipo_coleccion'] == $data3['id_tipo_coleccion']) && ($dataperdidos['id_tppc'] == $data3['id_tppc'])){
                                                        ...
                                                        if($nuevoResult>0){ ?>
                                                            <tr class="codigoP<?=$data3['id_premio']?>"> <!-- PRIMER PAGO -->
                                                              <td class="col1">
                                                                <?php echo $nuevoResult; ?>
                                                              </td>
                                                              <td class="col2">
                                          ...
                                          if (!empty($planstandard['id_plan_campana'])){
                                            if ($dataperdidos['valor'] == $planstandard['tipo_premio']){ ?>
                                                <tr class="codigoC"> <!-- SEGUNDO -->
                                                  ...
                                                  <td>
                                                    <select class="opciones" name="opts[C]" id="C">
                                                      <option value="Y">SI</option>
                                                      <option value="N">No</option>
                                                    </select>
                                                  </td>
