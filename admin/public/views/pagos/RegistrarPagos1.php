        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
                ...
                <div class="row">
                  <div class="form-group col-xs-12 col-sm-6">
                     ...
                     <select class="form-control select2" id="forma" name="forma" style="width:100%;">
                        <option></option>
                        <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Transferencia Banco a Banco"){ echo "selected"; } ?> >Transferencia Banco a Banco</option>
                        <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Transferencia de Otros Bancos"){ echo "selected"; } ?>>Transferencia de Otros Bancos</option>
                        <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Pago Movil Banco a Banco"){ echo "selected"; } ?>>Pago Movil Banco a Banco</option>
                        <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Pago Movil de Otros Bancos"){ echo "selected"; } ?>>Pago Movil de Otros Bancos</option>
                        <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Deposito En Dolares"){ echo "selected"; } ?>>Deposito En Dolares</option>
                                ...
                                <?php if ($vendedorLimiteFechasDivisas=="0"): ?>
                                    ...
                                    <?php if ($abonos < $primerPago): ?>
                                        <?php if ($actualDate <= $despacho['fecha_primera_senior']): ?>
                                                <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Divisas Dolares"){ echo "selected"; } ?>>Divisas Dolares</option>
                                                <option <?php if(!empty($_GET['formaPagar']) && $_GET['formaPagar']=="Efectivo Bolivares"){ echo "selected"; } ?>>Efectivo Bolivares</option>
                                        <?php endif; ?>
                                    <?php else: ?>
                  ...
                  <div class="form-group col-xs-12 col-sm-6">
                     ...
                     <label for="bancoPago">Bancos</label>
                      <?php if(!empty($_GET['formaPagar']) && !empty($_GET['bancoPagar']) && !empty($_GET['fechaPagar'])){ ?>
                            ...
                            <?php if ($_GET['formaPagar'] == "Pago Movil Banco a Banco" || $_GET['formaPagar'] == "Pago Movil de Otros Bancos"): ?>
                              <div class="bancosSelect bancosPM">                                 <select class="form-control select2 bancoPago bancoPagoPM" style="width:100%" name="bancoPago">
                                    <option value=""></option>
                                  <?php  foreach ($bancos as $data) { if(!empty($data['id_banco'])){ if($data['opcion_pago']=="Pago Movil" || $data['opcion_pago']=="Ambos"){  ?>
                                      <option <?php if($_GET['bancoPagar']==$data['id_banco']){ echo "selected"; } ?> value="<?php echo $data['id_banco'].'-'.$data['nombre_banco'] ?>" 
                            ...
                            <?php if ($_GET['formaPagar'] == "Transferencia Banco a Banco" || $_GET['formaPagar'] == "Transferencia de Otros Bancos"): ?>
                              <div class="bancosSelect bancosT">
                            ...
                            <?php if ($_GET['formaPagar'] == "Deposito En Bolivares"): ?>
                              <div class="bancosSelect bancosAll">
                            ...
                            <?php if ($_GET['formaPagar'] == "Deposito En Dolares"): ?>
                              <div class="bancosSelect bancosDivisas">
                            ...
                            <?php if ($_GET['formaPagar'] == "Efectivo Bolivares" || $_GET['formaPagar'] == "Divisas Dolares" || $_GET['formaPagar'] == "Divisas Dolares"): ?>
                              <div class="bancosEfectivo ">
                                 <select class="form-control select2 bancoPago bancoPagoE" style="width:100%" name="bancoPago">
                                    <option <?php if($_GET['bancoPagar']==$data['id_banco']){ echo "selected"; } ?> value="0-Efectivo">Efectivo</option>
                                 </select>
                              </div>
                            <?php endif; ?>
            ...
            <?php } ?>
                  ...
                  <?php if ($_GET['formaPagar'] == "Pago Movil Banco a Banco" || $_GET['formaPagar'] == "Pago Movil de Otros Bancos"): ?> ?>
                    <?php if ($_GET['nombreBancoPagar']!="Provincial"): ?>
                            ...
                            <div class="box-body">
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                     ...
                                     <input type="date" class="form-control fechaPago" min="<?=$limiteFechaMinimo?>" name="fechaPago" id="fechaPago" max="<?=date('Y-m-d')?>">
                                     <span id="error_fechaPago" class="errors"></span>
                                  </div>

                                  <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                     <label for="tasa">Tasa</label>
                                     <input type="number" step="0.01" class="form-control tasa" id="tasa" class="tasa" name="tasa" readonly="">
                    ...
                    <?php else: ?>
                      <?php if ($_GET['formaPagar'] == "Pago Movil Banco a Banco"): ?>
                      ...
                      <?php endif; ?>
                      <?php if ($_GET['formaPagar'] == "Pago Movil de Otros Bancos"): ?>
              ...
              <?php if (!empty($_GET['formaPagar']) && !empty($_GET['bancoPagar']) && !empty($_GET['fechaPagar']) ): ?>
                <?php if ($_GET['formaPagar'] == "Transferencia Banco a Banco" || $_GET['formaPagar'] == "Transferencia de Otros Bancos"): ?>
                  <?php if ($_GET['nombreBancoPagar']!="Provincial"): ?>
                    <div class="boxForm boxFormTransferencia" style="">
                  <?php else: ?>
                      ...
                      <form action="" method="post" role="form" class="form_register">
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                              ...
                              <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                 <label for="tasa">Tasa</label>
                                 <input type="number" step="0.01" class="form-control tasa" id="tasa" name="tasa" readonly="">
                                 <span id="error_tasa" class="errors"></span>
                              </div>
              ...
              <?php if (!empty($_GET['formaPagar']) && !empty($_GET['bancoPagar']) && !empty($_GET['fechaPagar']) ): ?>
                <?php if ($_GET['formaPagar'] == "Transferencia Banco a Banco" || $_GET['formaPagar'] == "Transferencia de Otros Bancos"): ?>
                  <?php if ($_GET['nombreBancoPagar']=="Provincial"): ?>
                    <div class="boxForm boxFormTransferenciaProvincial" style="">
                  <?php else: ?> 
              ...
              <?php if (!empty($_GET['formaPagar']) && !empty($_GET['bancoPagar']) && !empty($_GET['fechaPagar']) ): ?>
                <?php if ($_GET['formaPagar'] == "Pago Movil Banco a Banco" || $_GET['formaPagar'] == "Pago Movil de Otros Bancos"): ?>
                  <?php if ($_GET['nombreBancoPagar']!="Provincial"): ?>
                    <div class="boxForm boxFormPagoMovil" style="">
                  <?php else: ?>
                    <div class="boxForm boxFormPagoMovil" style="display:none">
                  <?php endif; ?>
                <?php endif; ?>
              ...
              <?php if (!empty($_GET['formaPagar']) && !empty($_GET['bancoPagar']) && !empty($_GET['fechaPagar']) ): ?>
                <?php if ($_GET['formaPagar'] == "Pago Movil Banco a Banco"): ?>
                  <?php if ($_GET['nombreBancoPagar']=="Provincial"): ?>
                    <div class="boxForm boxFormPagoMovilProvincial1" style="">
                  <?php else: ?>
                    <div class="boxForm boxFormPagoMovilProvincial1" style="display:none">
                  <?php endif; ?>
                <?php endif; ?>
              ...
              <?php if (!empty($_GET['formaPagar']) && !empty($_GET['bancoPagar']) && !empty($_GET['fechaPagar']) ): ?>
                <?php if ($_GET['formaPagar'] == "Pago Movil de Otros Bancos"): ?>
                  <?php if ($_GET['nombreBancoPagar']=="Provincial"): ?>
                    <div class="boxForm boxFormPagoMovilProvincial2" style="">
                  <?php else: ?>
                    <div class="boxForm boxFormPagoMovilProvincial2" style="display:none">
                  <?php endif; ?>
                <?php endif; ?>
  ...
  $(".enviar2").click(function(){
   ...
   $(".fechaPago").change(function(){
    ...
    if(fecha != ""){
      ...
      // alert(bancoPago);
      // alert(fecha);
      var url = '?campaing='+campaing+'&n='+n+'&y='+y+'&dpid='+dpid+'&dp='+dp+'&route=Pagos&action=Registrar&formaPagar='+formaPago+'&bancoPagar='+idBanco+'&nombreBancoPagar='+bancoPago+'&fechaPagar='+fecha;
      // alert(url);
