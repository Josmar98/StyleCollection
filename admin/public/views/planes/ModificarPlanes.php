              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre_plan" name="nombre_plan" value="<?php echo $plan['nombre_plan']; ?>" maxlength="90" placeholder="Ingresar nombre del plan">
                       <span id="error_nombre_plan" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="cantidad">Cantidad de colecciones</label>
                      <input type="number" class="form-control" step="1" id="cantidad" name="cantidad" value="<?php echo $plan['cantidad_coleccion'] ?>" maxlength="30" placeholder="Cantidad de Coleccion del plan">
...
function validar(){
  ...
  var rnombre_plan = checkInput(nombre_plan, alfanumericPattern2);
  if( rnombre_plan == false ){
    if(nombre_plan.length != 0){
      $("#error_nombre_plan").html("El nombre del plan no debe contener caracteres especiales");
    }else{
      $("#error_nombre_plan").html("Debe llenar el campo de nombre del plan ");      
    }
  }else{
    $("#error_nombre_plan").html("");
  }
  /*===================================================================*/
  ...
  /*===================================================================*/
  var result = false;
  if( rnombre_plan==true && rcantidad==true){
    result = true;
  }else{
    result = false;
  }
