              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                       ...
                       <div class="input-group">
                        <span class="input-group-addon">$</span> 
                        <input type="number" class="form-control" step=".1"  value="<?php echo $data['primer_descuento'] ?>" id="descuento_primer" name="descuento_primer" maxlength="30" placeholder="Precio del producto">
                       </div>
                    ...
                    <div class="form-group col-sm-4">
                       ...
                       <div class="input-group">
                        <span class="input-group-addon">$</span> 
                        <input type="number" class="form-control" step=".1" value="<?php echo $data['segundo_descuento'] ?>" id="descuento_segundo" name="descuento_segundo" maxlength="30" placeholder="Precio del producto">
                       </div>
