        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Agregar <?php echo "Planes de campaña"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <select class="form-control select2" id="planes" name="planes">
                        ...
                        ?>
                        <option <?php foreach ($planes_campana as $data2){if(!empty($data2['id_plan_campana'])){ if($data['id_plan']==$data2['id_plan']){  echo "disabled";  } }} ?> value="<?php echo $data['id_plan'] ?>"><?php echo $data['nombre_plan']; ?></option>
                        <?php
                           }
                         }
                        ?>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="color" class="form-control" name="color_plan">
                    </div>
                  ...
                  <div class="row">
                    <div class="form-group col-sm-4">
                       ...
                       <div class="input-group">
                        ...
                        <input type="number" class="form-control" step=".1" id="descuento_directo" name="descuento_directo" maxlength="30" placeholder="Descuento directo de coleccion">
                       </div>
                       <span id="error_descuento_directo" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-4">
                       <label for="descuento_primer">Descuento 1er pago puntual</label>
                       <div class="input-group">
                        <span class="input-group-addon">$</span> 
                        <input type="number" class="form-control" step=".1" id="descuento_primer" name="descuento_primer" maxlength="30" placeholder="Precio del producto">
                       </div>
                       <span id="error_descuento_primer" class="errors"></span>
                    </div>
                    <div class="form-group col-sm-4">
                       <label for="descuento_segundo">Descuento 2do pago puntual</label>
                       <div class="input-group">
                        <span class="input-group-addon">$</span> 
                        <input type="number" class="form-control" step=".1" id="descuento_segundo" name="descuento_segundo" maxlength="30" placeholder="Precio del producto">
                       </div>
                       <span id="error_descuento_segundo" class="errors"></span>
                    </div>
                  </div>
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        var n = $(".n").val();
        var y = $(".y").val();
        window.location = "?campaing="+campaing+"&n="+n+"&y="+y+"&route=PlanesCamp";
      });
    }
    if(response == "2"){
      swal.fire({
