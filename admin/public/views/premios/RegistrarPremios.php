              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre_premio" name="nombre_premio" maxlength="150" placeholder="Ingresar nombre del premio">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="precio" name="precio" maxlength="20" placeholder="Precio del premio">
                       </div>
                  ...
                  <div class="row">
                    <div class="form-group col-sm-12">
                      ...
                      <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion del premio" maxlength="200" style="height:60px;max-height:60px;min-height:60px;width:100%;min-width:100%;max-width:100%;"></textarea>
