              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="codigo" value="<?=$catalogo['codigo_producto_catalogo']?>" name="codigo" maxlength="30" placeholder="Ingresar el codigo del premio">
                       <span id="error_codigo" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="nombre">Nombre de premio</label>
                       <input type="text" class="form-control" id="nombre" value="<?=$catalogo['nombre_producto_catalogo']?>" name="nombre" maxlength="150" placeholder="Ingresar nombre del premio">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="file" class="form-control" id="imagen" name="imagen" maxlength="100" placeholder="Ingresar la imagen del premio">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      <?php if ($catalogo['imagen_producto_catalogo']!=""){ ?>
                        <img src="<?=$catalogo['imagen_producto_catalogo']; ?>" style='width:40%;border:1px solid #ccc'>
                      <?php } ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      <?php if ($catalogo['ficha_producto_catalogo']!=""){ ?>
                        <img src="<?=$catalogo['ficha_producto_catalogo']; ?>" style='width:40%;border:1px solid #ccc'>
                      <?php } ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      <?php if ($catalogo['ficha_producto_catalogo2']!=""){ ?>
                        <img src="<?=$catalogo['ficha_producto_catalogo2']; ?>" style='width:40%;border:1px solid #ccc'>
                      <?php } ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      <?php if ($catalogo['ficha_producto_catalogo3']!=""){ ?>
                        <img src="<?=$catalogo['ficha_producto_catalogo3']; ?>" style='width:40%;border:1px solid #ccc'>
                      <?php } ?>
                    </div>
                  </div>
