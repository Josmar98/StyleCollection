...
if($_SESSION['nombre_rol']!="Vendedor"){	
	...
	if(!empty($_GET['permission']) && $_GET['permission'] == 1 ){
		$query = "UPDATE factura_personalizada SET estatus = 0 WHERE id_factura_personalizada = $id";
	...
	if(empty($_POST)){
		...
		$query = "SELECT * FROM clientes, factura_personalizada WHERE factura_personalizada.id_cliente=clientes.id_cliente and factura_personalizada.estatus = 1";
