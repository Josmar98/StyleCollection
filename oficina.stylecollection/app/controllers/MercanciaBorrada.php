...
if($amPremiosC == 1){
	...
	$mercancia=$lider->consultarQuery("SELECT * FROM mercancia WHERE estatus = 0 ORDER BY mercancia asc;");

	if(!empty($_GET['permission']) && $_GET['permission'] == 1 ){
		if($amPremiosB == 1){

			$query = "UPDATE mercancia SET estatus = 1 WHERE codigo_mercancia = '$cod'";
