...
if(!empty($_POST)){
	...
	$n = 0;
	$responses = [];
	$exec = $lider->eliminar("DELETE FROM confignotaentrega WHERE id_campana = $id_campana");
	if($exec['ejecucion']==true){
		foreach ($planes as $id_plan) {
			$query = "INSERT INTO confignotaentrega (id_config_nota, id_campana, id_plan, opcion, estatus) VALUES (DEFAULT, $id_campana, $id_plan, $opciones[$n], 1)";
