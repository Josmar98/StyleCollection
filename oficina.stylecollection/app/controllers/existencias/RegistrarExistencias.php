...
if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario"){
  ...
  if(!empty($_POST['premios']) && !empty($_POST['cantidad_existencia']) ){
    ...
    $existencia = $_POST['cantidad_existencia'];
            ...
            $query = "INSERT INTO existencias (id_existencia, id_premio, id_campana, cantidad_existencia, cantidad_existencia_real, estatus) VALUES (DEFAULT, $id_premio, $id_campana, $existencia, $existencia, 1)";
