...
<div class='row col-xs-12' style='padding:0;margin:0;'>
	<div class='col-xs-12'  style='padding-left:50px;padding-right:20px;width:100%;'>
		...
		$font = "times new roman";
			...
			<img src='public/assets/img/iconoSinFondo.png' style='width:25em;height:30em;position:absolute;z-index:-10%;top:12%;left:33%;opacity:0.2;'>
			<div class='row'>
				<div class='col-xs-12'>
					";
									...
									<td class='celcontentR' style='width:60%;'><span class='content-table'>
										<small style='font-size:0.95em;'>
											...
											foreach($listaColecciones as $list){
												if($list['cant']>0){
													$info .= "".$list['cant']." ".$list['descripcion']."<br>";
												}
											}
							...
							<div class='box-content-final-R' style='text-align:right;'>
								...
								if($numero==$numeroReal&&$numero==$numerosCols){
									...
									<table style='width:100%;'>
										...
										<tr>
											<td class='celtitleR'><b>Total Operacion: </b></td>
											<td class='celcontentR'><b><span class='content-table'>
...
$dompdf->render();
$dompdf->stream("StyleCollection Nota ".$num_factura." - ".$factura['primer_nombre'], array("Attachment" => false));
