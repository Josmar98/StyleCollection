...
$dompdf = new Dompdf();
  ...
  $anio_campana = $_GET['y'];
	...
	$facturas = $lider->consultarQuery($query);
	 ...
	 if(strlen($num_factura2)==2){$num_factura = "0000".$num_factura2;}

	 if(strlen($num_factura2)==3){$num_factura = "000".$num_factura2;}

	 if(strlen($num_factura2)==4){$num_factura = "00".$num_factura2;}

	 if(strlen($num_factura2)==5){$num_factura = "0".$num_factura2;}

	 if(strlen($num_factura2)==6){$num_factura = $num_factura2;}
					...
					<div class='box-content-final'>
						...
						<table style='width:100%;'>
							...
							<tr>
								...
								<td class='celcontentR'><span class='content-table'>".number_format($precio_final_factura,2,',','.')." Bs</span></td>
