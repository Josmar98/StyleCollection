<?php 
	...
	$meses = ['01'=>"En", '02'=>"Feb", '03'=>"Mar", '04'=>"Abr", '05'=>"May", '06'=>"Jun", '07'=>"Jul", '08'=>"Ago", '09'=>"Sept", '10'=>"Oct", '11'=>"Nov", '12'=>"Dic"];
	...
	if( 
		...
		$query="SELECT *, factura_ventas.estatus as estado_ventas, factura_despacho.estatus as estado_factura FROM factura_ventas, factura_despacho, pedidos, despachos, clientes WHERE factura_ventas.id_factura_despacho = factura_despacho.id_factura_despacho and factura_despacho.id_pedido=pedidos.id_pedido and pedidos.id_despacho=despachos.id_despacho and pedidos.id_cliente=clientes.id_cliente and factura_despacho.fecha_emision BETWEEN '{$inicioFecha}' AND '{$finFecha}' and factura_ventas.estatus=1 ORDER BY factura_despacho.fecha_emision, factura_despacho.numero_factura, factura_despacho.numero_control1 ASC;";
