			...
			if(Count($buscar)<2){
				...
				if(Count($buscar)<2){
					...
					if($id_banco==""){
						...
						$query = "INSERT INTO pagos (id_pago, id_pedido, id_campana, fecha_pago, fecha_registro, forma_pago, tipo_pago, referencia_pago, monto_pago, tasa_pago, equivalente_pago, estado, estatus) VALUES (DEFAULT, $id_pedido, $id_campana, '$fechaPago', '".date('Y-m-d')."', '$forma_pago', '$tipoPago', '$serial', '$monto', '$tasa', '$eqv', 'Abonado', 1)";
						// echo $query;
					}else{
						// echo $id_banco."<br>";
						if($referencia!=""){
