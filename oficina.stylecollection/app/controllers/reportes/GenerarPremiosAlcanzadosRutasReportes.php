...
if($amReportesC == 1){
	...
	$id_despacho = $_GET['id'];
      ...
      $id_ruta = $_GET['ruta'];
      $ruta = $lider->consultarQuery("SELECT * FROM rutas WHERE id_ruta = $id_ruta");
      $nombre_ruta = $ruta[0]['nombre_ruta'];
      $order = $_GET['order'];
      $clientess = $lider->consultarQuery("SELECT * FROM rutaslideres, clientes, pedidos WHERE rutaslideres.id_cliente = clientes.id_cliente and clientes.id_cliente = pedidos.id_cliente and pedidos.id_despacho = {$id_despacho} and rutaslideres.id_ruta = {$id_ruta} ORDER BY rutaslideres.posicion {$order}");
	...
	<head>
		...
		<title>Premios Alcanzados (Ruta de {$nombre_ruta}) - Campaña ".$numeroCampana."/".$anioCampana." - StyleCollection</title>
	...
	<div class='row' style='padding:0;margin:0;'>
		<div class='col-xs-12'  style='width:100%;'>
			...
			<h2 style='font-size:1.9em;'> Premios Alcanzados (Ruta de {$nombre_ruta})- Campaña ".$numeroCampana."/".$anioCampana."</h2>
			<br>
		";		
