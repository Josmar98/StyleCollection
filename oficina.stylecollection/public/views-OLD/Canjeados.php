                      ...
                      <?php 
                        ...
                        foreach ($premiosCanjeados as $data2) { if(!empty($data2['id_canjeo'])){
                          if($data['id_cliente'] == $data2['id_cliente']){
                            // $cantidadUnidad = 1;
                            $cantidadUnidad = $data2['unidades'];
                            $cantGemasUnidad = ($cantidadUnidad*$data2['cantidad_gemas']);
                            // echo $cantGemasUnidad."<br>";
                            if(!empty($premiosTotales[$data2['id_catalogo']])){
                              // $premiosTotales[$data2['id_catalogo']]['gemas'] += $data2['cantidad_gemas'];
                              $premiosTotales[$data2['id_catalogo']]['gemas'] += $cantGemasUnidad;
                              $premiosTotales[$data2['id_catalogo']]['cantidad'] += $cantidadUnidad;

                            }else{
                              $premiosTotales[$data2['id_catalogo']] = ['name'=>$data2['nombre_catalogo'], 'gemas'=>$cantGemasUnidad, 'precio'=>$data2['cantidad_gemas'], 'cantidad'=>$cantidadUnidad];                                    
                            }
                        ?>
                            ...
                            <tr>
                              <td>
                                <span class="contenido2" style='color:#000'>
                                  <?php echo "<img style='width:20px;margin-right:1px;' src='{$fotoGema}'> ".$data2['cantidad_gemas']." <span style='margin-right:5px;margin-left:5px;'>-</span> "." (".$data2['unidades']." Unds) ".$data2['nombre_catalogo']." -> ";
                                  $premiosTotales;
                        ...
                        <?php } else { ?>
                          <tr>
                            <td>
                              <span class="contenido2">
                                <?php echo "<img style='width:20px;margin-right:1px;' src='{$fotoGema}'> ".$data2['cantidad_gemas']." <span style='margin-right:5px;margin-left:5px;'>-</span> "." (".$data2['unidades']." Unds) ".$data2['nombre_catalogo']."<br><small> (".$lider->formatFecha($data2['fecha_canjeo'])."-".$data2['hora_canjeo'].")</small><br>"; ?>
                              </span>
                            </td>
                            <?php if ($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Analista Supervisor2" || $_SESSION['nombre_rol']=="Analista2"): ?>
                            <td>
