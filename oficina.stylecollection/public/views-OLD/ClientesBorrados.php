    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo "Lideres Suspendidos"; ?></li>
              ...
              <br>
              <div style="width:100%;text-align:center;"><a href="?route=Clientes&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar Lideres</a></div>
              <?php } ?>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            ?>
                <tr>
                  ...
                  <td style="width:10%">
                    <!-- <table style="background:none;text-align:center;width:100%"> -->
                      <!-- <tr> -->
                        ...
                        <!-- <td style="width:50%"> -->
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=Clientes&action=Modificar&id=<?php echo $data['id_cliente'] ?>">
                        ...
                        <?php if ($amClientesB): ?>
                        <!-- <td style="width:50%"> -->
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=Clientes&id=<?php echo $data['id_cliente'] ?>&permission=1">
                  ...
                  <td style="width:5%">
                    <span class="contenido2">
                    <a href="?route=Clientes&action=Detalles&id=<?php echo $data['id_cliente'] ?>">
