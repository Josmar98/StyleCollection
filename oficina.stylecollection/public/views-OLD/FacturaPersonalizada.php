      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <?php 
              $num = 1;
              foreach ($facturas as $data){ if(!empty($data['id_factura_personalizada'])){ 
                $continuar = false;
                if($accesoBloqueo=="1"){
                ...
                if($continuar == true){
                  ...
                  <tr>
                    ...
                    <td style="width:20%">
                        <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=<?=$url; ?>&action=Modificar&id=<?=$data['id_factura_personalizada']?>">
                          <span class="fa fa-wrench"></span>
                        </button>
                        <?php if($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Administrativo"){ ?>
                        <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?<?=$menu3; ?>route=<?=$url; ?>&id=<?=$data['id_factura_personalizada']; ?>&permission=1">
                      ...
                      <table style="background:;text-align:center;width:100%">
                        <tr>
                          <td style="width:50%">
                                ...
                                <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=GenerarFactura&id=<?php echo $data['id_factura_personalizada'] ?>&t=2">
                                  Factura Personalizada
                                </a>

                                <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=GenerarFacturaSP&id=<?php echo $data['id_factura_personalizada'] ?>&t=2">
                                  Factura Sin Precio
                                </a>

                                <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=GenerarNota&id=<?php echo $data['id_factura_personalizada'] ?>&t=2">
                                  Nota de entrega
                                </a>
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        var dpid = $(".dpid").val();
        var dp = $(".dp").val();
        window.location = "?campaing="+campaing+"&n="+n+"&y="+y+"&dpid="+dpid+"&dp="+dp+"&route=FacturaPersonalizada";
      });
    }
    if(response == "2"){
      swal.fire({
