                          ...
                          <th style='padding:0;margin:0;'>
                            ...
                            <?php
                              ...
                              if( $abonadosPagos[$pagosR['id']] != 0){
                                $totalesPagos[$pagosR['id']] = $abonadosPagos[$pagosR['id']] / $precio;
                              }else{
                  ...
                  <table id="" class="table table-bordered table-striped datatablee" style="text-align:center;min-width:100%;max-width:100%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><h4><b style="color:<?=$colorText; ?>">$<?=number_format($equivalenciasT,2, ",",".")?></b></h4></td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td style="width:8.5%"><?=$nuevoTotal." | ".$descuentosTotales; ?></td>
                        <td><h4>Monto: </h4></td>
                        <td><h4><b><?=number_format($montosT,2, ",",".")?></b></h4></td>
