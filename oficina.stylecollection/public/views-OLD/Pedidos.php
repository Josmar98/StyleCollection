                    ...
                    <div class="box-body">
                      ...
                      <div class="container text-center" style="width:100%;">
                            ...
                            <div class="col-md-4">
                                            ...
                                            if($pagosPlanesCamp['tipo_pago_plan_campana']==$key['name']){
                                              if(!empty($pagosPlanesCamp['descuento_pago_plan_campana']) && $pagosPlanesCamp['descuento_pago_plan_campana']>0){ ?>
                                                <tr>
                                                  ...
                                                  ?>
                                                  <td><b><?php echo "Plan ".$col['nombre_plan']; ?></b></td>
                                                  <td><b> <?php echo "$".number_format($pagosPlanesCamp['descuento_pago_plan_campana'],2,',','.'); ?></b></td>
                                                  <td><?php echo " x "; ?></td>
                                                  <td><b style="color:#ED2A77;"><?php echo $multi; ?> <small>Col.</small></b></td>
                                                  <td><?php echo " = "; ?></td>
                                                  <td><b style="color:#0c0;">
                              ...
                              <?php
                                $totalDescuentoVendedor = $total_descuento_distribucion + 
                                                          ...
                                                          // $totalDescuentoVendedor+=1692.02;
                              ?>
                          ...
                          <?php
                            ...
                            // ============================== // ================================== // ============================== //
                            // echo "<br>total_responsabilidad: ".$total_responsabilidad;
                            // echo "<br>abonado_lider_gemas: ".$abonado_lider_gemas;
                            // echo "<br>porcentajeAbonadoPuntual: ".$porcentajeAbonadoPuntual;
                          ?>
