                ...
                <tr>
                  ...
                  <td >
                    <?php if ($amPremioscampB==1): ?>
                      <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=<?php echo $url; ?>&id=<?php echo $data['id_reto_campana'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        var n = $(".n").val();
        var y = $(".y").val();
        window.location = "?campaing="+campaing+"&n="+n+"&y="+y+"&route=RetosCampBorrados";
      });
    }
    if(response == "2"){
      swal.fire({
