...
$(document).ready(function(){
  var w1 = $(window).width();
  $(".main-header").removeClass("bg-fucsia");
  $(".main-header").addClass($("#nlogo").attr("class"));
  if(w1 <= 768){
    var w2 = 0;
  }else{
    var w2 = $(".main-sidebar").width();
  }
  var ww = 100 - (w2*100/w1);
  var st1 = $(".navbar-static-top").attr("style");
  $(".navbar-static-top").attr("style",st1+";width:"+ww+"% !important;");
      ...
      // var ruta = "?campaing="+campaing+"&n="+num_campaing+"&y="+year_campaing+"&dpid="+despacho_id+"&dp="+num_despacho+"&route=Pedidos";
        ...
        if(cantidadAll > 0){
          if(cantidad > 0){
            ...
            $(".cantidad_notificaciones").attr("style","background:red;border:1px solid #d00");
          }
          var notificA = "";
          var notificF = "";
          var html = "";
          for (var i = 0; i < cantidadAll; i++) {
            ...
            if(dataJson[i].visto_admin==0){
              notificA = "<li style='background:#ddd;width:100%;'><a href='"+ruta+"'><i class='fa fa-user text-success'></i> ";
            }else{
              notificA = "<li style='width:100%;'><a href='"+ruta+"'><i class='fa fa-user text-aqua'></i> ";              
            }
            notificF = "</a></li>";
            html += notificA;
          ...
          for (var i = 0; i < cantidadAll; i++) {
            if(dataJson[i].cantidad_aprobado > 0){
              ...
              if(dataJson[i].visto_cliente==2){
                notificA = "<li style='background:#ddd'><a href='"+ruta+"'><i class='fa fa-user text-aqua'></i> ";
              }else{
                notificA = "<li><a href='"+ruta+"'><i class='fa fa-user text-aqua'></i> ";              
              }
          ...
          for (var i = 0; i < dataJson2.data.length; i++) {
            ...
            if(dataJson['limite']){ //Hay fecha limite cerca
              ...
              if(dias!="-1"){
                ...
                $(".Informaciones").attr("style","font-size:0.8em;background:red;border:1px solid #000;color:#fff");
                ...
                // alert("Quedan "+dias+cantDias+" para realizar pedido del despacho "+despacho['numero_despacho']+" de Campaña "+campana['numero_campana']+"/"+campana['anio_campana']);
                  ...
                  notificA = "<li style='background:#FFF;padding:10px;'><a style='color:#222;background:#ddd'><i style='font-size:1.5em;color:red' class='fa fa-user text-danger' ></i> "; 
                  notificF = "</a></li>";
                  html += notificA;
