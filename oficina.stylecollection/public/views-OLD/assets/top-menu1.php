...
.d-none{
  ...
  <header class="main-header bg-fucsia">
    <!-- Logo -->
    <?php
      if(!empty($_GET['campaing']) && !empty($_GET['dpid'])){
        // echo "Dentro de PEDIDO";
        $fondoLogo = "background:#112255 !important;";
        $bgtemp = "bg-nivel3";
      }else if(!empty($_GET['campaing']) && empty($_GET['dpid'])){
        // echo "Dentro de Campaña";
        $fondoLogo = "background:#112255 !important;";
        $bgtemp = "bg-nivel2";
      }else if(empty($_GET['campaing']) && empty($_GET['dpid'])){
        $fondoLogo = "background:#0D0D0D !important;";
        $bgtemp = "bg-nivel1";
      }
    ?>
    <!-- <input type="color" name=""> -->
    <div class="logo" style="<?=$fondoLogo;?>border:none;margin:0;padding:0;">
        <a href="./" id="nlogo" class="<?=$bgtemp;?>">
        <span class="logo-lg color-completo" style="padding:0;margin:0;background:;border-bottom:red;"><b class="color-corto">Style</b>Collection</span>
            <!-- <span class="logo-mini color-completo"><b class="color-corto">S</b>tyle</span> -->
        </a>
    </div>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="height:15%;box-sizing:border-box;">
            
      <!-- Sidebar toggle button-->
      <!-- <style type="text/css">.sidebar-toggle:hover{background: red}</style> -->
      <span href="#" class="sidebar-toggle text-center" data-toggle="push-menu" role="button" style="background:;position:absolute;top:-10%;height:100%;margin:0;padding:0;width:3em;">
        ...
        <ul class="nav navbar-nav" style="">
          ...
          <li class="dropdown notifications-menu" style="font-size:;">
            <a href="#" class="dropdown-toggle box_notificaciones" data-toggle="dropdown">
              <span class="fa fa-bell-o" style="font-size:1.2em"></span>
              <span class="label cantidad_notificaciones d-none">10</span>
            </a>
            <ul class="dropdown-menu" class="notification" style="padding:0 !important;margin:0 !important;"><!-- style="width:320px" -->
              <li class="header" style="width:100%;">
                <b style="">Tiene <span class="cantidadNoVista"></span> <span class="tipoNovista"></span></b></li>
              <li>
