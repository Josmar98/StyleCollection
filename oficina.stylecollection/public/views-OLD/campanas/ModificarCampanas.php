              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                       ...
                       <input type="number" min="1" max="10" step="0.1" class="form-control" value="<?php echo $campana['numero_campana']; ?>" id="num_campana" name="num_campana" maxlength="3" placeholder="Numero de campaña">
                       <span id="error_num_campana" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-3">
                       <label for="anio">Año de la campaña</label>
                       <input type="number" class="form-control" id="anio" minlength="4" maxlength="4" min="2020" value="<?php echo $campana['anio_campana']; ?>" name="anio" placeholder="Año de la campaña">
