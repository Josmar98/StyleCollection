              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-4">
                       ...
                       <input type="text" class="form-control nombreConfig" id="nombreConfig" value="<?=$configgema['nombreconfiggema']?>" name="nombreConfig" placeholder="por ..." <?php if ($_SESSION['nombre_rol']!="Superusuario"): ?>
                         readonly=''
                       <?php endif ?>>
                    ...
                    <div class="form-group col-xs-12 col-sm-4">
                       ...
                       <input type="number" class="form-control cantidad" id="cantidad" name="cantidad" value="<?=$configgema['cantidad_correspondiente']?>" maxlength="20" placeholder="1">
                    ...
                    <div class="form-group col-xs-12 col-sm-4">
                       ...
                       <select class="form-control condicion" name="condicion" id="condicion">
                         <option <?php if ($configgema['condicion']=="Multiplicar"){ echo "selected=''";} ?>>Multiplicar</option>
                         <option <?php if ($configgema['condicion']=="Dividir"){ echo "selected=''";} ?>>Dividir</option>
                       </select>
                       <span id="error_cantidad" class="errors"></span>
                    </div>
                  </div>
