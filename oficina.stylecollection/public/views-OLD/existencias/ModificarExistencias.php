                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <select class="form-control select2" id="premios" name="premios">
                        <!-- <option value=""></option> -->
                        <?php 
                          foreach ($premios_planes as $data){ if(!empty($data['id_premio'])){
                            ?>
                              <option <?php foreach ($existencias as $data2){ if(!empty($data2['id_premio'])){ if($data['id_premio']==$data2['id_premio']){ foreach ($existencias2 as $data3){if(!empty($data3['id_existencia'])){if($data3['id_premio']==$data['id_premio']){ echo 'selected="selected"'; } if($data3['id_premio']!=$data['id_premio']){ echo 'disabled="disabled"'; } }} } }} ?> value="<?php echo $data['id_premio'] ?>" ><?php echo $data['nombre_premio']; ?></option>
                            <?php
                          }}
                        ?>
                       </select>
                    ...
                    <div class="form-group col-sm-6">
                       <label for="cantidad_existencia">Cantidad Disponible</label>
                        <input type="number" class="form-control" step="1" min='0' value="<?=$existencias2[0]['cantidad_existencia_real']?>" id="cantidad_existencia" name="cantidad_existencia" placeholder="Cantidad de Existencia Disponible">
                       <span id="error_cantidad_existencia" class="errors"></span>
                       <input type="hidden" name="id_existencia" value="<?=$existencias2[0]['id_existencia']?>">
                    </div>
