    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo " Liderazgos"; ?></li>
          ...
          <br>
              <div style="width:100%;text-align:center;"><a href="?<?php echo $menu; ?>&route=<?php echo $url ?>" class="color_btn_sweetalert" style="text-decoration-line:underline;">Ver Liderazgos de Campaña</a></div>
    <!-- Main content -->
        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Agregar Nuevos <?php echo "Liderazgos de Campaña"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                  ...
                  <div class="row">
                    <div class="form-group col-sm-12">
                       ...
                       <select class="form-control select2" id="titulo" name="titulo">
                          <option value=""></option>
                        <?php foreach ($liderazgos as $data):?>
                          <?php if (!empty($data['id_liderazgo'])): ?>
                          <option <?php foreach ($liderss as $lid): ?>
                              <?php if (!empty($lid['id_liderazgo'])): ?>
                                  <?php if ($lid['id_liderazgo'] == $data['id_liderazgo']): ?>
                                      disabled=''
                                  <?php endif ?>                            
                              <?php endif ?>
                          <?php endforeach ?> 
                  ...
                  <div class="row">
                      <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" min="0" step="0.01" class="form-control" id="descuento_coleccion" name="descuento_coleccion" placeholder="Descuento de cada coleccion">
                        </div>
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon">$</span>
                          <input type="number" min="0" step="0.01" class="form-control" id="total_descuento" name="total_descuento" placeholder="Descuento acumulado de cada coleccion" readonly="">
                        </div>
