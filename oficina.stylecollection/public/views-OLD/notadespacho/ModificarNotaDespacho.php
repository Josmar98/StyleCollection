        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Modificar <?php echo "Nota de Despacho"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php 
              ...
              <div class="box-body">
                  <div class="row">
                      <div class="form-group col-sm-6">
                       ...
                       <input type="number" class="form-control" name="num_nota" value="<?php echo $numero_nota; ?>" readonly>
                       <span id="error_fecha1" class="errors"></span>
                    </div>
                    <!-- <div class="form-group col-sm-6">
                       <label for="forma">Forma de pago</label>
                       <select class="form-control select2" id="forma" name="forma">
                          <option <?php if($nota_despacho['tipo_nota']=="Crédito"){ echo "selected"; } ?> >Crédito</option>
                          <option <?php if($nota_despacho['tipo_nota']=="Contado"){ echo "selected"; } ?> >Contado</option>
                       </select>
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <?php 
                          foreach ($despachos as $desp){ if(!empty($desp['id_despacho'])){
                            // print_r($desp);
                            // echo "<br>";
                            $nitem = "";
                       ...
                       <select class="form-control select2" id="pedidoss" name="pedidoss[]" multiple="multiple">
                          ...
                          <?php foreach ($despachos as $desp){ if(!empty($desp['id_despacho'])){ 
                            ...
                            ?>
                            <option value="<?=$desp['id_despacho']; ?>" <?php if($nota_despacho['cantidad_colecciones'.$nitem]>0){ echo "selected"; } ?> >
                              <?php
                  ...
                  <div class="row">
                    <div class="form-group col-sm-6">
                       ...
                       <select class="form-control select2" id="pedido" name="pedido" readonly>
                          <option value=""></option>
                                    ...
                                    if(!empty($struct['id_cliente'])){
                                      if($struct['id_cliente']==$data['id_cliente']){
                                        ...
                                        <option value="<?php echo $data['id_pedido'] ?>" 
                                              <?php
                                                    if($data['id_pedido']==$nota_despacho['id_pedido']):
                                                      ?> selected <?php
                                                    else: 
                                                      ?> disabled <?php
                                                    endif;
                    ...
                    <?php foreach ($despachos as $desp){ if(!empty($desp['id_despacho'])){ 
                      ...
                      <div class="form-group col-xs-12 col-sm-3">
                         ...
                         <input type="number" step="1" class="form-control select2 cantidad" id="cantidad<?=$desp['numero_despacho']; ?>" name="cantidad<?=$desp['numero_despacho']; ?>" value="<?=$nota_despacho['cantidad_colecciones'.$nitem]; ?>">
                         <span id="error_cantidad" class="errors"></span>
                      </div>
                    <?php } } ?>
                    <!-- <div class="form-group col-sm-6">
                       <label for="cantidad">Cantidad de colecciones</label>
                       <input type="number" step="1" class="form-control select2" id="cantidad" value="<?=$nota_despacho['cantidad_colecciones']?>" name="cantidad">
                       <span id="error_cantidad" class="errors"></span>
                    </div> -->
                  </div>
                  ...
                  <div class="row">
                    <div class="form-group col-sm-6">
                       ...
                       <input type="number" step="0.01" class="form-control" id="preciodolar" value="<?=$nota_despacho['precioDolar']?>" name="preciodolar">
                       <span id="error_preciodolar" class="errors"></span>
                    </div>

                    <!-- <div class="form-group col-sm-4">
                       <label for="preciobs">Precio Colección en Bolivares</label>
                       <input type="number" step="0.01" class="form-control" id="preciobs" value="<?=$nota_despacho['precioBs']?>" name="preciobs">
                       <span id="error_preciobs" class="errors"></span>
                    </div> -->
                    
                    <div class="form-group col-sm-6">
                       <label for="preciobsfiscal">Precio Colección Fiscal</label>
                       <input type="number" step="0.01" class="form-control" id="preciobsfiscal" value="<?=$nota_despacho['precioBsFiscal']?>" name="preciobsfiscal">
                  ...
                  <div class="row">
                    <div class="form-group col-sm-6">
                       ...
                       <input type="date" class="form-control" id="fecha1" name="fecha1" value="<?=$nota_despacho['fecha_emision']?>">
                       <span id="error_fecha1" class="errors"></span>
                    </div>
                    
                    <div class="form-group col-sm-6">
                       <label for="fecha2">Vencimiento de Factura</label>
                       <input type="date" class="form-control" id="fecha2" name="fecha2" value="<?=$nota_despacho['fecha_vencimiento']?>" min="<?=$nota_despacho['fecha_emision']?>">
