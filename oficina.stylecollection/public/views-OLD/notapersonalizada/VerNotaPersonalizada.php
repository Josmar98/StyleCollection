                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered text-left table-striped table-hover" id="">
                        ...
                        <tbody>
                          <?php foreach($opcionesEntregas as $entregas){ if(!empty($entregas['id_opcion_entrega_personalizada'])){ ?>
                            <?php $opcionTemp=$entregas['opcion']; ?>
                            <tr class="codigo<?=$entregas['id_opcion_entrega_personalizada']; ?>" <?php if($opcionTemp=="N"){ ?> style="color:#DDD"; <?php } ?>>
                              <td class="col1">
                                <?=$entregas['cantidad']; ?>
                              </td>
                              <td class="col3">
                              ...
                              <td></td>
                              <td>
                                <select class="opciones opcion<?=$entregas['id_opcion_entrega_personalizada']; ?>" name="P<?=$entregas['id_opcion_entrega_personalizada']; ?>">
