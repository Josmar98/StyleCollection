              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <?php } ?>
                    <div class="form-group col-xs-12">
                      <label for="cantidad">Cantidad de Colecciones <!-- (Coleccion: Principal) --></label>
                    ...
                    <?php //foreach ($despachosSec as $despSec){ if(!empty($despSec['id_despacho_sec'])){ ?>
                      <!-- <div class="form-group col-xs-12">
                        <label for="cantidad">Cantidad de Colecciones (Coleccion: <?=$despSec['nombre_coleccion_sec']; ?>)</label>
                        <input type="number" class="form-control" id="cantidad" step="1" name="cantidad" value="0">
                        <input type="hidde" name="id[]" value="<?=$despSec['id_despacho_sec']; ?>">
                        <span id="error_cantidad" class="errors"></span>
                      </div> -->
                    <?php //} } ?>
