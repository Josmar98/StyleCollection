                ...
                ?>
                  ...
                  <div class="row">
                    ...
                    <?php
                      $valueCols = 0;
                      $tipoCol = "";
                      foreach ($planesCol as $data2){ if (!empty($data2['id_plan'])){ if($plan['id_plan']==$data2['id_plan']){
                          $valueCols = $data2['cantidad_coleccion_plan'];
                          $tipoCol = $data2['id_tipo_coleccion'];
                      } } }
                    ?>
                    <div class="form-group col-xs-12">
                      <label for="cantidad_plan<?=$plan['nombre_plan']?>">Cantidad de planes</label>
                      <input type="number" step="1" min="0" class="form-control cantidades cant<?=$plan['id_plan']?>" id="<?=$plan['id_plan'];?>" name="cantidad_plan[]" value="<?=$valueCols; ?>" >
                      ...
                      <input type="hidden" name="id_tipo_coleccion[]" value="<?=$tipoCol; ?>">
                      <!-- <input type="hidden" name="id_tipo_coleccion[]" value="<?php foreach ($planesCol as $plan2): if(!empty($plan2['id_plan_campana'])): if ($plan['id_plan_campana']==$plan2['id_plan_campana']) { echo $plan2['id_tipo_coleccion']; }  endif; endforeach; ?>"> -->
                      <span id="error_cantidad_aprobado" class="errors"></span>
                    </div>
