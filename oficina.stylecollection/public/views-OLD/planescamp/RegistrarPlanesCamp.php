              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12">
                       ...
                       <div class="input-group">
                        ...
                        <input type="number" class="form-control" step=".1" maxlength="30" value="0" id="descuento_directo" name="descuento_directo"  placeholder="Descuento directo de coleccion">
                       </div>
                  ...
                  <?php foreach ($cantidadPagosDespachosFild as $cpfill){ if(!empty($cpfill['name'])){ ?>
                    <div class="form-group col-xs-6" style="margin-bottom:35px;">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon">$</span> 
                        <input type="number" class="form-control" step=".1" maxlength="30" value="0" id="descuento_<?=$cpfill['id']; ?>" name="descuentos[<?=$cpfill['id']; ?>]" placeholder="Descuento de <?=mb_strtolower($cpfill['name']); ?> puntual">
                      </div>
