              ...
              <div class="box-body">
                       ...
                       <select class="form-control select2 premio" style="width:100%" name="premio" id="premio">
                        <option value="0"></option>
                          <?php foreach ($premios as $data): if (!empty($data['id_premio'])): ?>
                            <option value="<?=$data['id_premio'];?>"><?=$data['nombre_premio']; ?></option>
                          <?php endif; endforeach; ?>
                       </select>
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="number" step="1" class="form-control cantidad" id="cantidad" name="cantidad" placeholder="Cantidad de Premios">
                       <span id="error_cantidad" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="descripcion">Descripcion</label>
                       <input type="text" step="1" class="form-control descripcion" id="descripcion" name="descripcion" placeholder="Descripcion">
