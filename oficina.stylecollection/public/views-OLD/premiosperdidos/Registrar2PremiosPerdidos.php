            ...
            <form action="" method="post" role="form" class="form_register">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <input type="hidde" name="dataoculta[]" value="<?="nombre*Inicial*0*0*".$data['cantidad_aprobado']."*".$data['id_pedido']."*".$data['id_cliente']; ?>">
                        <?php
                          $planess[$num] = ['codigo'=>'nombre', 'valor'=>"Inicial"]; 
                          $num++;
                        ?>
                        <input type="number" class="nombre_Inicial form-control cantidadPerdidas" id="<?=$cantidad_colecciones;?>" name="cantidadesPedidas[]" value="<?=$data['cantidad_aprobado']-$totalInicales;?>" title="Inicial" readonly>
                      </div>
                ...
                <!-- <div class="row"> -->
                  <div class="form-group col-xs-12">
                      ...
                      <input type="hidde" name="" class="maximosPrimerPagoHidden" value="<?=$data['cantidad_aprobado']-$totalPrimerPago;?>" readonly>
                      <input type="number" name="" class="form-control maximosPrimerPago" value="<?=$data['cantidad_aprobado']-$totalPrimerPago;?>" readonly>
                  ...
                  if($data2['nombre_plan']=="Standard"){ ?>
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <input type="hidde" name="dataoculta[]" value="<?="nombre*Standard*".$data2['id_tipo_coleccion']."*0*".$data2['cantidad_coleccion_plan']."*".$data2['id_pedido']."*".$data['id_cliente']; ?>">
                        <?php
                          $planess[$num] = ['codigo'=>'nombre', 'valor'=>"Standard"]; 
                          $num++;
                        ?>
                        <input type="number" class="nombre_Standard form-control cantidadPerdidas" id="<?=$data2['cantidad_coleccion_plan'];?>" name="cantidadesPedidas[]" title="Primer Pago" src="1">
                      </div>
                              ...
                              if($data3['cantidad_premios_plan']>0){  
                                ...
                                <div class="form-group col-xs-12">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="hidde" name="dataoculta[]" value="<?="id"."*".$data3['id_premio']."*".$data3['id_tipo_coleccion']."*".$data3['id_tppc']."*".$data3['cantidad_premios_plan']."*".$data['id_pedido']."*".$data['id_cliente']; ?>">
                                    <?php
                                      $planess[$num] = ['codigo'=>'id', 'valor'=>$data3['id_premio']]; 
                                      $num++;
                                    ?>
                                    <input type="number" class="<?='id'.'_'.$data3['id_premio']?> form-control cantidadPerdidas" id="<?=$data3['cantidad_premios_plan'];?>"  name="cantidadesPedidas[]" title="Primer Pago" src="<?=$data3['cantidad_coleccion']?>">
                                  </div>
                ...
                <hr>
                  <div class="form-group col-xs-12">
                    ...
                    <div class="input-group">
                      ...
                      <input type="hidde" name="dataoculta[]" value="<?="nombre*Segundo*0*0*".$cantidad_colecciones."*".$data['id_pedido']."*".$data['id_cliente']; ?>">
                      <?php
                          $planess[$num] = ['codigo'=>'nombre', 'valor'=>"Segundo"]; 
                          $num++;
                      ?>
                      <input type="number" class="nombre_Segundo form-control cantidadPerdidas" title="Segundo Pago" id="<?=$cantidad_colecciones;?>" name="cantidadesPedidas[]">
                    </div>
