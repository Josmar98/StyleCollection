  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo "Registrar ";} echo "Fechas"; ?></li>
      </ol>
    </section>
          <br>
        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Agregar <?php echo "Fechas de Promoción"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12">
                       <label for="fechaPago">Fecha de pago puntual de promoción</label>
                        <input type="date" class="form-control fechaPago" name="fechaPago" id="fechaPago">
