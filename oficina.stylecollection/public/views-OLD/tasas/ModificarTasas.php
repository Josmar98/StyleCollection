              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="date" class="form-control" value="<?php echo $tasa['fecha_tasa']; ?>" id="fecha" name="fecha" maxlength="30">
                       <span id="error_fecha" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="tasa">Tasa</label>
                       <input  type="number" step="0.0001" class="form-control" id="tasa" name="tasa" value="<?php echo $tasa['monto_tasa']; ?>" maxlength="30" placeholder="Precio de la Tasa del dia">
...
function validar(){
  ...
  if( rprecio == false ){
    if(precio.length != 0){
      ...
      $("#error_tasa").html("Debe llenar el campo de precio para el producto");      
    }
  }
  else{
    $("#error_tasa").html("");
