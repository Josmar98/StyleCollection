...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo "Catalogo"; ?>
        <small><?php echo "Ver Catalogo deshabilitado"; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?route=Home"><i class="fa fa-dashboard"></i> Inicio </a></li>
        <li><a href="?route=<?php echo $url ?>"><?php echo "Catalogo deshabilitado"; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo $action;} echo " Catalogo deshabilitado"; ?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo "Catalogos deshabilitados"; ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  <div class="sm-none">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-xs-12" style="height:12.5%;width:100%;margin-top:2%;" >
                                    ...
                                    <?php if($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador"): ?>
                                      <button class="eliminarBtn btn" style="font-size:1em;border:0;background:none;background:#04a7c9;color:#FFF;width:40%;height:auto;margin-left:auto;margin-right:auto;display:inline-block;" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_catalogo'] ?>&permission=1">
...
$(document).ready(function(){ 
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        type: 'success',
        title: '¡Elemento habilitado correctamente!',
    ...
    if(response == "2"){
      swal.fire({
        type: 'error',
        title: '¡Error al habilitar el elemento!',
        confirmButtonColor: "#ED2A77",
      });
    }
