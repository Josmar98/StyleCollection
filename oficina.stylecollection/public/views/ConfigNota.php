  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><?php echo "Ver Config. de nota de entrega"; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?route=Home"><i class="fa fa-dashboard"></i> Inicio </a></li>
        <li><a href="?route=<?php echo $url ?>"><?php echo " config. de nota"; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo $action;} echo "  config. de nota"; ?></li>
      </ol>
    </section>
            <?php if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario" || $amPermisosR==1){ ?>
              <br>
              <div style="width:100%;text-align:center;"><a href="?<?=$menu?>&route=<?php echo $url ?>&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar config. de nota</a></div>
            <?php } ?>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo "  Config. de nota de entrega"; ?></h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  ...
                  <td style="width:20%">
                    <span class="contenido2">
                      <?php if($data['opcion'] == "1"){ echo "Habilitado"; }else{ echo "Inhabilitado"; } ?>
                    </span>
                  </td>
