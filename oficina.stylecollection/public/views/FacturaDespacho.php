                        ...
                        <tr>
                          <td style="width:50%">
                              <?php 
                                ...
                                <!-- <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=Generarusd&id=<?=$data['id_factura_despacho'] ?>">
