      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <?php 
              $num = 1;
              foreach ($facturas as $data){ if(!empty($data['id_factura_despacho_perso'])){ 
                $continuar = false;
                if($accesoBloqueo=="1"){
                  ...
                  <tr>
                    ...
                    <td style="width:20%">
                      <?php if($data['estado_factura']==1){ ?>
                        <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=<?=$url; ?>&action=Modificar&id=<?=$data['id_factura_despacho_perso']?>">
                          <span class="fa fa-wrench"></span>
                        </button>
                        <?php if($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Administrativo"){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?<?=$menu3; ?>route=<?=$url; ?>&id=<?=$data['id_factura_despacho_perso']; ?>&permission=1">
                      ...
                      <span class="contenido2">
                        <?php
                          if($data['estado_factura']==1){
                            ...
                            // $estado_factura = "Cerrada";
                            $id_factura=$data['id_factura_despacho_perso'];
                        ...
                        <tr>
                          <td style="width:50%">
                              <?php 
                                ...
                                if(Count($tasas)>1){
                                  ?>
                                  <!-- <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=Generarbs&id=<?php echo $data['id_factura_despacho_perso'] ?>">
                                ...
                                <!-- <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=Generarusd&id=<?=$data['id_factura_despacho_perso'] ?>">
                              ...
                              ?>
                                <!-- <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=GenerarFiscal&id=<?php echo $data['id_factura_despacho_perso'] ?>&t=1">
                                  Generar Factura Fiscal<br>Media Carta
                                </a> -->

                                <!-- <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=GenerarFiscal&id=<?php echo $data['id_factura_despacho_perso'] ?>&t=2">
                                  Generar Factura Fiscal
                                </a> -->
                                <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF"  href="?<?php echo $menu ?>&route=<?=$url; ?>&action=VerFiscal&id=<?php echo $data['id_factura_despacho_perso'] ?>&t=2">
                                  Ver Factura
                                </a>

                                <!-- <a class="btn" style="border:1px solid #fff;border-radius:5px;background:<?php echo $color_btn_sweetalert ?>;color:#FFF" target="_blank" href="?<?php echo $menu ?>&route=<?php echo $url ?>&action=GenerarSP&id=<?php echo $data['id_factura_despacho_perso'] ?>&t=2">
                                  Generar Factura - Sin Precio
                                </a> -->
                              <?php //} else { ?>
