              ...
              ?>
                <tr>
                  ...
                  <td style="width:20%">
                    <span class="contenido2">
                      <!-- <a href="?<?php echo $menu ?>&dpid=<?php echo $data['id_despacho'] ?>&dp=<?php echo $data['numero_despacho'] ?>&route=Homing2"> -->
                        <?php echo $lider->formatFecha($data['fecha_inicial']); ?>
                      <!-- </a> -->
                    </span>
                  </td>
                  <td style="width:20%">
                    <span class="contenido2">
                      <!-- <a href="?<?php echo $menu ?>&dpid=<?php echo $data['id_despacho'] ?>&dp=<?php echo $data['numero_despacho'] ?>&route=Homing2"> -->
                        <?php echo $lider->formatFecha($data['fecha_primera']); ?>
                      <!-- </a> -->
                    </span>
                  </td>
                  <td style="width:20%">
                    <span class="contenido2">
                      <!-- <a href="?<?php echo $menu ?>&dpid=<?php echo $data['id_despacho'] ?>&dp=<?php echo $data['numero_despacho'] ?>&route=Homing2"> -->
                        <?php echo $lider->formatFecha($data['fecha_segunda']); ?>
                      <!-- </a> -->
                    </span>
                  </td>
                  <td style="width:20%">
            ...
            <div class="box-body">
              ...
              <select class="form-control filter col-xs-offset-1"  style="width:85%">
                ...
                ?>
                  ...
                  <option value="<?php echo $dataa['numero_despacho'] ?>">Pedido <?php if($dataa['numero_despacho']!="1"){ echo $dataa['numero_despacho']; } ?> de Campaña <?php echo $numero_campana."/".$anio_campana; ?></option>
                <?php
                  }
                } 
                ?>
