                ...
                <?php 
                  ...
                  foreach ($mercancia as $data){ if(!empty($data['id_mercancia'])){ 
                    ...
                    <tr>
                      ...
                      <td>
                            <?php if($amPremiosB==1){ ?>
                              <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&cod=<?php echo $data['codigo_mercancia'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=MercanciaBorrada";
      });
    }
    if(response == "2"){
      swal.fire({
      ...
      swal.fire({ 
          ...
          if (isConfirm.value){            
                ...
                swal.fire({ 
                    ...
                    text: "Se restauraran los datos, esta opcion no se puede deshacer, ¿desea continuar?",
                    type: "error",
                    showCancelButton: true,
                  confirmButtonColor: "#ED2A77",
                    confirmButtonText: "¡Si!",
