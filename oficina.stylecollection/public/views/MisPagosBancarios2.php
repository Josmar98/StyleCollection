        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              &nbsp&nbsp&nbsp&nbsp
              <h3 class="box-title"><?php echo "Mis Pagos (Bancarios)"; ?></h3>
              <br><br>
              ...
              <div class="row">
                      ...
                      <div class="col-xs-12 col-md-12" style="text-align:right;margin-bottom:15px;">
                        <a href="?<?=$menu?>&route=MisPagos" style="background:#099;color:#FFF;border-radius:7px !important;" class="btn"><b><u>Ver todos los pagos</u></b></a>
                      </div>
                      <br>
                      <div class="col-xs-12 col-md-12" style="text-align:right;margin-bottom:15px;">
