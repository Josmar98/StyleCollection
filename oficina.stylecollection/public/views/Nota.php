  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><?php if(!empty($action)){echo $action;} echo " Notas de entrega de lideres"; ?></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li><a href="?<?php echo $menu ?>&route=<?php echo $url ?>"><?php echo "Notas de entrega"; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo $action." Notas de entrega";}else{echo "Notas de entrega";} ?></li>
      </ol>
    </section>
            <?php if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario"){ ?>
              <br>
              <div style="width:100%;text-align:center;"><a href="?<?php echo $menu3; ?>route=<?php echo $url ?>&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar Notas de entrega</a></div>
            <?php } ?>
    <!-- Main content -->
        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo "Notas de entrega"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">
              ...
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr >
                  ...
                  <td style="">
                    <span class="contenido2">
                      <a href="?<?=$menu?>&route=Nota&action=Ver&nota=<?=$data['id_nota_entrega']?>"> Ver nota de entrega</a>
                    </span>
                  </td>
