...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo "Gemas"; ?>
        <small><?php echo "Ver Gemas autorizadas"; ?></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo " Gemas autorizadas"; ?></li>
            ...
            <?php if($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Analista Supervisor2"){ ?>
              <br>
              <div style="width:100%;text-align:center;"><a href="?<?=$menu?>&route=<?php echo $url ?>&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar Gemas autorizadas</a></div>
            <?php } ?>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo "Gemas autorizadas"; ?></h3>
            </div>
            <!-- /.box-header -->
            <?php 
              // $supereditargemas = 0;
                      ...
                      <tr>
                        ...
                        <td style="width:8%">
                          <?php if($estado_campana=="1"){ ?>
                              ...
                              <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?<?=$menu?>&route=<?php echo $url; ?>&id=<?php echo $data['id_obsequio_gema'] ?>&permission=1">
...
$(document).ready(function(){ 
  ...
  if(response==undefined){
    ...
    if(response == "1"){
        swal.fire({
            type: 'success',
            title: '¡Obsequio borrado correctamente!',
      ...
      swal.fire({ 
          ...
          if (isConfirm.value){            
                ...
                swal.fire({ 
                    ...
                    text: "Se borraran los datos, ¿desea continuar?",
                    type: "error",
                    showCancelButton: true,
                  confirmButtonColor: "#ED2A77",
                    confirmButtonText: "¡Si!",
