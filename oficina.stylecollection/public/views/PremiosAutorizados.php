          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                foreach ($premios_autorizados as $data):
                  if(!empty($data['id_PA'])):  
                ?>
                <?php
                  $permitido = "0";
                    ...
                    <tr >
                      ...
                      <td style="width:15%">
                        <?php if($estado_campana=="1"): ?>
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=<?php echo $url; ?>&action=Modificar&id=<?=$data['id_PA']?>">
                            <span class="fa fa-wrench"></span>
                          </button>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?<?php echo $menu ?>&route=<?php echo $url; ?>&id=<?=$data['id_PA']?>&permission=1">
                      ...
                      <td style="width:25%">
                        <span class="contenido2">
                          <?php echo "(".$data['cantidad_PA'].") ".$data['nombre_premio']; ?>
                        </span>
                      </td>
                      <td style="width:30%">
                        <span class="contenido2">
                          <?php
                            if($data['descripcion_PA']==""){
                              echo $data['firma_PA'];
                            }else{
                              echo $data['descripcion_PA'];
                            }
                          ?>
                        </span>
                      </td>
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        var dpid = $(".dpid").val();
        var dp = $(".dp").val();
        var menu = "?campaing="+campaing+"&n="+n+"&y="+y+"&dpid="+dpid+"&dp="+dp+"&route=PremiosAutorizados";
