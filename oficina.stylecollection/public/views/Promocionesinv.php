    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo " ". $modulo; ?></li>
            ...
            <?php if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario" || $amPromocionesR==1){ ?>
              <br>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  <th>Nº</th>
                  <?php if ($amPromocionesE==1||$amPromocionesB==1): ?>
                  <th>---</th>
                  <?php endif ?>
                  <th>Promociones</th>
                </tr>
                ...
                <tr>
                  ...
                  <?php if ($amPromocionesE==1||$amPromocionesB==1){ ?>
                  <td style="width:10%">
                        <?php if ($amPromocionesE==1){ ?>
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_promocioninv'] ?>">
                            <span class="fa fa-wrench"></span>
                          </button>
                        <?php } ?>
                        <?php if ($amPromocionesB==1){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_promocioninv'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=Promocionesinv";
      });
    }
    if(response == "2"){
      swal.fire({
