      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo " ". $url; ?></li>
            ...
            <?php if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario" || $amLiderazgosR==1){ ?>
              <br>
              <div style="width:100%;text-align:center;"><a href="?route=<?php echo $url ?>&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar <?=$url; ?></a></div>
            <?php } ?>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            <?php 
              ...
              foreach ($proveedores as $data):
                if(!empty($data['id_proveedor_compras'])):  
            ?>
                <tr style="background :<?=$data['color_liderazgo'];?>33">
                  ...
                  <td style="width:20%">
                    <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url ?>&action=Modificar&id=<?php echo $data['id_proveedor_compras'] ?>">
                      <span class="fa fa-wrench"></span>
                    </button>
                    <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=<?php echo $url ?>&id=<?php echo $data['id_proveedor_compras'] ?>&permission=1">
