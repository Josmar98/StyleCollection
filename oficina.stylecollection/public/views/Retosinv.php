    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo "".$modulo; ?></li>
              ...
              <?php if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario" || $amRetosR==1){ ?>
              <br>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="datatable2" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  <th>Nº</th>
                  <?php if ($amRetosE==1||$amRetosB==1){ ?>
                  <th>---</th>
                  <?php } ?>
                  <th>Nombre de Reto</th>
                  <th>Colecciones</th>
                </tr>
                </thead>
                <tbody>
            ...
            ?>
                <tr>
                  ...
                  <td style="width:10%">
                        <?php if ($amRetosE==1){ ?>
                          <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_retoinv'] ?>">
                            <span class="fa fa-wrench"></span>
                          </button>
                        <?php } ?>
                        <?php if ($amRetosB==1){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_retoinv'] ?>&permission=1">
                  ...
                  <td style="width:20%">
                    <span class="contenido2">
                        <?php echo $data['num_coleccionesreto']." cols."; ?>
                    </span>
                  </td>
