          ...
          <div class="box">
            ...
            ?>
                <tr>
                  ...
                  <td style="width:10%">
                        <?php if ($amRetosB==1){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_retoinv'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=RetosinvBorrados";
      });
    }
    if(response == "2"){
      swal.fire({
