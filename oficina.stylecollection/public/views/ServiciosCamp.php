    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo "".$modulo; ?></li>
            ...
            <?php if($_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Superusuario" || $amServiciosR==1){ ?>
              <br>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo $modulo." Campaña #".$n; ?></h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              ...
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  ...
                  <td style="width:20%">
                      <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=<?php echo $url; ?>&action=Modificar&id=<?=$data['id_servicio']?>">
                        <span class="fa fa-wrench"></span>
                      </button>

                      <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?<?php echo $menu ?>&route=<?php echo $url; ?>&id=<?php echo $data['id_servicio'] ?>&permission=1">
                          <span class="fa fa-trash"></span>
                      </button>
                  </td>
                  <td style="width:55%">
                    <span class="contenido2">
                      <?php echo $data['nombre_servicio']." <small>(".$data['nombre_servicioss'].")</small>"; ?>
                    </span>
                  </td>
                  <td style="width:15%">
                    <span class="contenido2">
                      <?php echo "$".number_format($data['precio_servicio'],2,',','.'); ?>
                    </span>
                  </td>
                </tr>
                <?php
