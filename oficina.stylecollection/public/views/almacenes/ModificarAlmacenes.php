              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-sm-12">
                       ...
                       <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $datas['nombre_almacen'] ?>" maxlength="30" placeholder="Ingresar nombre del almacen">
              ...
              $.ajax({
                    ...
                    success: function(respuesta){
                      ...
                      if (respuesta == "9"){
                        swal.fire({
                            type: 'error',
                            title: '¡No se han encontrado el registro!',
                            confirmButtonColor: "#ED2A77",
                        });
                      }
                      if (respuesta == "5"){ 
...
function validar(){
  ...
  if( rnombre == false ){
    if(nombre.length != 0){
      $("#error_nombre").html("El nombre del almacen no debe contener numeros o caracteres especiales");
    }else{
      $("#error_nombre").html("Debe llenar el campo de nombre del almacen");      
    }
  }else{
    $("#error_nombre").html("");
  }
  ...
  /*===================================================================*/
  var result = false;
  if( rnombre==true && rdireccion==true){
    result = true;
  }else{
    result = false;
  }
