              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre" name="nombre" maxlength="30" placeholder="Ingresar nombre del almacen">
...
function validar(){
  ...
  if( rnombre == false ){
    if(nombre.length != 0){
      $("#error_nombre").html("El nombre del modulo no debe contener caracteres especiales");
    }else{
