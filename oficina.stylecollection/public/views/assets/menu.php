...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
                            <?php } ?>
          <a href="#">
            <i class="fa fa-tags"></i> <span>Notas de entrega</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?<?php echo $menu ?>&route=Nota&action=Registrar"><i class="fa fa-tag"></i> Realizar Nota de entrega</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?<?php echo $menu ?>&route=Nota&action=Registrar"><i class="fa fa-tag"></i> Realizar Nota de entrega</a></li>
                            <?php } ?>
                      <?php } ?>
            ...
            <li class="active"><a href="?<?php echo $menu ?>&route=Nota"><i class="fa fa-tag"></i> Ver  Notas de entrega</a></li>
                            <?php }else{ ?>
            <li><a href="?<?php echo $menu ?>&route=Nota"><i class="fa fa-tag"></i> Ver  Notas de entrega</a></li>
                            <?php } ?>
                      <?php } ?>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
          ...
          <a href="?<?php echo $menu ?>&route=PlanesCamp">
            <i class="fa fa-tags"></i> <span>Planes de Campaña <?=$n?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
          ...
          <a href="?<?php echo $menu ?>&route=PremiosCamp">
            <i class="fa fa-tags"></i> <span>Premios de Campaña <?=$n?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
                            <?php } ?>
          <a href="#">
            <i class="fa fa-tags"></i> <span>Config. Nota de Entrega</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
                            <?php } ?>
          <a href="#">
            <i class="fa fa-bookmark"></i> <span>Liderazgos de Campaña <?=$n?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
