            ...
            <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="hidden" value="CanjeosGemas" name="route">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-sm-6">
                         ...
                         <div class="input-group">
                          ...
                          <input type="number" class="form-control precioGema" id="precioGema" name="precioGema" <?php if (count($precioGema)>1){ ?> value="<?=$precio_gema['precio_gema'];?>" <?php } ?> readonly>
                         </div>
                      ...
                      <div class="form-group col-xs-12 col-sm-6">
                         ...
                         <div class="input-group">
                          <input type="number" class="form-control disponible" id="disponible" name="disponible" value="<?=$gemasAdquiridasDisponiblesCliente;?>" readonly>
                      ...
                      <div class="form-group col-xs-12 col-sm-6">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon">$</span>
                          <input type="text" class="form-control total" id="total" name="total" value="0" readonly="">
                        </div>
