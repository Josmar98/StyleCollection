              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre" value="<?=$catalogo['nombre_catalogo']?>" name="nombre" maxlength="150" placeholder="Ingresar nombre del premio">
                       <span id="error_nombre" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="codigo">Codigo de premio</label>
                       <input type="text" class="form-control" id="codigo" value="<?=$catalogo['codigo_catalogo']?>" name="codigo" maxlength="100" placeholder="Ingresar el codigo del premio">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="marca" value="<?=$catalogo['marca_catalogo']?>" name="marca" maxlength="100" placeholder="Ingresar marca del premio">
                       <span id="error_marca" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="color">Color</label>
                       <input type="text" class="form-control" id="color" value="<?=$catalogo['color_catalogo']?>" name="color" maxlength="100" placeholder="Ingresar el color del premio">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="voltaje" value="<?=$catalogo['voltaje_catalogo']?>" name="voltaje" maxlength="100" placeholder="Ingresar voltaje del premio">
                       <span id="error_voltaje" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="caracteristicas">Caracteristicas</label>
                       <input type="text" class="form-control" id="caracteristicas" value="<?=$catalogo['caracteristicas_catalogo']?>" name="caracteristicas" maxlength="100" placeholder="Ingresar el caracteristicas del premio">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="puestos" value="<?=$catalogo['puestos_catalogo']?>" name="puestos" maxlength="100" placeholder="Ingresar puestos del premio">
                       <span id="error_puestos" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="otros">Otros</label>
                       <input type="text" class="form-control" id="otros" value="<?=$catalogo['otros_catalogo']?>" name="otros" maxlength="100" placeholder="Ingresar el otros del premio">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="cantidad"  value="<?=$catalogo['cantidad_gemas']?>" name="cantidad" step="0.01" placeholder="Ingresar el precio en gemas, Ej, 10,25">
                       </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <span class="errors"><b>Advertencia: Si no desea reemplazar la imagen, no seleccione ninguna otra imagen.</b></span>
                    </div>
                  </div>

                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-offset-6">
                      <span class="btn btn-info mostrarocultarimg">Mostrar Imagen</span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-6 box-img">
                    </div>
                    <div class="form-group col-xs-12 col-sm-6 box-img">
                      <img src="<?=$catalogo['imagen_catalogo']?>" style='width:60%;border:1px solid #ccc'>
                    </div>
                  </div>
                  ...
                  <?php
                    ...
                    if(!empty($catalogo['id_premio'])){
                      $premiosInv = $lider->consultarQuery("SELECT * FROM premios_inventario WHERE estatus=1 and id_premio={$catalogo['id_premio']}");
                  ...
                  <?php for($z=1; $z<=$limiteElementos; $z++){ ?>
                    <div class="row" style="padding:0px 15px;">
                      ...
                      ?>
                      <div style="width:20%;float:left;" class=" box-inventarios<?=$z; ?> box-inventario <?php if($z>$elementosMostrar){ echo "d-none"; } ?>">
                        <input type="number" class="form-control" id="stock<?=$z; ?>" min="0" name="stock[]" step="1" placeholder="Cantidad (150)"  value="<?php if(!empty($inventario[0])){ echo $inventario[0]['unidades_inventario']; } ?>">
                      ...
                      <div style="width:80%;float:left;" class=" box-inventarios<?=$z; ?> box-inventario <?php if($z>$elementosMostrar){ echo "d-none"; } ?>">
                        <select class="form-control select2 inventarios" id="inventario<?=$z; ?>" min="<?=$z;?>" name="inventario[]"  style="width:100%">
                          ...
                          <?php foreach($productos as $inv){ if(!empty($inv['id_producto'])){ ?>
                            ...
                            <?php
                              if(!empty($inventario[0])){
                                if($inventario[0]['tipo_inventario']=="Productos"){
                                  if($inventario[0]['id_producto']==$inv['id_producto']){
                                    echo "selected";
                                    $tipoInvOP="Productos";
                                  }
                                }
                            ...
                            ?>
                            ><?php echo "(".$inv['codigo_producto'].") ".$inv['producto']."(".$inv['cantidad'].") ".$inv['marca_producto']; ?></option>
                          <?php } } ?>
                          <?php foreach($mercancia as $inv){ if(!empty($inv['id_mercancia'])){ ?>
                            <option value="m<?php echo $inv['id_mercancia']; ?>"
                            <?php
                              if(!empty($inventario[0])){
                                if($inventario[0]['tipo_inventario']=="Mercancia"){
                                  if($inventario[0]['id_mercancia']==$inv['id_mercancia']){
                                    echo "selected";
                                    $tipoInvOP="Mercancia";
                                  }
                                }
                            ...
                            ?>
                            ><?php echo "(".$inv['codigo_mercancia'].") ".$inv['mercancia']."(".$inv['medidas_mercancia'].") ".$inv['marca_mercancia']; ?></option>
                          <?php } } ?>
                        </select>
                    ...
                    <div style='width:100%;'>
                      <span style='float:left' id="addMore<?=$z; ?>" min="<?=$z; ?>" class="addMore btn btn-success box-inventarios<?=$z; ?> box-inventario <?php if($z!=$elementosMostrar){ echo "d-none"; } ?>"><b>+</b></span>
                      <?php if($z>1){ ?>
                        <span style='float:right' id="addMenos<?=$z; ?>" min="<?=$z; ?>" class="addMenos btn btn-danger box-inventarios<?=$z; ?> box-inventario <?php if($z!=$elementosMostrar){ echo "d-none"; } ?>"><b>-</b></span>
                      <?php } ?>
                    </div>
                  <?php } ?>
                  <input type="hidden" id="cantidad_elementos" name="cantidad_elementos" value="<?=$elementosMostrar; ?>">
                  <hr>
...
$(document).ready(function(){
  ...
  $(".box-img").hide();
  $(".mostrarocultarimg").click(function(){
    if($(".box-img").is(":visible")){
      $(".box-img").slideUp();
      $(this).html("Mostrar Imagen");
    }else{
      $(".box-img").slideDown();
