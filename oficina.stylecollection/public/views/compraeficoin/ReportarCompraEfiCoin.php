                ...
                ?>
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-6">
                      ...
                      <input type="date" class="form-control fechaPago" min="<?=$limiteFechaMinimo; ?>" value="<?=date('Y-m-d')?>" <?php if(empty($_GET['admin'])){ echo "readonly"; } ?> name="fechaPago" id="fechaPago" max="<?=date('Y-m-d')?>">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      <?php 
                        $precioValidoEficoin = 0;
                        if($horaActual<"14:00:00"){ $precioValidoEficoin=$preciom; }
                        if($horaActual>="14:00:00"){ $precioValidoEficoin=$preciot; }
                      ?>
                      <label for="precio_eficoin_total">Tasa Eficoin</label>
                      <input type="number" class="form-control precio_eficoin_total" readonly value="<?=$precioValidoEficoin; ?>" name="precio_eficoin_total" id="precio_eficoin_total">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6 col-md-4">
                      ...
                      <select class="form-control select2 tipo_eficoin"  style="width:100%;" name="tipo_eficoin" id="tipo_eficoin">
                        <option value=""></option>
                        <option value="En Fisico">Fisico</option>
        ...
        if (data.msj == "1"){
          if(data.msj_efi=="1"){
            ...
            if(turno==""){
              ...
              if(turno=="2"){
                $("#precio_eficoin_total").val(datos_efi.monto_tasa_tarde);
              }
            }
          }else{
            $("#precio_eficoin_total").val(0);
...
function validar(){
  ...
  // alert(tasaeficoin);
  // error_total_equivalente

  /*===================================================================*/
  var result = false;
  if( rfechaPago==true && rtipoPago==true && rturno==true && rtipo_eficoin==true && rtasaeficoin==true && rbanco==true && rserial==true && requivalente==true && rtotal_equivalente==true){
    result = true;
  }else{
    result = false;
  }
