                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-4">
                       <label for="primer_pago">Fecha de 1er pago</label>
                        <input type="date" class="form-control" id="primer_pago" name="primer_pago" >
                       <span id="error_primer_pago" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-4">
                       <label for="segundo_pago">Fecha de 2do pago</label>
                       <input type="date" class="form-control" id="segundo_pago" name="segundo_pago"  >
                    ...
                    <div class="form-group col-xs-12 col-sm-4">
                       ...
                       <input type="date" class="form-control" id="inicial_senior" name="inicial_senior" >
                       <span id="error_inicial_senior" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-4">
                       <label for="primer_pago_senior">Fecha de 1er pago Senior</label>
                        <input type="date" class="form-control" id="primer_pago_senior" name="primer_pago_senior" >
                       <span id="error_primer_pago_senior" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-4">
                       <label for="segundo_pago_senior">Fecha de 2do pago Senior</label>
                       <input type="date" class="form-control" id="segundo_pago_senior" name="segundo_pago_senior"  >
