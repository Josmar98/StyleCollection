                    ...
                    <?php if (!empty($data['id_cliente'])): ?>
                      ...
                      <tr class="elementTR">
                        <td style="text-align:left;padding:0;">
                          <label style="display:block;padding:5px;;" for="<?=$data['id_cliente']; ?>" class="labellider" <?php if ($opcion=="1"): ?>
                            disabled="disabled"
                          <?php endif ?>>
                      ...
                      <!-- <div class="row"> -->
                        <!-- <div class="form-group col-xs-12"> -->
                          ...
                          <input type="checkbox" class="form-control2 lideres" style="float:right;" id="<?=$data['id_cliente']; ?>" name="lideres[]" maxlength="30" placeholder="Ingresar nombre de usuario" value="<?=$data['id_cliente']; ?>" <?php if ($opcion=="1"): ?>
                            disabled="disabled"
                          <?php endif ?>>
