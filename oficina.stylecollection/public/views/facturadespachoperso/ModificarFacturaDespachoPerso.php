        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            ...
            <?php 
              ...
              $pedidosFacturas = $lider->consultarQuery("SELECT * FROM factura_despacho_variadas_perso, pedidos WHERE factura_despacho_variadas_perso.estatus=1 and pedidos.estatus=1 and factura_despacho_variadas_perso.id_pedido_factura=pedidos.id_pedido and factura_despacho_variadas_perso.id_factura_despacho_perso={$id}");
              $multiples = false;
              ...
              <div class="box-body">
                                      ...
                                      foreach ($facturas as $key){ 
                                        if (!empty($key['id_pedido'])){ 
                                          if ($data['id_pedido'] == $key['id_pedido']){
                                            ?>
                                          <option selected value="<?php echo $data['id_pedido'] ?>" >
                                            <?=$data['cedula']." ".$data['primer_nombre']." ".$data['primer_apellido']. " Pedido: ". $data['cantidad_aprobado'] . " colecciones"; ?>
                                          </option>
                                            <?php 
                                          }
                                        }
                  ...
                  <div class="row">
                    <div class="form-group col-sm-6">
                       ...
                       <input type="date" class="form-control" id="fecha1" name="fecha1" value="<?=$factura['fecha_emision']; ?>">
                       <span id="error_fecha1" class="errors"></span>
                    </div>
                    
                    <div class="form-group col-sm-6">
                       <label for="fecha2">Vencimiento de Factura</label>
                       <input type="date" class="form-control" id="fecha2" name="fecha2" min="<?=$factura['fecha_emision']; ?>" value="<?=$factura['fecha_vencimiento']; ?>">
                  ...
                  <div class="row">
                    <div class="form-group col-sm-6">
                       ...
                       <input type="number" class="form-control" id="control1" name="control1" value="<?=$factura['numero_control1']; ?>">
