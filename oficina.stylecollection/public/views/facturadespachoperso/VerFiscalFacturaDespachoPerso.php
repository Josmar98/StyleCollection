        ...
        <section class="content">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12" style='padding:0px 30px;'>
                                    ...
                                    <?php } ?>
                                        ...
                                        if($factura['estado_factura']==1){
                                            ...
                                            $facturadosDescontar=[];
                                            $facturados = $lider->consultarQuery("SELECT * FROM operaciones, factura_despacho WHERE operaciones.id_factura=factura_despacho.id_factura_despacho and factura_despacho.id_pedido={$id_pedido} and operaciones.modulo_factura='{$moduloFacturacionn}' ORDER BY operaciones.id_operacion ASC;");
                                        ...
                                        if($factura['estado_factura']==0){
                                            ...
                                            $mostrarFacturaFinal=[];
                                            $facturados = $lider->consultarQuery("SELECT * FROM operaciones, factura_despacho_personalizada WHERE operaciones.id_factura=factura_despacho_personalizada.id_factura_despacho_perso and factura_despacho_personalizada.id_pedido={$id_pedido} and operaciones.modulo_factura='{$moduloFacturacion}' and operaciones.id_factura={$id_factura} ORDER BY operaciones.id_operacion ASC;");
                                            foreach ($facturados as $facts) {
                                                if(!empty($facts['id_factura'])){
                                                    ...
                                                    // echo "=> ".$codUnic." => ".$mostrarFacturaFinal[$codUnic]['cantidad'];
                                                    // echo "<br><br>";
                                                }
                                            }
                                            // foreach ($mostrarFacturaFinal as $keysss) {
                                            //     print_r($keysss);
                                            //     echo "<br><br><br>";
                                            // }
                                        ...
                                        $_SESSION['mostrarFacturaFinalPerso'.$_GET['id']] = $mostrarFacturaFinal;
                                        $_SESSION['listaColeccionesPerso'.$_GET['id']] = $listaColecciones;
                                    ...
                                    <div class='box-content-final-R'  style="width:35%;float:right;text-align:right;">
                                        ...
                                        <table style='width:100%;'>
                                            ...
                                            <tr>
                                                ...
                                                <td class='celcontentR' style="text-align:right;">
                                                    <b><span class='content-table'>
                                                        <?=$simbolo."".number_format($precioFinal,2,',','.'); ?>
                                                    </span></b>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <?php if($factura['estado_factura']==0){ ?>
                                        <br>
                                        <?php $urlCerrarFact = $menuPersonalizado."&abrir=1"; ?>
                                        <?php if($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Contable"){ ?>
                                            <a href="?<?=$urlCerrarFact; ?>"><span class='btn enviar2'>Abrir Factura</span></a>
                                        <?php } ?>
                                    <?php } ?>
                ...
                <?php if( (!empty($_GET['t']) && !empty($_GET['i']) && !empty($_GET['e'])) || (!empty($_GET['nuevo']))){ ?>
                    <?php
                        $limiteDisponibles = $_SESSION['limiteDisponiblesInventarioPerso'];
                    ?>
