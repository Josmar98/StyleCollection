            ...
            <form action="" method="get" role="form" class="form_register">
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="configgema">Tipo de premio de gema</label>
                       <!-- <input type="text" class="form-control nombreConfig" id="nombreConfig" name="nombreConfig" placeholder="por ..."> -->
                       <select class="form-control select2 configgema" style="width:100%" name="tipo" id="configgema">
                        <option value="0"></option>
                          <?php foreach ($configgemas as $data): if (!empty($data['id_configgema'])): if ($data['nombreconfiggema']!="Por Colecciones De Factura Directa"): ?>
                        <option <?php if(!empty($_GET['lider']) && !empty($_GET['tipo'])){ if($data['id_configgema']==$_GET['tipo']){ echo "selected=''"; } } ?> value="<?=$data['id_configgema']?>"><?=$data['nombreconfiggema']; ?></option>
                          <?php endif; endif; endforeach; ?>
                       </select>
                       <span id="error_configgema" class="errors"></span>
                    </div>
              ...
              <div class="box-footer">
                ...
                <span type="submit" class="btn enviar2 enviarprimerform">Cargar</span>
                <input type="color" class="d-none color-button-sweetalert" value="<?php echo $color_btn_sweetalert ?>">

                <button class="btn-enviarprimerform d-none" disabled=""  >enviar</button>
              </div>
            </form>

            <hr>
            <?php if(!empty($_GET['lider']) && !empty($_GET['tipo'])): ?>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                      <!-- <div class="form-group col-xs-12 col-sm-6">
                         ...
                         <select class="form-control select2 campana" style="width:100%" name="campana" id="campana">
                          ...
                          <option value="<?=$data['id_campana']?>">Campaña <?=$data['numero_campana']."/".$data['anio_campana']." - ".$data['nombre_campana']?></option>
                            <?php endif; endforeach; ?>
                         </select>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-sm-6">
                         ...
                         <input type="text" class="form-control cantidad_gemas" value="0" id="cantidad_gemas" name="cantidad_gemas" readonly>
