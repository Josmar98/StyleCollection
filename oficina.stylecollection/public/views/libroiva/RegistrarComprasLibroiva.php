              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <select class="form-control select2" id="periodoAnio" name="periodoAnio" style="width:100%;">
                        <!-- <option value=""></option> -->
                        <?php
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <select class="form-control select2" id="periodoMes" name="periodoMes" style="width:100%;">
                        <option value=""></option>
                        <?php
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="date" class="form-control" id="fechaFactura" name="fechaFactura" placeholder="2024-01-01">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <select class="form-control select2" id="idProveedor" name="idProveedor" style="width:100%;">
                        ...
                        <?php foreach ($proveedores as $prov){ if(!empty($prov['id_proveedor_compras'])){ ?>
                          <option value="<?=$prov['id_proveedor_compras']; ?>"><?=$prov['codRif']."-".$prov['rif']." ".$prov['nombreProveedor']; ?></option>
                        <?php } }?>
                      </select>
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="text" class="form-control" id="numeroFactura" name="numeroFactura" placeholder="ABC1234567">
                       <span id="error_numeroFactura" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="numeroControl">Numero de Control</label>
                       <input type="text" class="form-control" id="numeroControl" name="numeroControl" placeholder="ABC1234567">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <input type="number" class="form-control" id="totalCompra" name="totalCompra" step="0.01" placeholder="0,00">
                       <span id="error_totalCompra" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-6">
                       <label for="comprasExentas">Compras Exentas Exoneradas</label>
                       <input type="number" class="form-control" id="comprasExentas" name="comprasExentas" step="0.01" placeholder="0,00">
                       <span id="error_comprasExentas" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-5">
                       <label for="comprasInternasGravadas">Compras Internas Gravadas</label>
                       <input type="number" class="form-control" id="comprasInternasGravadas" name="comprasInternasGravadas" value="0" placeholder="0,00" readonly>
                    ...
                    <div class="form-group col-xs-12 col-sm-5">
                       ...
                       <input type="number" class="form-control" id="ivaGeneral" name="ivaGeneral" value="0" placeholder="0,00" readonly>
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-md-6">
                      ...
                      <select class="form-control select2" id="opRetencion" name="opRetencion" style="width:100%;">
                        <option value="0" <?php if(!empty($_GET['tipo'])){ if($_GET['tipo']=="0"){ echo "selected"; } } ?> >No</option>
                        <option value="1" <?php if(!empty($_GET['tipo'])){ if($_GET['tipo']=="1"){ echo "selected"; } } ?> >Si</option>
                      </select>
                      <span id="error_tipo" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-md-6 boxNoRet d-none">
                    ...
                    <div class="form-group col-xs-12 col-sm-4 boxNoRet d-none">
                       <label for="retencionIva">Retención IVA ALicuota General</label>
                       <input type="number" class="form-control" id="retencionIva" name="retencionIva" placeholder="0,00" readonly>
                       <span id="error_retencionIva" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-4 boxNoRet d-none">
                       <label for="comprobante">Comprobante de Retención de IVA</label>
                       <input type="text" class="form-control" id="comprobante" maxlength="15" name="comprobante" placeholder="ABC1234567">
                       <span id="error_comprobante" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-4 boxNoRet d-none">
                       <label for="fechaComprobante">Fecha del Comprobante de Retención</label>
                       <input type="date" class="form-control" id="fechaComprobante" name="fechaComprobante" placeholder="Ingresar nombre de liderazgo">
  ...
  $(".enviar").click(function(){
    ...
    if(response == true){
      ...
      swal.fire({ 
        ...
        if (isConfirm.value){
          $.ajax({
            url: '?route=Libroiva&action=RegistrarCompras',
            type: 'POST',
            data: {
              validarData: true,
