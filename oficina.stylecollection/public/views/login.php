...
<div class="" style="">
  ...
  <div style="background:;position:absolute;bottom:15%;right:0;z-index:500;background:<?=$fucsia; ?>;padding:5px 4px;border-radius:5px;">
    <span id="enlaceAccess" class="d-none" style="font-size:1.2em;padding-left:10px;background:<?=$fucsia; ?>;color:#FFF;margin-right:2px"><a class="enlaceOpen" href="<?=$ruta; ?>" style="color:#FFF;"><b>Líneas de productos</b></a></span>
    ...
    <section class="content" style="width:100%;">
      <div class="row" style="width:100%;margin:auto;margin-top:4%;">
        ...
        <div class="col-xs-12 col-md-4">
          ...
          <div class="box">
            <div class="box-body">
              <img src="public/assets/img/logoTipo2.png" style="width:100%;">
