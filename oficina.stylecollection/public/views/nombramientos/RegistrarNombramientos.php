                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-4">
                       ...
                       <select class="form-control select2 liderazgo" style="width:100%" name="liderazgo" id="liderazgo">
                        ...
                        <option value="<?=$data['id_confignombramientos']?>"><?=$data['nombre_liderazgo']." - (".$data['cantidad_correspondiente']; if($data['cantidad_correspondiente']==1){echo " Gema)";}else{echo " Gemas)";} ?></option>
                          <?php endif; endforeach; ?>
                       </select>
