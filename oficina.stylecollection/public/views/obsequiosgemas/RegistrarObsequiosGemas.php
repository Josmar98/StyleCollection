...
<html>
<head>
  <title><?php echo SERVERURL; ?> | <?php if(!empty($action)){echo $action; } ?> <?php if(!empty($url)){echo "Gemas autorizadas";} ?></title>
        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Agregar <?php echo "Gemas autorizadas"; ?></h3>
            </div>
                ...
                <div class="box-body">
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-sm-6">
                         ...
                         <input type="number" class="form-control cantidad_gemas" min="0" id="cantidad_gemas" name="cantidad_gemas">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-sm-12">
                         <label for="descripcion">Descripción</label>
                          <input type="text" class="form-control descripcion" maxlength="100" id="descripcion" name="descripcion">
