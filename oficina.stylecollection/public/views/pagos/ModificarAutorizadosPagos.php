                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-6">
                           ...
                           <select class="form-control select2" id="tipoPago" name="tipoPago" style="width:100%;">
                                ...
                                <option <?php if($pago['tipo_pago']==$cvPagos['name']){ ?> selected <?php } ?>  ><?=$cvPagos['name']; ?></option>
                                <?php endforeach ?>
                                <!-- <option <?php if($pago['tipo_pago']=="Contado"){ ?> selected <?php } ?> >Contado</option> -->
                                <!-- <option <?php if($pago['tipo_pago']=="Inicial"){ ?> selected <?php } ?> >Inicial</option> -->
                                <!-- <option <?php if($pago['tipo_pago']=="Primer Pago"){ ?> selected <?php } ?> >Primer Pago</option> -->
                                <!-- <option <?php if($pago['tipo_pago']=="Segundo Pago"){ ?> selected <?php } ?> >Segundo Pago</option> -->
                                <?php 
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-6 col-md-6">
                          ...
                          <div class="input-group">
                           ...
                           <input type="number" placeholder="0.00" step="0.01" value="<?=$pago['equivalente_pago']?>" class="form-control equivalente montoDinero" id="equivalente" class="equivalente" name="equivalente">
                          </div>
...
$(document).ready(function(){
  ...
  if(response==undefined){
      ...
      swal.fire({
        ...
        <?php }else if(!empty($_GET['aux'])){ ?>
          menu = "?campaing="+campaing+"&n="+n+"&y="+y+"&dpid="+dpid+"&dp="+dp+"&route=<?=$_GET['aux']?>";
        <?php }else{ ?>
