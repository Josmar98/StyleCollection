  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- left column -->
      <?php if(($_SESSION['nombre_rol']=="Superusuario" || $_SESSION['nombre_rol']=="Administrador" || $_SESSION['nombre_rol']=="Analista Supervisor") || $_SESSION['nombre_rol']=="Vendedor" && $optHabilitarPagos=="1"): ?>
        <div class="col-xs-12" >
          ...
          <div class="box">
            ...
            <?php if( (empty($_GET['admin']) && !isset($_GET['select']) && !empty($_GET['fechaPagar'])) || (!empty($_GET['admin']) && isset($_GET['select']) && $_GET['select']==1  && !empty($_GET['fechaPagar'])) ){ ?>
            ...
            <div class="box-footer">
              <center>
                <span class="errors"><i>No hay tasa de pago cargada a la fecha <?=$lider->formatFecha($_GET['fechaPagar'])?>. Vuelva a intentarlo mas tarde, o al siguiente dia habil.</i></span>
              </center>
            </div>
              <?php endif; ?>
            <?php } ?>
