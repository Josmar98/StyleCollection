        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Editar <?php echo "Planes de colecciones"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                  <div class="row">
                    <div class="form-group col-sm-4">
                       ...
                       <input type="number" class="form-control" id="cantidad_aprobado" value="<?=$restoFinal?>" readonly>
                ...
                ?>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                             <label for="plan">Cantidad <?=$plan['nombre_plan']?></label>
                             <input type="text" class="form-control" id="cantidad<?=$plan['id_plan']?>" value="<?=$plan['cantidad_coleccion'];?>" readonly style='font-size:1.3em'>
                             <span id="error2_plan<?=$plan['id_plan']?>" class="errors"></span>
                    </div>


                   <!--  <div class="form-group col-sm-4">
                      <?php
                        foreach ($premios_planes as $key1) {
                          if(!empty($key1['id_plan_campana'])){
                            if($key1['id_plan_campana'] == $plan['id_plan_campana']){
                              echo $key1['tipo_premio'].": ";
                              foreach ($tipo_premios_planes as $key2) {
                                if(!empty($key2['id_ppc'])){
                                  if($key1['id_ppc']==$key2['id_ppc']){
                                    echo '"'.$key2['producto'].'", ';
                                  }
                                }
                              }
                    ...
                    <div class="form-group col-sm-4">
                       ...
                       <input type="number" step="1" min="0" class="form-control cantidades cant<?=$plan['id_plan']?>" id="<?=$plan['id_plan'];?>" name="cantidad_plan[]" value="<?=$plan['cantidad_coleccion_plan']?>">
