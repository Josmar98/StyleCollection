              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre_plan" name="nombre_plan" maxlength="90" placeholder="Ingresar nombre del plan">
                       <span id="error_nombre_plan" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="cantidad">Cantidad de colecciones</label>
                      <input type="number" class="form-control" step="1" id="cantidad" name="cantidad" maxlength="30" placeholder="Cantidad de Coleccion del plan">
