                                                            ...
                                                            <?php
                                                              ...
                                                              foreach($prinv as $inv){
                                                                if(!empty($inv['id_premio_inventario'])){
                                                                  ...
                                                                  <input style="width:20%;float:left;" type="number" class="form-control" value="<?=$inv['precio_inventario']; ?>" name="precios_inventario[]">
                                                                  <div style="clear:both;"></div>
                                                                  <?php
                                                                }
                                                              }
                                                ...
                                                <?php
                                                  ...
                                                  foreach($prinv as $inv){
                                                    if(!empty($inv['id_premio_inventario'])){
                                                      ...
                                                      <input style="width:10%;float:left;" type="text" class="form-control" value="<?=$inv['unidades_inventario']; ?>" name="unidades_inventario[]" readonly>
                                                      <input style="width:70%;float:left;" type="text" class="form-control" value="<?=$inv['elemento']; ?>" name="elementos[]" readonly>
                                                      <input style="width:20%;float:left;" type="number" class="form-control" value="<?=$inv['precio_inventario']; ?>" name="precios_inventario[]" readonly>
                                                      <div style="clear:both;"></div>
                                                      <?php
                                                    }
                                                  }
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        var n = $(".n").val();
        var y = $(".y").val();
        window.location = "?campaing="+campaing+"&n="+n+"&y="+y+"&route=PreciosInventario";
      });
    }
    if(response == "2"){
      swal.fire({
