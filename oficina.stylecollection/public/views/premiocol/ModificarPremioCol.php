                            ...
                            if($key1['id_plan_campana'] == $premios['id_plan_campana']){?>
                              <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                  ...
                                  <input type="hidden" id="existencia<?=$plan['id_plan'].$key1['id_premio']?>" name="existenciaAct[]" value="<?=$exiss['cantidad_existencia']+$key1['cantidad_premios_plan']?>">
                                ...
                                <div class="form-group col-sm-6">
                                   ...
                                   <input type="number" step="1" min="0" class="form-control cantidades cant<?=$plan['id_plan'].$key1['id_premio']?>" id="<?=$plan['id_plan'].$key1['id_premio'];?>" name="cantidad_premios_plan[]" <?php if($plan['cantidad_coleccion_plan']=="0"){echo "readonly value='0'";}else{ ?> value="<?=$key1['cantidad_premios_plan']?>" <?php } ?> >
                                    
                                    <input type="hidden" id="llenar<?=$plan['id_plan'].$key1['id_premio'];?>" <?php if($plan['cantidad_coleccion_plan']=="0"){echo " value='0'";}else{ ?> value="<?=$key1['cantidad_premios_plan']?>" <?php } ?>>


                                    <input type="hidden" name="id_premio_coleccion[]" value="<?=$key1['id_premio_coleccion']?>">
