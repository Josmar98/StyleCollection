          ...
          <div class="box">
            ...
            <form action="" method="post" role="form" class="form_register">
              <div class="box-body">
                                ...
                                if($plan['cantidad_coleccion_plan']!=0){ ?>
                                  ...
                                  <div class="row">
                                    <div class="col-xs-12">
                                      ...
                                      <input type="number" style="background:non" step="1" min="0" class="form-control aprobado<?=$plan['id_plan']?>" id="<?=$plan['id_plan'];?>" name="cantidad_plan[]" readonly value="<?=$plan['cantidad_coleccion_plan']?>">
                                              ...
                                              if($premiosPlan['id_ppc']==$premios['id_ppc']){
                                                ...
                                                <div class="col-xs-12">
                                                  <div class="form-group col-xs-12">
                                                    ...
                                                    <?php foreach ($existencias as $exiss) {
                                                      if(!empty($exiss['id_premio'])){
                                                        if($exiss['id_premio'] == $premiosPlan['id_premio']){
                                                          ...
                                                          <input type="hidden" id="existencia<?=$plan['id_plan'].$premiosPlan['id_premio']?>" name="existenciaAct[]" value="<?=$exiss['cantidad_existencia']?>">
                                                    ...
                                                    <input type="number" step="1" min="0" class="form-control cantidades cant<?=$plan['id_plan'].$premiosPlan['id_premio']?>" id="<?=$plan['id_plan'].$premiosPlan['id_premio'];?>" name="cantidad_premios_plan[]" <?php if($plan['cantidad_coleccion_plan']==0){echo "readonly";}?> value="0">
                                                    <input type="hidden" id="llenar<?=$plan['id_plan'].$premiosPlan['id_premio'];?>" value="0">
                ...
                <?php
                  $planesss3 = []; $x = 0;
                  if(!empty($tipo_premios_planespp)){
                    foreach ($tipo_premios_planespp as $keys3){
                      if (!empty($keys3['id_premio'])){
                        $stp = "";
