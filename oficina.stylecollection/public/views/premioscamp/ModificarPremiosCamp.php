                    ...
                    <div class="col-sm-12">
                      <h3 class="box-title">
                        ...
                        <select name="plan" id="plan" class="select2" style="width:70%">
                          <option value=""></option>
                          <?php   foreach ($planes as $data): if(!empty($data['id_plan'])): ?>
...
<input type="hidden" class="tInicial" value="<?php echo $tipo_inicial ?>">
<input type="hidden" class="tPrimer" value="<?php echo $tipo_primer ?>">
<input type="hidden" class="tSegundo" value="<?php echo $tipo_segundo ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <select class="form-control select2" name="tipoInicial" id="tipoInicial">
                         <option value=""></option>
                         <option <?php foreach ($tipos_premios as $data){if(!empty($data['tipo_premio'])){if($data['tipo_premio'] == "Inicial" && $data['tipo_premio_producto']=="Productos"){ echo "selected=''";}}}?> >Productos</option>
                         <option <?php foreach ($tipos_premios as $data){if(!empty($data['tipo_premio'])){if($data['tipo_premio'] == "Inicial" && $data['tipo_premio_producto']=="Premios"){ echo "selected=''";}}}?> >Premios</option>
                       </select>
                    ...
                    <div class="form-group col-sm-6 box-premiosInicial d-none">
                      ...
                      <select class="select2" style="width:100%" id="premiosInicial" multiple="multiple" name="premiosInicial[]">
                        ...
                        <!-- <option value="0">Ninguna</option> -->
                          ...
                          <option value="<?php echo $data['id_premio'] ?>" <?php foreach ($tpremios as $data2){if(!empty($data2['id_premio'])){if($data2['tipo_premio'] == "Inicial" && $data['id_premio']==$data2['id_premio']){echo "selected=''";}}} ?>><?php echo $data['nombre_premio'] ?></option>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <select class="form-control select2" name="tipoPrimer" id="tipoPrimer">
                         <option value=""></option>
                         <option <?php foreach ($tipos_premios as $data){if(!empty($data['tipo_premio'])){if($data['tipo_premio'] == "Primer" && $data['tipo_premio_producto']=="Productos"){ echo "selected=''";}}}?> >Productos</option>
                         <option <?php foreach ($tipos_premios as $data){if(!empty($data['tipo_premio'])){if($data['tipo_premio'] == "Primer" && $data['tipo_premio_producto']=="Premios"){ echo "selected=''";}}}?> >Premios</option>
                       </select>
                    ...
                    <div class="form-group col-sm-6 box-productosPrimer d-none">
                      ...
                      <select class="select2" style="width:100%;" id="productosPrimer" multiple="multiple" name="productosPrimer[]">
                         <option value=""></option>
                          <!-- <option value="0">Ninguna</option> -->
                            <?php foreach ($productos as $data): if( !empty($data['id_producto']) ): ?>
                          <option value="<?php echo $data['id_producto'] ?>" <?php foreach ($tpremios as $data2){if(!empty($data2['id_premio'])){if($data2['tipo_premio'] == "Primer" && $data['id_producto']==$data2['id_premio']){echo "selected=''";}}} ?> ><?php echo $data['producto'] ?></option>
                            <?php endif; endforeach; ?>
                      </select>
                    ...
                    <div class="form-group col-sm-6 box-premiosPrimer d-none">
                      ...
                      <select class="select2" style="width:100%;" id="premiosPrimer" multiple="multiple" name="premiosPrimer[]">
                        ...
                        <!-- <option value="0">Ninguna</option> -->
                            <?php foreach ($premios as $data): if( !empty($data['id_premio']) ): ?>
                          <option value="<?php echo $data['id_premio'] ?>" <?php foreach ($tpremios as $data2){if(!empty($data2['id_premio'])){if($data2['tipo_premio'] == "Primer" && $data['id_premio']==$data2['id_premio']){echo "selected=''";}}} ?> ><?php echo $data['nombre_premio'] ?></option>
                            <?php endif; endforeach; ?>
                      </select>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <select class="form-control select2" name="tipoSegundo" id="tipoSegundo">
                         <option value=""></option>
                         <option <?php foreach ($tipos_premios as $data){if(!empty($data['tipo_premio'])){if($data['tipo_premio'] == "Segundo" && $data['tipo_premio_producto']=="Productos"){ echo "selected=''";}}}?> >Productos</option>
                         <option <?php foreach ($tipos_premios as $data){if(!empty($data['tipo_premio'])){if($data['tipo_premio'] == "Segundo" && $data['tipo_premio_producto']=="Premios"){ echo "selected=''";}}}?> >Premios</option>
                       </select>
                    ...
                    <div class="form-group col-sm-6 box-productosSegundo d-none">
                      ...
                      <select class="select2" style="width:100%" id="productosSegundo" multiple="multiple" name="productosSegundo[]">
                        ...
                        <!-- <option value="0">Ninguna</option> -->
                            <?php foreach ($productos as $data): if( !empty($data['id_producto'])): ?>
                          <option value="<?php echo $data['id_producto'] ?>"  <?php foreach ($tpremios as $data2){if(!empty($data2['id_premio'])){if($data2['tipo_premio'] == "Segundo" && $data['id_producto']==$data2['id_premio']){echo "selected=''";}}} ?> ><?php echo $data['producto'] ?></option>
                            <?php endif; endforeach; ?>
                      </select>
                    ...
                    <div class="form-group col-sm-6 box-premiosSegundo d-none">
                      ...
                      <select class="select2" style="width:100%" id="premiosSegundo" multiple="multiple" name="premiosSegundo[]">
                        ...
                        <!-- <option value="0">Ninguna</option> -->
                            <?php foreach ($premios as $data): if( !empty($data['id_premio'])): ?>
                          <option value="<?php echo $data['id_premio'] ?>"  <?php foreach ($tpremios as $data2){if(!empty($data2['id_premio'])){if($data2['tipo_premio'] == "Segundo" && $data['id_premio']==$data2['id_premio']){echo "selected=''";}}} ?> ><?php echo $data['nombre_premio'] ?></option>
                            <?php endif; endforeach; ?>
                      </select>
