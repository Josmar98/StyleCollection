                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <?php
                          ...
                          $num++;
                        ?>
                        <input type="number" class="nombre_Inicial form-control cantidadPerdidas" value="<?=$dataperdidos['cantidad_premios_perdidos']?>" id="<?=$cantidad_colecciones;?>" name="cantidadesPedidas[]">
                      </div>
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <?php
                          ...
                          $num++;
                        ?>
                        <input type="number" class="nombre_Standard form-control cantidadPerdidas"  value="<?=$dataperdidos['cantidad_premios_perdidos']?>" id="<?=$data2['cantidad_coleccion_plan'];?>" name="cantidadesPedidas[]">
                      </div>
                                ...
                                <div class="form-group col-xs-12">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <?php
                                      ...
                                      $num++;
                                    ?>
                                    <input type="number" class="<?='id'.'_'.$data3['id_premio']?> form-control cantidadPerdidas" id="<?=$data3['cantidad_premios_plan'];?>" value="<?=$dataperdidos['cantidad_premios_perdidos']?>" name="cantidadesPedidas[]">
                                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <div class="input-group">
                      ...
                      <?php
                          ...
                          $num++;
                      ?>
                      <input type="number" class="nombre_Segundo form-control cantidadPerdidas" value="<?=$dataperdidos['cantidad_premios_perdidos']?>" id="<?=$cantidad_colecciones;?>" name="cantidadesPedidas[]">
                    </div>
