                                          ...
                                          <div class="form-group col-xs-12">
                                            ...
                                            <?php
                                              ...
                                              if(mb_strtolower($nameTPlanesTemp)==mb_strtolower("Productos")){ 
                                                ...
                                                <!-- Activo ACA -->
                                                <!-- <br> -->
                                                <!-- nombre_<?=$pagosR['id'].$idPlanesTemp; ?> -->
                                                <!-- <br> -->
                                                <!-- error_nombreid_<?=$idPlanesTemp; ?> -->
                                                <!-- <br> -->
                                                <!-- Activo ACA -->
...
$(document).ready(function(){
  ...
  $(".cantidadPerdidas").keyup(function(){
    ...
    // alert(titulo + " | " + seleccion_premios);
    if(titulo == seleccion_premios){
      ...
      for (var i = 0; i < planes.length; i++) {
        ...
        // alert(claseTemp+ " | " + $("."+claseTemp).attr("title") + " | " + seleccion_premios);
