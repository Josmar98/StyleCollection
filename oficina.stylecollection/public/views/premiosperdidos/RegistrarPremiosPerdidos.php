                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <select class="form-control select2 selectLider" id="lider" name="lider" style="width:100%;">
                      ...
                      <option <?php if (!empty($_GET['lider'])): if($data['id_cliente']==$_GET['lider']): ?>
                          selected="selected"
                      <?php endif; endif; ?> value="<?=$data['id_cliente']?>" <?php foreach ($premios_perdidos_usados as $pclientes) { if(!empty($pclientes['id_cliente'])){ if($pclientes['id_cliente']==$data['id_cliente']){ ?> disabled="" <?php } } } ?> ><?=$data['primer_nombre']." ".$data['primer_apellido']." ".$data['cedula']?></option>
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <?php
                          ...
                          $num++;
                        ?>
                        <input type="number" class="nombre_Inicial form-control cantidadPerdidas" id="<?=$cantidad_colecciones;?>" name="cantidadesPedidas[]">
                      </div>
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <div class="input-group">
                        ...
                        <?php
                          ...
                          $num++;
                        ?>
                        <input type="number" class="nombre_Standard form-control cantidadPerdidas" id="<?=$data2['cantidad_coleccion_plan'];?>" name="cantidadesPedidas[]">
                      </div>
                                ...
                                <div class="form-group col-xs-12">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <?php
                                      ...
                                      $num++;
                                    ?>
                                    <input type="number" class="<?='id'.'_'.$data3['id_premio']?> form-control cantidadPerdidas" id="<?=$data3['cantidad_premios_plan'];?>"  name="cantidadesPedidas[]">
                                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <div class="input-group">
                      ...
                      <?php
                          ...
                          $num++;
                      ?>
                      <input type="number" class="nombre_Segundo form-control cantidadPerdidas" id="<?=$cantidad_colecciones;?>" name="cantidadesPedidas[]">
                    </div>
