              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre_producto" value="<?php echo $producto['producto'] ?>" name="nombre_producto" maxlength="150" placeholder="Ingresar nombre del producto">
                       <span id="error_nombre_producto" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="cantidad">Cantidad</label>
                       <input type="text" class="form-control" id="cantidad" value="<?php echo $producto['cantidad'] ?>" name="cantidad" maxlength="20" placeholder="Cantidad del producto. Ej (400ml)">
                    ...
                    <!-- <div class="form-group col-sm-4">
                       ...
                       <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="precio" value="<?php echo $producto['precio'] ?>" name="precio" maxlength="30" placeholder="Precio del producto">
                       </div>
