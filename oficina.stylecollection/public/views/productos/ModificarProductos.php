              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="hidden" id="id_producto" value="<?=$producto['id_producto'] ?>" name="id_producto">
                       <input type="text" class="form-control" id="codigo_producto" value="<?=$producto['codigo_producto'] ?>" name="codigo_producto" maxlength="150" placeholder="Ingresar nombre del producto">
                       <span id="error_codigo_producto" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="nombre_producto">Nombre</label>
                       <input type="text" class="form-control" id="nombre_producto" value="<?=$producto['producto'] ?>" name="nombre_producto" maxlength="150" placeholder="Ingresar nombre del producto">
                       <span id="error_nombre_producto" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="cantidad">Unidad de medida</label>
                       <input type="text" class="form-control" id="cantidad" value="<?=$producto['cantidad'] ?>" name="cantidad" maxlength="20" placeholder="Medida del producto. (400ml, 50g, 2lts)">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <input type="text" class="form-control" id="marca_producto" value="<?=$producto['marca_producto'] ?>" name="marca_producto" maxlength="150" placeholder="Ingresar la marca del producto">
                      <span id="error_marca_producto" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                      <label for="color_producto">Color</label>
                      <input type="color" class="form-control" id="color_producto" value="<?=$producto['color_producto'] ?>" name="color_producto" maxlength="150" placeholder="Ingresar color del producto">
