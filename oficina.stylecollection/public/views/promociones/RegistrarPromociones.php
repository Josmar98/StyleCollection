        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Solicitar Promoción</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <input type="number" class="form-control" id="cantidad" step="1" name="cantidad" <?php if(!empty($_GET['admin']) && empty($_GET['lider'])){ echo "disabled"; } ?>>
