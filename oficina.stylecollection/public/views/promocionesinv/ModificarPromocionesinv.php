              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-11">
                       ...
                       <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $datas['nombre_promocioninv'] ?>" maxlength="30" placeholder="Ingresar nombre del promocion">
...
function validar(){
  ...
  if( rnombre == false ){
    if(nombre.length != 0){
      $("#error_nombre").html("El nombre de la promocion no debe contener numeros o caracteres especiales");
    }else{
      $("#error_nombre").html("Debe llenar el campo de nombre de la promocion");      
    }
  }else{
    $("#error_nombre").html("");
  }
