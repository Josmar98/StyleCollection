...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $modulo; ?>
        <small><?php if(!empty($action)){echo $action;} echo " "; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?route=Home"><i class="fa fa-dashboard"></i> Inicio </a></li>
        <li><a href="?route=<?=$url; ?>"><?php echo $modulo; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo $action;} echo " de ". $modulo; ?></li>
      </ol>
    </section>
          <br>
                ...
                <div class="row">
                  <div class="form-group col-sm-12 col-md-4">
                     ...
                     <div class="input-group" style="width:100%;">
                       ...
                       <input type="text" class="form-control" maxlength="10" style="width:80%;" id="rif" name="rif" placeholder="12345678-9">
                     </div>
                     <span id="error_rif" class="errors"></span>
                  </div>
                  <div class="form-group col-sm-12 col-md-4">
                     <label for="nombre">Nombre o razón social del Proveedor</label>
                     <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de proveedor">
                     <span id="error_nombre" class="errors"></span>
                  </div>
                  <div class="form-group col-sm-12 col-md-4">
                    <label for="tipoInv">Tipo de inventario</label>
                    <select class="form-control select2" id="tipoInv" name="tipoInv[]" style="width:100%;" multiple="multiple">
                    <option value=""></option>
...
function validar(){
  ...
  if(tipoInv==""){
    rtipoInv=false;
    $("#error_tipoInv").html("Debe seleccionar al menos un inventario");
  }else{
    rtipoInv=true;
    $("#error_tipoInv").html("");
  }
