...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $url; ?>
        <small><?php if(!empty($action)){echo "Canjeo de Gemas";} echo " "; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?route=Home"><i class="fa fa-dashboard"></i> Inicio </a></li>
        <li><a href="?route=<?php echo $url ?>"><?php echo $url; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo "Canjeo de Gemas";} echo " "; ?></li>
      </ol>
    </section>
          <br>
        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reporte de <?php echo "Canjeo de Gemas"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body"> 
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6" style="text-align:right;">
                          <a href="?route=Reportes&action=GenerarCanjeoGemas" target="_blank"><button class="btn" style="background:<?=$fucsia?>;color:#FFF;">Generar PDF</button></a>
                      </div>
                    </div>
                      ...
                      <tbody>
                        ...
                        <?php foreach ($newData as $data): if(!empty($data['id_cliente'])):?>
                          ...
                          ?>
                              ...
                              <?php if (($data['canjeadas']+$data['asignadas']+$data['noasignadas'])>0): ?>
                              <tr class="elementTR">
                                <td><?=$num;?></td>
                                <td>
                                    <?php 
                                ...
                                <td>
                                    <?php 
                                      echo "<b style='color:#5C5'>".number_format($data['asignadas'],2,',','.')."</b> Gemas";
                                      $gemasAsignadas += $data['asignadas'];
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                      echo "<b style='color:#C55'>".number_format($data['noasignadas'],2,',','.')."</b> Gemas";
                        ...
                        <?php endif; endforeach; ?>
                          <tr style="background:#eee;">
                            ...
                            <td>
                              <b>
                                  <?php 
                                      echo number_format($gemasCanjeadas,2,',','.')." Gemas Canjeadas"; 
                                  ?>
                              </b>
                            </td>
                            <td>
                              <b>
                                  <?php 
                                      echo number_format($gemasAsignadas,2,',','.')." Gemas Asignadas"; 
                                  ?>
                              </b>
                            </td>
                            <td>
                              <b>
                                  <?php 
                                      echo number_format($gemasNoAsignadas,2,',','.')." Gemas No Asignadas"; 
                                  ?>
                              </b>
                            </td>
                          </tr>
