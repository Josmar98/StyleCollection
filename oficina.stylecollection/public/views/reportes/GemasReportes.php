...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $url; ?>
        <small><?php if(!empty($action)){echo "Gemas";} echo " "; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?route=Home"><i class="fa fa-dashboard"></i> Inicio </a></li>
        <li><a href="?route=<?php echo $url ?>"><?php echo $url; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo "Gemas";} echo " "; ?></li>
      </ol>
    </section>
          <br>
        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reporte de <?php echo "Gemas"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="" method="get" role="form" class="form_register">
              <div class="box-body">
                  ...
                  $pedidos = $lider->consultarQuery("SELECT * FROM campanas, despachos WHERE campanas.id_campana = despachos.id_campana ORDER BY campanas.id_campana DESC;");  // $redired = "route=".$_GET['route']."&action=".$_GET['action']."&id=".$_GET['id']; ?>
                        ...
                        <input type="hidden" name="action" value="Gemas">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6" style="text-align:right;">
                          <a href="?route=Reportes&action=GenerarGemas&id=<?=$_GET['P']?>" target="_blank"><button class="btn" style="background:<?=$fucsia?>;color:#FFF;">Generar PDF</button></a>
                      </div>
                    </div>
                    <table class="table table-bordered table-striped text-center" style="font-size:1.1em;">
                      ...
                      <tbody>
                        <?php $num = 1; 
                          ...
                          $gemasDisponibles = 0;
                        ?>
                        <?php foreach ($newData as $data): if(!empty($data['id_cliente'])):?>
                          <?php
                            $permitido = "0";
                            if($accesoBloqueo=="1"){
                          ...
                          ?>
                              ...
                              <?php if (($data['canjeadas']+$data['bloqueadas']+$data['disponibles'])>0): ?>
                              <tr class="elementTR">
                                <td><?=$num;?></td>
                                <td>
                                    <?php 
                                ...
                                <td>
                                    <?php 
                                      echo "<b style='color:#55C'>".number_format($data['canjeadas'],2,',','.')."</b> Gemas";
                                      $gemasCanjeadas += $data['canjeadas'];
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                      echo "<b style='color:#C55'>".number_format($data['bloqueadas'],2,',','.')."</b> Gemas";
                                      $gemasBloqueadas += $data['bloqueadas'];
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                      echo "<b style='color:#5C5'>".number_format($data['disponibles'],2,',','.')."</b> Gemas";
                                      $gemasDisponibles += $data['disponibles'];
                                      $acumDisponible += $gemasDisponibles;
                                    ?>
                                </td>
                              </tr>
                              <?php $num++; ?>
                        ...
                        <?php endif; endforeach; ?>
                          <tr style="background:#eee;">
                            ...
                            <td>
                              <b>
                                  <?php 
                                      echo number_format($gemasCanjeadas,2,',','.')." Gemas"; 
                                  ?>
                              </b>
                            </td>
                            <td>
                              <b>
                                  <?php 
                                      echo number_format($gemasBloqueadas,2,',','.')." Gemas"; 
                                  ?>
                              </b>
                            </td>
                            <td>
                              <b>
                                  <?php 
                                      echo number_format($gemasDisponibles,2,',','.')." Gemas"; 
                                  ?>
                              </b>
                            </td>
                          </tr>
