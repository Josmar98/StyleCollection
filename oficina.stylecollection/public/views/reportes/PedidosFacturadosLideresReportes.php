              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control conductor" id="conductor" name="conductor" value="<?php if(!empty($_GET['conductor'])){ echo $_GET['conductor']; } ?>" required>
                      <span class="errors error_conductor"></span>
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="cedula">Cedula del Conductor: </label>
                      <input type="text" class="form-control cedula" id="cedula" name="cedula" value="<?php if(!empty($_GET['cedula'])){ echo $_GET['cedula']; } ?>" required>
                      <span class="errors error_cedula"></span>
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="tlf">Telefono del Conductor: </label>
                      <input type="text" maxlength="12" class="form-control tlf" id="tlf" name="tlf" value="<?php if(!empty($_GET['tlf'])){ echo $_GET['tlf']; } ?>" required>
                      <span class="errors error_tlf"></span>
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="vehiculo">Tipo de Vehículo: </label>
                      <input type="text" class="form-control vehiculo" id="vehiculo" name="vehiculo" value="<?php if(!empty($_GET['vehiculo'])){ echo $_GET['vehiculo']; } ?>" required>
                      <span class="errors error_vehiculo"></span>
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="placa">Placa del Vehículo: </label>
                      <input type="text" class="form-control placa" id="placa" name="placa" value="<?php if(!empty($_GET['placa'])){ echo $_GET['placa']; } ?>" required>
                      <span class="errors error_placa"></span>
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="ruta">Nombre de la Ruta: </label>
                      <input type="text" class="form-control ruta" id="ruta" name="ruta" value="<?php if(!empty($_GET['ruta'])){ echo $_GET['ruta']; } ?>" required>
            ...
            <div class="box-body"> 
              <div class="row">
                <div class="col-xs-12">
                    ...
                    <table class="table table-bordered table-striped text-center" style="font-size:1.1em;">
                      ...
                      <tbody>
                        <?php 
                          ...
                          // $total_colecciones=0;
                          // foreach ($tipoColecciones as $tipoCol) {
                          //   $sumatorias[$tipoCol['id']]['cantidad']=0;
                            
                          //   $resumenTotal[$tipoCol['id']]['num']=$num;
                          //   $resumenTotal[$tipoCol['id']]['colecciones']="Colección de ".$tipoCol['name'];
                          //   $facturado = $facturados[$tipoCol['id']];
                          //   $resumenTotal[$tipoCol['id']]['facturas']="";
                          //   $indexado = 0;
                          //   foreach ($facturado as $fact) {
                          //     $numero_fact = $fact['numero_factura'];
                          //     $sumatorias[$tipoCol['id']]['cantidad']+=$fact['cantidad'];
                          //     $numeracion = "";
                          //     if(strlen($numero_fact)<6){
                          //       for ($i=0; $i < (6-strlen($numero_fact)); $i++) { 
                          //         $numeracion.="0";    
                          //       }
                          //     }
                          //     // echo $numeracion.$numero_fact;
                          //     $resumenTotal[$tipoCol['id']]['facturas'].=$numeracion.$numero_fact;
                          //     $indexado++;
                          //     if($indexado < count($facturado)){
                          //       // echo ", ";
                          //       $resumenTotal[$tipoCol['id']]['facturas'].=", ";
                          //     }
                          //     $resumenTotal[$tipoCol['id']]['cantidades']="";
                          //     foreach ($sumatorias[$tipoCol['id']] as $key) {
                          //       // echo $key." Cols.";
                          //       $resumenTotal[$tipoCol['id']]['cantidades'].=$key." Cols.";
                          //       $total_colecciones+=$key;
                          //     }
                          //   }
                          //   ?>
                             <!-- <tr>
                               ...
                               <td><?="Colección de ".$tipoCol['name']; ?></td>
                               <td>
                                 <?=$resumenTotal[$tipoCol['id']]['facturas']; ?>
                               </td>
                             </tr> -->
                          ...
                          //   $num++;
                          // }
                          // $resumenTotal['Ultima']['num']="";
                          // $resumenTotal['Ultima']['cantidades']=$total_colecciones." Cols.";
                          // $resumenTotal['Ultima']['colecciones']="";
                          // $resumenTotal['Ultima']['facturas']="";
                        ?>
                        <tr>
                          <th></th>
                          <th></th>
                    ...
                    <table style="width:100%;">
                      <tr>
                        <td style="width:25%;"><b>Despachado Por:</b></td>
                        <td style="width:25%;"></td>
                        <td style="width:25%;"><b>Conductor:</b></td>
                        <td style="width:25%;"></td>
                      </tr>
                      <tr>
                        <td style="width:25%;"><b>Nombre y Apellido:</b></td>
                        <td style="width:25%;"></td>
                        <td style="width:25%;"><b>Nombre y Apellido:</b></td>
                        <td style="width:25%;"></td>
                      </tr>
                      <tr>
                        <td style="width:25%;"><b>C.I.:</b></td>
                        <td style="width:25%;"></td>
                        <td style="width:25%;"><b>C.I.:</b></td>
                        <td style="width:25%;"></td>
                      </tr>
                      <tr>
                        <td style="width:25%;"><b>Firma:</b></td>
                        <td style="width:25%;"></td>
                        <td style="width:25%;"><b>Firma:</b></td>
                        <td style="width:25%;"></td>
                      </tr>
                    ...
                    <?php
                      $_SESSION['resumenTotalFactuacionPedidos']=$resumenTotal;
...
function validar(){
  ...
  /*===================================================================*/
  var result = false;
  if( rselected==true && rconductor==true && rcedula==true && rtlf==true && rvehiculo==true && rplaca==true && rruta==true ){
    result = true;
  }else{
    result = false;
  }
