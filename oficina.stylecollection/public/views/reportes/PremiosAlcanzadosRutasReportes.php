...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $url; ?>
        <small><?php if(!empty($action)){echo "Premios Alcanzados por Rutas";} echo " "; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?route=Home"><i class="fa fa-dashboard"></i> Inicio </a></li>
        <li><a href="?route=<?php echo $url ?>"><?php echo $url; ?></a></li>
        <li class="active"><?php if(!empty($action)){echo "Premios Alcanzados por Rutas";} echo " "; ?></li>
      </ol>
    </section>
          <br>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reporte de <?php echo "Premios Alcanzados por Rutas"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="" method="get" role="form" class="form_register">
              <div class="box-body">
                  ...
                  <input type="hidden" name="action" value="PremiosAlcanzadosRutas">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="rutaSelected"><b style="color:#000;">Seleccione la ruta</b></label>
                        <select id="rutaSelected" name="R" class="form-control select2" style="width:100%;">
                          <option value="0"></option>
                          <?php foreach ($rutas as $data):
                            if(!empty($data['id_ruta'])){ ?>
                              <option value="<?=$data['id_ruta']?>"
                                <?php if(!empty($id_ruta)){if($data['id_ruta']==$id_ruta){echo "selected";}} ?>
                                    >
                        ...
                        <span class="errors error_rutaSelected"></span>
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="order"><b style="color:#000;">Ordenamiento</b></label>
                        <select id="order" name="order" class="form-control select2" style="width:100%;">
                          <option value="ASC" <?php if(!empty($order)){ if($order=="ASC"){ echo "selected"; } } ?>>Ascendente</option>
                          <option value="DESC" <?php if(!empty($order)){ if($order=="DESC"){ echo "selected"; } } ?>>Descendente</option>
                        </select>
                    </div>
        ...
        <?php if(!empty($_GET['P']) && !empty($_GET['R'])){ ?>
            <div class="box-body">
              <div class="row">
                <div class="col-xs-12">
                ...
                <div class="col-xs-12">
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6" style="text-align:right;">
                          <a href="?route=Reportes&action=GenerarPremiosAlcanzadosRutas&id=<?=$id_despacho?>&ruta=<?=$id_ruta?>&order=<?=$order?>" target="_blank"><button class="btn" style="background:<?=$fucsia?>;color:#FFF;">Generar PDF</button></a>
                      </div>
                    </div>
                    <table class="table text-center datatable" id="">
                      ...
                      <tbody>
                        ...
                        <?php $num = 1; ?>
                        <?php foreach ($clientess as $data): if(!empty($data['id_pedido'])):?>

                          <tr class="elementTR">
                            <td style="width:10%;"><?=$data['posicion']?></td>
                            <td style="width:20%">
                                <?php 
                                                  ...
                                                  if($key['cantidad']>0){
                                                    ...
                                                    ?>
                                                        <table style="width:100%;">
                                                          <tr>
                                                            <td style="text-align:left;">
                                                              <?php echo $key['cantidad']." ".$planstandard['producto']; ?>
                                                            </td>
                                                            <td style="text-align:right;">
                                                              <?php
                                                                $totSelected = $acumColecciones;
                                                                $totAlcanzado = $key['cantidad'];
                                                  ...
                                                  if($key['cantidad']>0){
                                                    ...
                                                    <table style="width:100%;">
                                                          <tr>
                                                            <td style="text-align:left;">
                                                              <?php 
                                                                  echo $key['cantidad']." ".$planstandard['producto'];
                                                               ?>
                                                            </td>
                                                            <td style="text-align:right;">
                                                              <?php
...
function validar(){
  ...
  /*===================================================================*/
   var cliente = parseInt($("#rutaSelected").val());
  var rcliente = false;
  if(cliente > 0){
    rcliente = true;
    $(".error_rutaSelected").html("");
  }else{
    rcliente = false;
    $(".error_rutaSelected").html("Debe Seleccionar una ruta");      
  }
  /*===================================================================*/
