        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reporte de <?php echo "Premios Canjeados General"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
                  ...
                  <form action="" method="get" role="form" class="form_register formgemasCatalogo">
                    ...
                    <input type="hidden" name="action" value="PremiosCanjeadosGeneral">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6" style="text-align:right;">
                        <?php
                          $rutaReporte = "?route=Reportes&action=GenerarPremiosCanjeadosGeneral";
                          ...
                          ?>
                              ...
                              <tr class="elementTR">
                                ...
                                <td style="text-align:left;">
                                  <?php 
                                  foreach ($newData as $info2) {
                                    if(!empty($info2['id_catalogo_asignado'])){
                                        echo "(".$info2['cantidad_canjeo_asignado'].") &nbsp&nbsp ".$info2['nombre_catalogo_asignado']." ".$info2['marca_catalogo_asignado']."<br>";
                                    }
                                  }
                                ...
                                <td style="text-align:left;">
                                  <?php 
                                  foreach ($newData as $info2) {
                                    if(!empty($info2['id_catalogo_noasignado'])){
                                        echo "(".$info2['cantidad_canjeo_noasignado'].") &nbsp&nbsp ".$info2['nombre_catalogo_noasignado']." ".$info2['marca_catalogo_noasignado']."<br>";
                                    }
                                  }
                          ...
                          <tr style="background:#eee;">
                            ...
                            <td style="text-align:left;">
                              <b>
                                <?php 
                                  foreach ($newDataAcum as $key) {
                                    if($key['cantidad_asignado']>0){
                                      echo "(".$key['cantidad_asignado'].") &nbsp&nbsp".$key['nombre']." ".$key['marca']."<br>";
                                    }
                                  }
                                ?>
                              </b>
                            ...
                            <td style="text-align:left;">
                              <b>
                                <?php 
                                  foreach ($newDataAcum as $key) {
                                    if($key['cantidad_noasignado']>0){
                                      echo "(".$key['cantidad_noasignado'].") &nbsp&nbsp".$key['nombre']." ".$key['marca']."<br>";
                                    }
                                  }
                                ?>
                              </b>
