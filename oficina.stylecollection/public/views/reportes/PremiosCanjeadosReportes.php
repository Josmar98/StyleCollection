        ...
        <div class="col-md-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reporte de <?php echo "Premios Canjeados Totales"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
                  ...
                  <form action="" method="get" role="form" class="form_register formgemasCatalogo">
                    ...
                    <input type="hidden" name="action" value="PremiosCanjeados">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6" style="text-align:right;">
                        <?php
                          $rutaReporte = "?route=Reportes&action=GenerarPremiosCanjeados";
