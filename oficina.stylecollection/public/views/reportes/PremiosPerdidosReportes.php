                                                      ...
                                                      if ($planstandard['id_plan_campana']):
                                                        ...
                                                        <table style="width:100%;">
                                                          <tr>
                                                            ...
                                                            <?php
                                                        // echo $perdidos." ".$planstandard['producto'];
                                                        // echo "<br>";
                                                          endif;
                                                      endif;
                                                    endforeach;
                                              ...
                                              <td style="width:50%;">
                                                  <table style='width:100%;background:none'> 
                                                      <tr>
                                                                      ...
                                                                      if ($data2['nombre_plan'] == $planstandard['nombre_plan']):
                                                                        if ($planstandard['tipo_premio']=="Primer"): ?>
                                                                          ...
                                                                          <?php 
                                                                            ...
                                                                            // $porcentSelected = $data2['cantidad_coleccion_plan'];
                                                                            // $porcentPerdido = $perdidos;
                                                                            // $porcentResul = ($perdidos/$data2['cantidad_coleccion_plan'])*100;

                                                                            // echo number_format($porcentResul,2,',','.');
                                                        ...
                                                        <td>
                                                            <?php //$porcentSelected." / ".$porcentPerdido." * 100 = ".$porcentResul; ?>
                                                            <?php //number_format($porcentResul,2,',','.');?>
                                                        </td>
                                                      </tr>
                                                              ...
                                                              foreach ($premios_perdidos as $dataperdidos) {
                                                                  if(!empty($dataperdidos['id_premio_perdido'])){
                                                                    if(($dataperdidos['id_tipo_coleccion'] == $data3['id_tipo_coleccion']) && ($dataperdidos['id_tppc'] == $data3['id_tppc'])){
                                                                      ...
                                                                      <?php 
                                                                      // echo $perdidos." ".$data3['nombre_premio'];
                                                                      // $porcentSelected = $data3['cantidad_premios_plan'];
                                                                      // $porcentPerdido = $perdidos;
                                                                      // $porcentResul = ($perdidos/$data3['cantidad_premios_plan'])*100;
                                                ...
                                                <?php if ($plan['nombre_plan']==$prem['plan']): ?>
                                                  <?php foreach ($prem['premio'] as $prem2): ?>
                                                    ...
                                                    <?php 
                                                      ...
                                                      // echo $acumPlanes[$plan['nombre_plan']];
                                                      // echo $prem2['cantidad']; 
                                                    ?>
                                                    <?php endif; ?>
                                                  <?php endforeach ?>
