                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <select class="form-control select2 selectLider" id="lider" name="lider" style="width:100%;">
                      ...
                      <?php foreach ($liderRetos as $pclientes) { if(!empty($pclientes['id_cliente'])){ if($pclientes['id_cliente']==$data['id_cliente']){ ?> disabled <?php } } } ?> ><?=$data['primer_nombre']." ".$data['primer_apellido']." ".$data['cedula']?></option>
