                  ...
                  <div class="row">
                        ...
                        <?php 
                          foreach ($retosInv as $data) {
                            if(!empty($data['id_retoinv'])){
                              ?>
                              <option 
                              <?php foreach ($retos_campana as $data2){
                    ...
                    <!-- <div class="form-group col-xs-12 col-sm-6">
                       ...
                       <select class="form-control select2" id="premios" name="premios">
                        ...
                        ?>
                        <option <?php foreach ($retos_campana as $data2){if(!empty($data2['id_reto_campana'])){ if($data['id_premio']==$data2['id_premio']){  echo "disabled";  } }} ?> value="<?php echo $data['id_premio'] ?>"><?php echo $data['nombre_premio']; ?></option>
                        <?php
                           }
                         }
                        ?>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <div class="col-xs-12" style="width:100%;border:1px solid #cdcdcd;padding:;">
                        ...
                        <input type="text" class="form-control" style="width:84%;float:right;" id="name_opcion" name="name_opcion" placeholder="Coloque nombre de premio"  value="">
                        ...
                        <?php for($z=1; $z<=$limitesElementos; $z++){ ?>
                          <div style="width:100%;" id="box_tipo<?=$z; ?>" class="box_inventario_tipo box_inventario_tipo<?=$z; ?> <?php if($z>$elementosMostrar){ echo "d-none"; } ?>">
                            ...
                            <div class="" style="width:15%;float:left;">
                              ...
                              <input type="number" class="form-control unidades" id="unidad<?=$z; ?>" name="unidades[]" value="">
