              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" id="nombre_reto" name="nombre_reto" maxlength="80" placeholder="Ingresar nombre del reto">
                       <span id="error_nombre_reto" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="num_colecciones">Numero de colecciones</label>
                       <input type="number" step="1" class="form-control" id="num_colecciones" name="num_colecciones" placeholder="Numero de colecciones">
