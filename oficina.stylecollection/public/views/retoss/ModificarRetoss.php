  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action." Editar";}else{echo "Editar";} ?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12" >
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Editar <?php echo "Retos"; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
              <form action="" method="post" role="form" class="form_register">
                  ...
                  <div class="row">
                    <div class="form-group col-sm-4">
                       ...
                       <input type="number" class="form-control" id="cantidad_aprobado" value="<?=$disponible?>" readonly>
                       <input type="hidden" id="cantidad_aprobado2" value="<?=$cantidad_colecciones;?>">
                  ...
                  <?php
                    ...
                    <div class="row">
                      <div class="form-group col-sm-4">
                         ...
                         <?php
                          $id_premios_busqueda = $reto['id_premio'];
                      ...
                      <div class="form-group col-sm-4">
                        <?php foreach ($retosLider as $data3): ?>
                          <?php if (!empty($data3['id_reto_campana'])): ?>
                            <?php if ($data3['id_reto_campana'] == $reto['id_reto_campana']): ?>

                         <label for="cantidad_premio<?=$reto['nombre_premio']?>">Cantidad de retos</label>
                         <input type="number" step="1" min="0" class="form-control cantidades cant<?=$reto['id_premio']?>" id="<?=$reto['id_premio'];?>" name="cantidad_plan[]" value="<?=$data3['cantidad_retos']?>">
...
<input type="hidden" class="idAdmin" <?php if(!empty($_GET['admin'])): ?> value="<?=$_GET['admin']?>" <?php else: ?> value="0" <?php endif; ?>>
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        if(idAdmin==0){
          var menu = "?campaing="+campaing+"&n="+n+"&y="+y+"&dpid="+dpid+"&dp="+dp+"&route=MisRetos";
        }
        if(idAdmin!=0){
