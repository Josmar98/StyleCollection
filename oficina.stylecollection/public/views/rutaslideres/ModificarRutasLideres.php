                  ...
                  <div class="row">
                    <div class="form-group col-xs-12">
                        ...
                        <select class="form-control select2" id="rutas" name="ruta" style="width:100%;">
                          ...
                          <option value="<?=$ruta['id_ruta'];?>" <?php foreach ($rutasya as $ruta2){ if(!empty($ruta2['id_ruta'])){ if($ruta['id_ruta'] == $ruta2['id_ruta']){ if($ruta['id_ruta']==$id){ echo "selected"; }else{ echo "disabled"; } } } } ?> ><?=$ruta['nombre_ruta'];?></option>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <div class="input-group">
                        ...
                        <select class="form-control select2 lideres" id="lideres<?=$posicion;?>" name="lideres[]" style="width:100%;">
                          ...
                          <option value="<?=$data['id_cliente']?>" <?php foreach($lideresya as $data2){ if(!empty($data2['id_cliente'])){ if($data['id_cliente']==$data2['id_cliente']){ if($data2['id_ruta']==$id){ if($data2['posicion']==$posicion){ echo "selected"; } }else{ echo "disabled"; } } } } ?> >
                            
                            <?=$data['primer_nombre']." ".$data['primer_apellido']." - ".$data['cedula']?><?php foreach($lideresya as $data2){ if(!empty($data2['id_cliente'])){ if($data['id_cliente']==$data2['id_cliente']){ echo " | Ruta (".$data2['nombre_ruta'].")"; } } } ?>
