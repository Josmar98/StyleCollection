              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-11">
                       ...
                       <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $datas['nombre_servicioss'] ?>" maxlength="30" placeholder="Ingresar nombre del servicio">
...
function validar(){
  ...
  if( rnombre == false ){
    if(nombre.length != 0){
      $("#error_nombre").html("El nombre del servicio no debe contener numeros o caracteres especiales");
    }else{
      $("#error_nombre").html("Debe llenar el campo de nombre del servicio");      
    }
  }else{
    $("#error_nombre").html("");
  }
