              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <input type="date" class="form-control" value="<?php echo date("Y-m-d") ?>" id="fecha" name="fecha" maxlength="30">
                       <span id="error_fecha" class="errors"></span>
                    </div>

                    <div class="form-group col-sm-6">
                       <label for="tasa">Tasa</label>
                       <input type="number" step="0.01" class="form-control" id="tasa" name="tasa" maxlength="30" placeholder="Precio de la Tasa del dia">
