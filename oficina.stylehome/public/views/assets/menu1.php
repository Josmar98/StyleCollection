        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="?route=Clientes&action=Registrar"><i class="fa fa-user-plus"></i> Registrar Lider</a></li>
                            ...
                            <?php if($url=="Clientes" && !empty($action) && $action == "Consultar"){ ?>
            ...
            <li><a href="?route=Clientes"><i class="fa fa-user"></i> Ver Lideres</a></li>
                            ...
                            <?php if($url=="Clientes" && !empty($action) && $action == "Borrados"){ ?>
            <li class="active"><a href="?route=Clientes&action=Borrados"><i class="fa fa-user"></i> Ver Lideres Suspendidos</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Clientes&action=Borrados"><i class="fa fa-user"></i> Ver Lideres Suspendidos</a></li>
                            <?php } ?>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
                            ...
                            <?php if($url=="Ciclos" && !empty($action) && $action == "Registrar"){ ?>
            <li class="active"><a href="?route=Ciclos&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Ciclo</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?route=Ciclos&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Ciclo</a></li>
                            <?php } ?>

                            <?php if($url=="Ciclos" && !empty($action) && $action == "Consultar"){ ?>
            <li class="active"><a href="?route=Ciclos"><i class="fa fa-puzzle-piece"></i> Ver Ciclos</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Ciclos"><i class="fa fa-puzzle-piece"></i> Ver Ciclos</a></li>
                            <?php } ?>

                            <?php if($url=="Ciclos" && !empty($action) && $action == "Borrados"){ ?>
            <li class="active"><a href="?route=Ciclos&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Ciclos Borradas</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Ciclos&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Ciclos Borradas</a></li>
                            <?php } ?>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
                            ...
                            <?php if($url=="Inventario" && !empty($action) && $action == "Registrar"){ ?>
            <li class="active"><a href="?route=Inventario&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Inventario</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?route=Inventario&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Inventario</a></li>
                            <?php } ?>

                            <?php if($url=="Inventario" && !empty($action) && $action == "Consultar"){ ?>
            <li class="active"><a href="?route=Inventario"><i class="fa fa-puzzle-piece"></i> Ver Inventario</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Inventario"><i class="fa fa-puzzle-piece"></i> Ver Inventario</a></li>
                            <?php } ?>

                            <?php if($url=="Inventario" && !empty($action) && $action == "Borrados"){ ?>
            <li class="active"><a href="?route=Inventario&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Inventario Borradas</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Inventario&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Inventario Borradas</a></li>
                            <?php } ?>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?route=Existencias&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Existencias</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?route=Existencias&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Existencias</a></li>
                            <?php } ?>

                            <?php if($url=="Existencias" && !empty($action) && $action == "Consultar"){ ?>
            <li class="active"><a href="?route=Existencias"><i class="fa fa-puzzle-piece"></i> Ver Existencias</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Existencias"><i class="fa fa-puzzle-piece"></i> Ver Existencias</a></li>
                            <?php } ?>

                            <?php if($url=="Existencias" && !empty($action) && $action == "Borrados"){ ?>
            <li class="active"><a href="?route=Existencias&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Existencias Borradas</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Existencias&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Existencias Borradas</a></li>
                            <?php } ?>
...
<!-- ======================================================================================================================= -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?route=Liderazgos&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Liderazgo</a></li>
                            <?php }else{ ?>
            <li class=""><a href="?route=Liderazgos&action=Registrar"><i class="fa fa-puzzle-piece"></i> Registrar Liderazgo</a></li>
                            <?php } ?>

                            <?php if($url=="Liderazgos" && !empty($action) && $action == "Consultar"){ ?>
            <li class="active"><a href="?route=Liderazgos"><i class="fa fa-puzzle-piece"></i> Ver Liderazgos</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Liderazgos"><i class="fa fa-puzzle-piece"></i> Ver Liderazgos</a></li>
                            <?php } ?>

                            <?php if($url=="Liderazgos" && !empty($action) && $action == "Borrados"){ ?>
            <li class="active"><a href="?route=Liderazgos&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Liderazgos Borradas</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Liderazgos&action=Borrados"><i class="fa fa-puzzle-piece"></i> Ver Liderazgos Borradas</a></li>
                            <?php } ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="?route=Usuarios&action=Registrar"><i class="fa  fa-user-plus"></i> Registrar Usuario</a></li>
                            ...
                            <?php if($url=="Usuarios" && !empty($action) && $action == "Consultar"){ ?>
            ...
            <li><a href="?route=Usuarios"><i class="fa fa-user"></i> Ver Usuarios</a></li>
                            ...
                            <?php if($url=="Usuarios" && !empty($action) && $action == "Borrados"){ ?>
            <li class="active"><a href="?route=Usuarios&action=Borrados"><i class="fa fa-user"></i> Ver Usuarios <br>&nbsp&nbsp Borrados</a></li>
                            <?php }else{ ?>
            <li><a href="?route=Usuarios&action=Borrados"><i class="fa fa-user"></i> Ver Usuarios <br>&nbsp&nbsp Borrados</a></li>
                            <?php } ?>
