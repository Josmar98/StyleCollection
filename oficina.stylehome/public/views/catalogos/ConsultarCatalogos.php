        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo "Catalogos"; ?></h3>
                ...
                <?php foreach ($catalogos as $cat){ if(!empty($cat['cod_inventario'])){ ?>
                  <div class="boxCatalogo col-xs-6 col-sm-4 col-md-3" style="padding:10px 25px;box-sizing:border-box;">
                    <div style="background:;text-align:center;">
                      <a href="?route=<?=$_GET['route']; ?>&action=Detalles&cod=<?=$cat['cod_inventario'].$addUrlAdmin; ?>">
                        ...
                        <br>
                        <span style="color:#555;"><?=number_format($cat['puntos_inventario'],2,',','.')." pts"; ?></span>
                      </a>
                      <!-- <br>
