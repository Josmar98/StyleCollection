              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <select class="form-control select2" style="width:100%;" id="premio" name="premio">
                        <option value=""></option>
                        <?php foreach ($inventarios as $inv){ if(!empty($inv['cod_inventario'])){ ?>
                        <option value="<?=$inv['cod_inventario']; ?>" 
                          <?php foreach ($existencias as $key){ if(!empty($key['cod_inventario'])){ if($key['cod_inventario']==$inv['cod_inventario']){ echo "disabled"; } } } ?>
                        ><?=$inv['nombre_inventario']." ( $".number_format($inv['precio_inventario'],2,',','.')." )"; ?></option>
                        <?php } } ?>
                      </select>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="number" class="form-control" id="total" name="total" step="1" placeholder="Ingresar la cantidad total de existencia">
                  ...
                  <!-- <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="number" class="form-control" id="disponible" name="disponible" step="1" placeholder="Ingresar la cantidad disponible en existencia" readonly>
                      <span id="error_disponible" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                      <label for="bloqueada">Cantidad bloqueada</label>
                      <input type="number" class="form-control" id="bloqueada" name="bloqueada" step="1" placeholder="Ingresar la cantidad bloqueada en existencia" readonly>
