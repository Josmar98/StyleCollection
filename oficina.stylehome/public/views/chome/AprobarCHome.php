                        ...
                        <?php if(count($pedidosInv)>1){ ?>
                          ...
                          <form class="FormPedidoFacturaTotal" method="POST" action="">
                            <?php foreach ($pedidosInv as $cart){ if(!empty($cart['id_pedido'])){ ?>
                              ...
                              <tr class="tr<?=$cart['cod_inventario']; ?>">
                                ...
                                <td style="width:30%;">
                                  <div class="input-group col-xs-12 col-sm-6" style="">
                                    ...
                                    <input type="number" step="1" min="0" value="<?=$cart['cantidad_solicitada']; ?>" class="form-control valuesCant val<?=$cart['cod_inventario']; ?>" style="text-align:center;" name="cantidad_aprobada[]" id="<?=$cart['cod_inventario']; ?>">
                                  ...
                                  <input type="hidden" id="cant<?=$cart['cod_inventario']; ?>" value="<?=$cart['cantidad_solicitada']; ?>">
                                </td>
                                <td style="width:10%;"><span class="totaltxt<?=$cart['cod_inventario']; ?>"><?="$".number_format(($cart['cantidad_solicitada'])*($cart['precio_inventario']),2,',','.'); ?></span></td>
                                <td style="text-align:right;padding-right:20px;">
                                  <?php
                                    ...
                                    if($cart['cantidad_solicitada'] > $cantExistencia){
                                      $colorr="#CC0000";
                                    }else{
                                      $colorr="#00CC00";
                                    }
                              ...
                              <?php $subtotal += ($cart['cantidad_solicitada'])*($cart['precio_inventario']) ?>
                            <?php } } ?>
                            <?php
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-7 col-sm-offset-4 col-md-5 col-md-offset-6">
                  ...
                  <div>
                    ...
                    <?php 
                      // echo "ADMIN: ".$personalAdmin;
                      $mostrar=0;
                      if($accesoAprobarPedidosR || $accesoAprobarPedidosM){
                        ?>
                        <input type="hidden" id="personalAdmin" value="<?=$personalAdmin; ?>">
...
$(document).ready(function(){ 
  ...
  $(".aprobarPedido").click(function(){
    ...
    var personalAdmin = $("#personalAdmin").val();
    if(personalAdmin==1){
      minimoFactura=0;
    }
