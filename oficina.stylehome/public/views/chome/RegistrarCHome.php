        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="table-responsive" style="padding-left:2.5%;padding-right:2.5%;">
                    <?php
                      $subtotal = 0;
                    ?>
                              ...
                              <tr>
                                ...
                                <td style="width:25%;">
                                  <div class="input-group col-xs-12 col-sm-6" style="">
                                    ...
                                    <input type="number" step="1" min="1" value="<?=$cart['cantidad_inventario']; ?>" id="val<?=$cart['cod_inventario']; ?>" style="text-align:center;" name="cantidad_inventario[]" class="form-control valuesCant">
                                    <span id="<?=$cart['cod_inventario']; ?>" class="Mass input-group-addon btn" style="width:25%;">+</span>
                                  </div>
                                </td>
                                <td style="width:15%;"><?="$".number_format(($cart['cantidad_inventario'])*($cart['precio_inventario']),2,',','.'); ?></td>
                              </tr>
