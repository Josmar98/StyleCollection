              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="number" step="1" min="1" maxlength="2" max="10" class="form-control" id="numero" name="numero" maxlength="30" placeholder="Numero de campaña" value="<?=$numeCiclo; ?>">
                      <span id="error_numero" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                      <label for="ano">Año de ciclo</label>
                      <input type="number" class="form-control" id="ano" minlength="4" maxlength="4" min="2020" value="<?php echo date("Y") ?>" name="ano" maxlength="30" placeholder="Año de la campaña">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="date" class="form-control" id="apertura" name="apertura" placeholder="Apertura de selección">
                      <span id="error_apertura" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                      <label for="cierre">Cierre de selección</label>
                      <input type="date" class="form-control" id="cierre" name="cierre" placeholder="Cierre de selección">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="date" class="form-control" id="pago" name="pago" placeholder="Pago del ciclo">
                      <span id="error_pago" class="errors"></span>
                    </div>

                    <div class="form-group col-xs-12 col-sm-6">
                      <label for="cuotas">Cantidad de Cuotas del ciclo</label>
                      <input type="number" step="1" min="1" class="form-control" id="cuotas" name="cuotas" placeholder="Ej (10)">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" step="0.1" min="1" class="form-control" id="precio" name="precio" placeholder="Precio minimo">
                      </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="number" step="0.05" min="0" class="form-control" id="puntos" name="puntos" placeholder="Puntos ganados">
