...
<html>
<head>
  <title><?php echo SERVERURL; ?> | <?php if(!empty($action)){echo $action; } ?> <?php if(!empty($modulo)){ echo $modulo; } ?></title>
            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tbody>
                  <?php 
                    $num = 1;
                    foreach ($clientes as $data){ if(!empty($data['id_cliente'])){  
                      ?>
                      <tr>
                        <td style="width:5%">
                        ...
                        <td style="width:10%">
                          <?php if($accesoClientesE){ ?>
                            <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Borrados&id=<?php echo $data['id_cliente'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=Clientes&action=Borrados";
      });
    }
    if(response == "2"){
      swal.fire({
