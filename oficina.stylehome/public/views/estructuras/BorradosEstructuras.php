                ...
                <tr>
                  ...
                  <td style="width:10%">
                    <?php if($accesoEstructurasE){ ?>
                      <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?=$url; ?>&action=Borrados&id=<?=$data2['analista'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=Estructuras&action=Borrados";
      });
    }
    if(response == "2"){
      swal.fire({
