              ...
              if(!empty($existencias)){
                foreach ($existencias as $data){
                  ...
                  <tr>
                    ...
                    <td style="width:15%">
                      <?php if($accesoExistenciasE){ ?>
                      <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Borrados&id=<?php echo $data['id_existencia']; ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=Existencias&action=Borrados";
      });
    }
    if(response == "2"){
      swal.fire({
