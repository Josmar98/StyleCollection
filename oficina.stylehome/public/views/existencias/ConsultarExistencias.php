          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="datatable2" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  <th>Nº</th>
                  <?php if($accesoExistenciasM || $accesoExistenciasE){ ?>
                  <th>---</th>
                  <?php } ?>
                  <th>Nombre</th>
                  <th>Disponibles</th>
              ...
              if(!empty($existencias)){
                foreach ($existencias as $data){
                  ...
                  <tr>
                    ...
                    <td style="width:15%">
                      <?php if($accesoExistenciasM || $accesoExistenciasE){ ?>
                      <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Modificar&id=<?php echo $data['id_existencia'] ?>">
                        <span class="fa fa-wrench"></span>
                      </button>
                      <?php } ?>
                      <?php if($accesoExistenciasM || $accesoExistenciasE){ ?>
                      <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?route=<?php echo $url; ?>&id=<?php echo $data['id_existencia']; ?>&permission=1">
                    ...
                    <td style="width:20%">
                      <span class="contenido2" style="color:#04C704;">
                        <?php echo $data['cantidad_disponible']; ?>
                      </span>
                    </td>
                    <td style="width:20%">
                      <span class="contenido2" style="color:#C70404;">
                        <?php echo $data['cantidad_bloqueada']; ?>
                      </span>
                    </td>
                    <td style="width:20%">
                      <span class="contenido2">
                        <?php echo $data['cantidad_total']; ?>
                      </span>
                    </td>
                  </tr>
                  <?php
