				...
				<div class='col-xs-12'>
					...
					<table class='table2' style='width:100%;'>
						...
						foreach ($pedidosInv as $pedInv) { if(!empty($pedInv['id_factura'])){
							$precioInv = ($pedInv['precio_inventario']); //Por ser en USD;
							...
							<tr style='padding-top:25px;'>
								...
								<td class='celcontentR'><span class='content-table'>$".number_format($precioInv,2,',','.')."</span></td>
					...
					<div class='box-content-final'>
						<table style='width:100%;'>
							<tr>
								...
								<td class='celcontentR'><span class='content-table'>$".number_format($totalNeto,2,',','.')."</span></td>
							</tr>
							<tr>
								<td class='celtitleL'>Impuesto (I.V.A): </td>
								<td class='celcontentR'><span class='content-table'>$".number_format($totalIva,2,',','.')."</span></td>
							</tr>
							<tr>
								<td class='celtitleL'>Total Operacion: </td>
								<td class='celcontentR'><span class='content-table'>$".number_format($totalOperacion,2,',','.')."</span></td>
							</tr>
						</table>
					</div>
