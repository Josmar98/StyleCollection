              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      <img src="<?=$inventario['imagen_inventario']; ?>" style="max-width:450px;max-height:450px;">
                      <br>
                      <span style="color:#DB3B3B;"><b>Advertencia: Si no desea reemplazar la imagen, no seleccione ninguna otra imagen.</b></span>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="text" class="form-control" value="<?=$inventario['cod_inventario']; ?>" id="codigo" name="codigo" maxlength="150" placeholder="Ingresar codigo del premio">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="text" class="form-control" value="<?=$inventario['nombre_inventario']; ?>" id="nombre" name="nombre" maxlength="150" placeholder="Ingresar nombre del premio">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control" value="<?=$inventario['precio_inventario']; ?>" id="precio" name="precio" step="0.01" placeholder="Ingresar el precio en gemas, Ej, 10,25">
                      </div>
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="number" class="form-control" value="<?=$inventario['puntos_inventario']; ?>" id="puntos" name="puntos" step="0.01" placeholder="Ingresar el precio en gemas, Ej, 10,25">
                      <span id="error_puntos" class="errors"></span>
                    </div>
                    <div class="form-group col-xs-12 col-sm-6">
                      <label for="descripcion">Descripción</label>
                      <textarea style="min-width:100%;max-width:100%;min-height:70px;max-height:120px;" class="form-control" id="descripcion" name="descripcion" placeholder="Ingresar descripcion del premio"><?=$inventario['descripcion_inventario']; ?></textarea>
...
function validar(){
  ...
  /*===================================================================*/
  var result = false;
  if( rnombre==true && rprecio==true && rpuntos==true && rdescripcion==true){
