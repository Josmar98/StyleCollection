        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo "Niveles de ".$modulo.""; ?></h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  <th>Nº</th>
                  <?php if($accesoLiderazgosM || $accesoLiderazgosE){ ?>
                  <th>---</th>
                  <?php } ?>
                  <th>Titulo</th>
                  <th>Color</th>
            ...
            ?>
                <tr style="background :<?=$data['color_liderazgo'];?>33">
                  ...
                  <?php if($accesoLiderazgosM || $accesoLiderazgosE){ ?>
                  <td style="width:20%">
                        <?php if($accesoLiderazgosE==1){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url ?>&action=Borrados&id=<?php echo $data['id_liderazgo'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=Liderazgos&action=Borrados";
      });
    }
    if(response == "2"){
      swal.fire({
