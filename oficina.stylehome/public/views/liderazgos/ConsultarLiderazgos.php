      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(!empty($action)){echo $action;} echo " ". $modulo; ?></li>
            ...
            <?php if($accesoLiderazgosR){ ?>
              <br>
              <div style="width:100%;text-align:center;"><a href="?route=<?php echo $modulo ?>&action=Registrar" class="color_btn_sweetalert" style="text-decoration-line:underline;">Registrar Liderazgo</a></div>
            <?php } ?>
    <!-- Main content -->
