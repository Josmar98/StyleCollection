          ...
          <div class="box">
            ...
            ?>
                <tr style="background :<?=$data['color_liderazgo'];?>33">
                  ...
                  <td style="width:20%">
                        <?php if($accesoLiderazgosCiclosE){ ?>
                          <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?<?php echo $menu ?>&route=<?php echo $url ?>&action=Borrados&id=<?php echo $data['id_lc'] ?>&permission=1">
