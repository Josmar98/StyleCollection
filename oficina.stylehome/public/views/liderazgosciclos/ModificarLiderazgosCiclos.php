              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <input type="number" min="1" step="1" value="<?php echo $datas['precio_minimo'] ?>" class="form-control" id="minima" name="minima" placeholder="Cantidad minima de colecciones">
                    ...
                    <div class="form-group  col-sm-6">
                      ...
                      <input type="number" min="0" step="1" value="<?php echo $datas['precio_maximo'] ?>" class="form-control" id="maxima" name="maxima" placeholder="Cantidad maxima de colecciones">
                  ...
                  <div class="row">
                      <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            <input type="number" min="1" step="1.00" max="100" value="<?php echo number_format($datas['descuento_liderazgos'],2) ?>" class="form-control" id="descuento_coleccion" name="descuento_coleccion" placeholder="Porcentaje de descuento de factura">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                          <input type="number" min="1" step="1.00" value="<?php echo number_format($datas['descuento_total'],2) ?>" class="form-control" id="total_descuento" name="total_descuento" placeholder="Porcentaje de descuento acumulado" readonly="">
                          <span class="input-group-addon">%</span>
                        </div>
...
<input type="hidde" class="max_total_descuento" value="<?php echo number_format($max, 2) ?>">
