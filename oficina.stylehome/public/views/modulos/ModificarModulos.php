              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12">
                       ...
                       <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $datas['nombre_modulo'] ?>" maxlength="30" placeholder="Ingresar nombre del modulo">
...
function validar(){
  ...
  if( rnombre == false ){
    if(nombre.length != 0){
      $("#error_nombre").html("El nombre del modulo no debe contener numeros o caracteres especiales");
    }else{
      $("#error_nombre").html("Debe llenar el campo de nombre del modulo");      
    }
  }else{
    $("#error_nombre").html("");
  }
