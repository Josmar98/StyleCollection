          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  <th>Nº</th>
                  <?php if($accesoNotasM || $accesoNotasE){ ?>
                  <th>---</th>
                  <?php } ?>
                  <th>Líder</th>
            ...
            <?php 
              ...
              foreach ($notas as $data){ if(!empty($data['id_nota'])){
                ...
                <tr>
                  ...
                  <?php if($accesoNotasM || $accesoNotasE){ ?>
                  <td style="width:20%">
                    <?php if($accesoNotasM==1){ ?>
                      <button class="btn modificarBtn" style="border:0;background:none;color:#04a7c9" value="?<?=$menu; ?>&route=<?=$url; ?>&action=Modificar&id=<?=$data['id_nota']; ?>"><span class="fa fa-wrench"></span></button>
                    <?php } ?>
                    <?php if($accesoNotasE){ ?>
                      <button class="btn eliminarBtn" style="border:0;background:none;color:red" value="?<?=$menu; ?>&route=<?=$url; ?>&id=<?=$data['id_nota']; ?>&permission=1"><span class="fa fa-trash"></span></button>
                    <?php } ?>
                  </td>
                  <?php } ?>
                  <td style="width:40%">
                  ...
                  <td style="">
                    <span class="contenido2">
                      <a href="?<?=$menu; ?>&route=<?=$url; ?>&action=Ver&id=<?=$data['id_nota']; ?>"> Ver nota de entrega</a>
                    </span>
                  </td>
                </tr>
                <?php
