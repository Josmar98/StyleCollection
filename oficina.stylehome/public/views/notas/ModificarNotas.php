                  ...
                  <div class="col-xs-12 col-sm-5 text-center">
                    ...
                    <div style="">
                      <div class="col-xs-12 col-md-6" style="display:inline-block;">
                        ...
                        <br>
                        <input type="text" name="lugar_emision" value="<?=$nota['fecha_emision'];?>" maxlength="90">
                      </div>
                      <div class="col-xs-12 col-md-6" style="display:inline-block;">
                        <small>FECHA DE EMISION</small>
                        <br>
                        <input type="date" name="fecha_emision" value="<?=$nota['fecha_emision'];?>">
                      </div>
                    </div>
                    <br><br><br><br>
                    ...
                    <div style="display:inline-block;width:60%;">
                      ...
                      <input type="number" class="form-control" min="1" readonly name="numero" step="1" value="<?=$numeroNota; ?>" onfocusout="$(this).val(parseInt($(this).val()))" style="display:inline-block;font-size:1.6em;float:right;width:85%;margin:0;">
                    </div>
                  </div>
