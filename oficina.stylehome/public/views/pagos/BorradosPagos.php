                          ...
                          if($permitido=="1"){ ?>
                            ...
                            <tr class='elementos_tr_<?=$data['id_pago']; ?> tr<?=$data['id_pago']?>' style="background:<?=$bgTablePago; ?>;">
                                  ...
                                  if( ($personalInterno && !empty($_GET['lider'])) || ($personalExterno) ){
                                    if(!empty($pedido)){
                                      ...
                                      foreach ($pagosCiclos as $keys){ if(!empty($keys['id_pago_ciclo'])){
                                        ...
                                        $nCuota = substr($keys['numero_cuota'], 0, strpos($keys['numero_cuota']," "));
                                        $coutasxD = $keys;
                                        if(mb_strtolower($nCuota)=="inicial"){
                                          $nCuota = "Cuota ".$nCuota;
                                        }else{
                                          $nCuota = $keys['numero_cuota'];
                                        }
                              ...
                              <td style="width:20%">
                                ...
                                <span class="contenido2">
                                  <span class='contenido_tipo_pago'><?php echo $nCuota; ?></span>
                                </span>
                              </td>
                              <?php if($accesoPagosDetallesM){ ?>
                              <td style="width:20%">
