              ...
              <div class="active tab-pane" id="infos">
                ...
                <form action="" method="POST" class="form-horizontal formCuenta">
                    ...
                    <div class="box-footer">                    
                      ...
                      <div class="col-sm-10">
                          <span type="submit" class="btn enviar2 EnviarData">Enviar</span>
                ...
                <form action="" method="POST" class="form-horizontal formUser d-none">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="username" name="username" maxlength="50" value="<?php echo $_SESSION['home']['username'] ?>" placeholder="Primer Nombre">
                    ...
                    <div class="box-footer">                    
                      <label class="col-sm-2 control-label"></label>
                      <div class="col-sm-10">
                          <span type="submit" class="btn enviar2 EnviarUser">Enviar</span>
                          <input type="color" class="d-none color-button-sweetalert" value="<?php echo $color_btn_sweetalert ?>">
                ...
                <form action="" method="POST" class="form-horizontal formPass d-none">
                    ...
                    <div class="box-footer">                    
                      <label class="col-sm-2 control-label"></label>
                      <div class="col-sm-10">
                          <span type="submit" class="btn enviar2 EnviarPassword">Enviar</span>
                          <input type="color" class="d-none color-button-sweetalert" value="<?php echo $color_btn_sweetalert ?>">
...
<!-- ./wrapper -->
<input type="hidden" class="passActual" value="<?php echo $_SESSION['home']['pass']; ?>">
