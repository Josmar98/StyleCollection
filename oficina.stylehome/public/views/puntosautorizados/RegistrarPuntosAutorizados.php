              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <input type="number" min="1" step="1" class="form-control" id="cantidad" name="cantidad" placeholder="Cantidad cantidad de colecciones">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-12">
                      ...
                      <textarea class="form-control" maxlength="250" id="descripcion" name="descripcion" style="min-width:100%;max-width:100%;min-height:60px;max-height:110px;"></textarea>
