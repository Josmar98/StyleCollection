...
<head>
	...
	<title>Pedidos aprobados de Ciclo ".$ciclo['numero_ciclo']."/".$ciclo['ano_ciclo']." - StyleHome</title>
</head>
<body>
<style>
body{
...
<div class='row' style='padding:0;margin:0;'>
	<div class='col-xs-12' style='width:100%;'>
		<h2 style='font-size:1.9em;'> Solicitudes aprobada de Pedidos - Ciclo ".$ciclo['numero_ciclo']."/".$ciclo['ano_ciclo']."</h2>
		<br>
		<br>
		";
...
$altoMedio = $alto / 2;
$dompdf->render();
$dompdf->stream("StyleHome ".$ciclo['numero_ciclo']."-".$ciclo['ano_ciclo']." Productos Aprobados", array("Attachment" => false));
