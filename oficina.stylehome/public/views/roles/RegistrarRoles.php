              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-11">
                       ...
                       <input type="text" class="form-control" id="nombre" name="nombre" maxlength="30" placeholder="Ingresar nombre del rol">
                            ...
                            ?>  
                              ...
                              <td style="width:<?php echo $porcen."% !important"; ?>; ">
                                ...
                                ?>
                                  ...
                                  <br>
                                  <input type="checkbox" name="accesos[]" id="<?php echo $code; ?>" class="accesos" value="<?php echo $code2; ?>">
