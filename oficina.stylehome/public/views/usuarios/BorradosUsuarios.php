            ...
            <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped" style="text-align:center;width:100%;">
                ...
                <tr>
                  ...
                  <td style="width:10%">
                    <?php if($accesoUsuariosE){ ?>
                      <button class="btn eliminarBtn" style="border:0;background:none;color:#04a7c9" value="?route=<?php echo $url; ?>&action=Borrados&id=<?php echo $data['id_usuario'] ?>&permission=1">
  ...
  if(response==undefined){
    ...
    if(response == "1"){
      swal.fire({
        ...
        window.location = "?route=Usuarios&action=Borrados";
      });
    }
    if(response == "2"){
      swal.fire({
