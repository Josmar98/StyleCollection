              ...
              <div class="box-body">
                  ...
                  <div class="row">
                      ...
                      <select class="form-control select2" id="cliente" name="cliente" readonly>
                        ...
                        foreach ($usuarios as $data) {
                          if( !empty($data['id_cliente']) ){
                            ?>
                              <option value="<?php echo $data['id_cliente'] ?>" <?php if($data['id_cliente']==$usuario['id_cliente']){ echo "selected=''"; } ?> ><?php echo $data['primer_nombre']." ".$data['primer_apellido']." - ".$data['cedula'] ?></option>
                            <?php
                          }
                        } ?>
                      </select>
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <select class="form-control select2" id="rol" name="rol" readonly>
                         <!-- <option value=""></option> -->
                        <!-- <option value="0">Ninguna</option> -->
                        <?php 
...
function validar(){
  ...
  /*===================================================================*/
  // var result = false;
  // if( rnombre==true && rpassword==true && rpassword2==true && rcliente==true && rrol==true){
  //   result = true;
  // }else{
  //   result = false;
  // }
