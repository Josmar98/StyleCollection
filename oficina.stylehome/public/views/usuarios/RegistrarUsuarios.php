              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-6">
                      ...
                      <select class="form-control select2" style="width:100%;" id="rol" name="rol">
                         <option value=""></option>
                        <!-- <option value="0">Ninguna</option> -->
                        <?php 
                        foreach ($roles as $data) {
                          if( !empty($data['id_rol']) ){
                            ?>
                              <option value="<?php echo $data['id_rol'] ?>">
...
function validar(){
  ...
  if(rol == ""){
    rrol = false;
    $("#error_rol").html("Debe seleccionar un rol para la cuenta de usuario");
  }else{
    rrol = true;
    $("#error_rol").html("");
  }
