...
<head>
	...
	<link rel="shortcut icon" type="image/k-icon" href="components/iconFondo.png" class="img-circle">
	<link rel="stylesheet" href="components/AdminLTE.min.css">
...
<?php
	$opcion = false;
	$presentacion = [];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion1', 'imagen'=>'./img/pantalla1.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion2', 'imagen'=>'./img/pantalla2.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion3', 'imagen'=>'./img/pantalla3.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion4', 'imagen'=>'./img/pantalla4.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion5', 'imagen'=>'./img/pantalla5.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion6', 'imagen'=>'./img/pantalla6.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion7', 'imagen'=>'./img/pantalla7.jpg'];
	$presentacion[count($presentacion)]=['nombre'=>'Presentacion8', 'imagen'=>'./img/pantalla8.jpg'];
	...
	foreach ($presentacion as $presentar){
		...
		<div style="" class="box1content<?=$num;  ?>" style="margin:0;padding:0;background:red;">
			...
			<div style="" class="boxContent" id="<?=$num; ?>" style="margin:0;padding:0;position:absolute;top:0;left:0;min-width:100%;max-width:100%;height:100vh;">
				<div  data-aos="<?=$class; ?>" data-aos-duration="3000" style="width:100%;">
