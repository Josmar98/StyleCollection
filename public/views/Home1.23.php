...
<body style="font-family:'arial';background:#FFF">
	...
	<div class="wrapper">
		...
		<div style="background:url('public/assets/img/resources/fondo1.23.jpg');background-size:100% 100%;max-width:100%;min-width:100%;min-height:90vh;max-height:90vh;overflow:hidden">

			<div style="" class="box1cintillo">
				<div style="" class="box2cintillo">
					<img src="public/assets/img/resources/cintillo_campana1.23.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1emblema">
				<div style="" class="box2emblema">
					<img src="public/assets/img/resources/emblema1.23.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1matas1">
				<div style="" class="box2matas1">
					<img src="public/assets/img/resources/mata1.23.1.png" style="max-width:100%;">
				</div>
			</div>

			<div style="" class="box1matas2">
				<div style="" class="box2matas2">
					<img src="public/assets/img/resources/mata1.23.2.png" style="max-width:100%;">
				</div>
			</div>

			<div style="" class="box1matas3">
				<div style="" class="box2matas3">
					<img src="public/assets/img/resources/mata1.23.3.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1logotipobottom">
				<div style="" class="box2logotipo">
					<img src="public/assets/img/resources/logotipo1.23.png" style="max-width:100%;">
				</div>
			</div>
		</div>
