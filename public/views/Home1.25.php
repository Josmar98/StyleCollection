...
<body style="font-family:'arial';background:#FFF">
	...
	<!-- <div class="wrapper" style="background:#FFFFFF;background-repeat:no-repeat;background-size:100% 100%;background-position-y:100%;opacity:1;"> -->
	<div class="wrapper" style="background:url('public/assets/img/resources/1.25/desenfoque2.png');background-repeat:no-repeat;background-size:100% 100%;background-position-y:100%;opacity:1;">
		...
		<div style="max-width:100%;min-width:100%;width:100%;min-height:90vh;max-height:90vh;overflow:hidden;">
			...
			<div style="" class="box1detalle1">
				<div style="" class="box2detalle1">
					<img src="public/assets/img/resources/1.25/fondos.png" style="width: 100%;overflow: hidden;">
				</div>
			</div>
			<div style="" class="box1detalle2">
				<div style="" class="box2detalle2">
					<img src="public/assets/img/resources/1.25/destellos2.png" style="max-width:100%;width:100%;">
				</div>
			</div>

			<div style="" class="box1emblema">
				<div style="" class="box2emblema">
					<img src="public/assets/img/resources/1.25/emblema.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			
			<div style="" class="box1logotipo">
				<div style="" class="box2logotipo">
					<img src="public/assets/img/resources/1.25/logo.png" style="max-width:100%;width:100%;">
				</div>
			</div>
