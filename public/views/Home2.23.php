...
<body style="font-family:'arial';background:#FFF">
	...
	<div class="wrapper">
		...
		<div style="background:url('public/assets/img/resources/fondo2.23.jpg');background-size:100% 100%;max-width:100%;min-width:100%;min-height:90vh;max-height:90vh;overflow:hidden">

			<div style="" class="box1cintillo">
				<div style="" class="box2cintillo">
					<img src="public/assets/img/resources/cintillo_campana2.23.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1emblema">
				<div style="" class="box2emblema">
					<img src="public/assets/img/resources/emblema2.23.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1detalle1">
				<div style="" class="box2detalle1">
					<img src="public/assets/img/resources/detalle1.2.23.png" style="max-width:100%;">
				</div>
			</div>

			<div style="" class="box1detalle2">
				<div style="" class="box2detalle2">
					<img src="public/assets/img/resources/detalle2.2.23.png" style="max-width:100%;">
				</div>
			</div>
			<!-- <div style="" class="box1logotipobottom">
				<div style="" class="box2logotipo">
					<img src="public/assets/img/resources/logotipo2.23.png" style="max-width:100%;">
				</div>
			</div> -->
		</div>
