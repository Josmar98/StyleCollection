...
<body style="font-family:'arial';background:#FFF">
	...
	<div class="wrapper" style="background:url('public/assets/img/resources/2.24/fondo2.24.12.png');background-repeat:no-repeat;background-size:100% 90%;background-position-y:100%;opacity:;">

		<img src="public/assets/img/resources/2.24/fondo2.24.png" class="fondoGeneral">
		...
		<div style="max-width:100%;min-width:100%;width:100%;min-height:90vh;max-height:90vh;overflow:hidden;">
			...
			<div style="" class="box1logotipo">
				<div style="" class="box2logotipo">
					<img src="public/assets/img/resources/logotipoGris.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			<div style="" class="box1emblema">
				<div style="" class="box2emblema">
					<img src="public/assets/img/resources/2.24/emblema2.24.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			<div style="" class="box1cintillo">
				<div style="" class="box2cintillo">
					<img src="public/assets/img/resources/2.24/cintillo2.24.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			<div style="" class="box1detalle1">
				<div style="" class="box2detalle1">
					<img src="public/assets/img/resources/2.24/detalle1.2.24.png" class=""  style="max-width:100%;width:100%;">
				</div>
			</div>

			<div style="" class="box1detalle2">
				<div style="" class="box2detalle2">
					<img src="public/assets/img/resources/2.24/detalle2.2.24.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			<div style="" class="box1detalle3">
				<div style="" class="box2detalle3">
					<img src="public/assets/img/resources/2.24/detalle3.2.24.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			<div style="" class="box1detalle4">
				<div style="" class="box2detalle4">
					<img src="public/assets/img/resources/2.24/detalle4.2.24.png" style="max-width:100%;width:100%;">
				</div>
			</div>
			<div style="" class="box1detalle5">
				<div style="" class="box2detalle5">
					<img src="public/assets/img/resources/2.24/detalle5.2.24.png" style="max-width:100%;width:100%;">
				</div>
			</div>
