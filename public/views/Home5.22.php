...
<body style="font-family:'arial';background:#FFF">
	...
	<div class="wrapper">
		...
		<div style="background:url('public/assets/img/resources/fondo5.22.png');background-size:100% 100%;max-width:100%;min-width:100%;height:90vh;">

			<div style="" class="box1cintillo">
				<div style="" class="box2cintillo">
					<img src="public/assets/img/resources/cintillo_campana5.22.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1logotipotop">
				<div style="" class="box2logotipo">
					<img src="public/assets/img/resources/logotipo.general.png" style="max-width:100%;">
				</div>
			</div>
			<br>
			<div style="" class="box1emblema">
				<div style="" class="box2emblema">
					<img src="public/assets/img/resources/emblema5.22.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1copas">
				<div style="" class="box2copas">
					<img src="public/assets/img/resources/copas5.22.png" style="max-width:100%;">
				</div>
			</div>
			<div style="" class="box1botella">
				<div style="" class="box2botella">
					<img src="public/assets/img/resources/botella5.22.png" style="max-width:100%;">
				</div>
			</div>
