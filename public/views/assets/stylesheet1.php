...
.seccion1Cintillo{ margin:0% 8%;position:absolute;top:15px; }
.seccion1Emblema{ margin:0% 10%;position:absolute;top:5%;left:30%;width:21%; }
/*.seccion1Separador{ position:absolute;left:5%;top:50%;width:90%;background:#CCC;border:1px solid #ccc }*/
.seccion1Productos{ position:absolute;left:-5%;top:8vh;width:95%; }
.seccion1Fondo{ margin:0;padding:0;background:url('public/assets/img/resources/fondo1.png');background-size:100% 100%;box-sizing:border-box;position:relative;height:90.5vh; }
...
.seccion1Emblema{ width:30%;left:27.5%; }

}

@media screen and (min-width: 992px) and (max-width: 1024px){
  /*.seccionFullWork1{ height:50vh; }*/
.seccion1Cintillo{ width:100px; }
.seccion1Productos{ ;width:100%;position:absolute;left:-8%;top:15vh; }
.seccion1Emblema{ width:30%;left:27%; }
/*.seccion1Separador{ position:absolute;top:54vh; }*/
.btnContent{ bottom:8%; }
...
/*.seccion1Separador{ position:absolute;top:60vh; }*/
.btnContent{ bottom:9%; }
.seccion1Fondo{ height:88vh; }
